...
class CheckpointsTreeView {
    ...
    getTreeItem(element) {
        ...
        if (!element.parentId) {
            ...
            element.collapsibleState =
                ((_a = this.model.checkpointContext) === null || _a === void 0 ? void 0 : _a.toString()) === file.id
                    ? vscode_1.TreeItemCollapsibleState.Expanded
                    : vscode_1.TreeItemCollapsibleState.Collapsed;
            // Set the file icon
            if (((_b = this.model.checkpointContext) === null || _b === void 0 ? void 0 : _b.toString()) === file.id) {
                element.iconPath = {
    ...
    getChildren(element) {
        ...
        if (!element && showActiveFileOnly) {
            let checkpoints = this.model.getCheckpoints((_a = this.model.checkpointContext) === null || _a === void 0 ? void 0 : _a.toString());
