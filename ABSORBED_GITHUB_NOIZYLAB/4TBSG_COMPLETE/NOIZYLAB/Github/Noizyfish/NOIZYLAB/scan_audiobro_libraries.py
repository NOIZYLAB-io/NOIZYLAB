...
# -*- coding: utf-8 -*-
"""
Audiobro Library Scanner — Noizy Fish
Scans all mounted volumes and local roots for Audiobro LA Scoring Strings and Legato Sordino libraries.
Indexes .nki and .ncw files, exports to CSV.
"""

from pathlib import Path
import csv

# Build search paths for all mounted volumes
