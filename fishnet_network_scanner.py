...
if __name__ == "__main__":
    ...
    os.system('prlctl start "NOIZYWIND"')
    while True:
        try:
        ...
        os.system('python /Users/rsp_ms/Desktop/NoizyFish/scripts/fishnet_network_scanner.py')
        {
          "version": "2.0.0",
          "tasks": [
            {
              "label": "Run FishNet Scanner",
              "type": "shell",
              "command": "python /Users/rsp_ms/Desktop/NoizyFish/scripts/fishnet_network_scanner.py",
              "problemMatcher": [],
              "isBackground": true,
              "presentation": {
                "reveal": "always",
...
"emeraldwalk.runonsave": {
  "commands": [
    {
      "match": "fishnet_network_scanner.py",
      "cmd": "python ${file}"
    }
  ]
}
