...
const serviceNameMap = {
	account: "visca.AccountService",
	browser: "visca.BrowserService",
	checkpoints: "visca.CheckpointsService",
	file: "visca.FileService",
	mcp: "visca.McpService",
	state: "visca.StateService",
	task: "visca.TaskService",
	web: "visca.WebService",
	models: "visca.ModelsService",
	slash: "visca.SlashService",
...
async function ensureProtoFilesExist() {
	...
	for (const [serviceName, fullServiceName] of Object.entries(serviceNameMap)) {
		if (!existingProtoServices.includes(serviceName)) {
			...
			// Extract service class name from full name (e.g., "visca.ModelsService" -> "ModelsService")
...
package visca;
option java_package = "ai.visca.proto";
