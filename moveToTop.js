...
exports.moveToTop = void 0;
const vscode = require("vscode");
const configMgr_1 = require("../helper/configMgr");
const util_1 = require("../helper/util");
function moveToTop(favoritesProvider) {
    return vscode.commands.registerCommand('favorites.moveToTop', function (value) {
...
//# sourceMappingURL=moveToTop.js.map
