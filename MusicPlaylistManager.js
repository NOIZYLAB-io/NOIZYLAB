...
exports.MusicPlaylistManager = void 0;
...
class MusicPlaylistManager {
    ...
    createPlaylist(playlistName, playlistTrackItems) {
        return __awaiter(this, void 0, void 0, function* () {
            // create the playlist
            const playlistResult = yield (0, cody_music_1.createPlaylist)(playlistName, true);
            let playlistId = null;
            const errMsg = (0, Util_1.getCodyErrorMessage)(playlistResult);
            if (errMsg) {
    ...
    addTracks(playlist_id, name, tracksToAdd) {
        return __awaiter(this, void 0, void 0, function* () {
            if (playlist_id) {
                ...
                const addTracksResult = yield (0, cody_music_1.addTracksToPlaylist)(playlist_id, tracksToAdd);
                if (addTracksResult.state === cody_music_1.CodyResponseType.Success) {
                    ...
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (playlist_id === Constants_1.SPOTIFY_LIKED_SONGS_PLAYLIST_NAME) {
                            yield (0, PlaylistDataManager_1.populateLikedSongs)();
                        }
                        else {
