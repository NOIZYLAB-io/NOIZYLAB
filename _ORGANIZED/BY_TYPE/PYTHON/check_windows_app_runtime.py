...
def get_architecture_and_installer_url():
    ...
    if arch in ['amd64', 'x86_64']:
        architecture = "x64"
        installer_url = f"https://aka.ms/windowsappsdk/1.8/{version}/windowsappruntimeinstall-x64.exe"
        installer_filename = "windowsappruntimeinstall-x64.exe"
    elif arch in ['arm64', 'aarch64']:
        architecture = "ARM64"
        installer_url = f"https://aka.ms/windowsappsdk/1.8/{version}/windowsappruntimeinstall-arm64.exe"
