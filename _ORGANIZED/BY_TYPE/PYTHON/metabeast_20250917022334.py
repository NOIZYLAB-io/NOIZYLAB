...
def listen_for_beast_command():
    recognizer = sr.Recognizer()
    mic = sr.Microphone()
    print("🎤 Say 'let the beast eat' to start Meta Beast...")
    with mic as source:
    ...
    try:
        ...
        if "let the beast eat" in command:
            print("🦾 Voice command recognized! Running Meta Beast...")
            main()
        else:
