...
class CheckpointsController {
    ...
    initialize() {
        ...
        this.model.checkpointContext = (_a = this.activeEditor) === null || _a === void 0 ? void 0 : _a.document.uri;
        ...
        this.context.subscriptions.push(vscode_1.window.registerTreeDataProvider("checkpointsTreeViewExplorer", this.treeView), vscode_1.window.registerTreeDataProvider("checkpointsTreeViewScm", this.treeView), vscode_1.workspace.registerTextDocumentContentProvider("checkpointsDocumentView", this.documentView), vscode_1.workspace.onDidSaveTextDocument(this.handleOnSave, this));
        // Register commands
        // =================
    ...
    onAddCheckpoint() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.activeEditor === undefined) {
                console.log(`Failed to add file to store. No document open.`);
                return;
            }
            if (((_a = this.activeEditor) === null || _a === void 0 ? void 0 : _a.document.uri.scheme) === "untitled") {
                console.log(`Failed to add file to store. Unsaved documents are currently not supported`);
                vscode_1.window.showInformationMessage("Untitled documents are currently not supported"); // Todo: do we need this message?
                return;
            }
    ...
    onRestoreCheckpoint(checkpointNode) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                assertDefined_1.assertDefined(textDocument, "Could not find document to restore");
            ...
            if (success &&
                checkpointNode.parentId !== ((_a = this.model.checkpointContext) === null || _a === void 0 ? void 0 : _a.toString())) {
    ...
    onToggleShowActiveFileOnly() {
        ...
        config.update("showActiveFileOnly", !currentConfigValue).then(() => {
    ...
    promptAreYouSure(message, cb) {
        vscode_1.window
            ...
            .then((answer) => {
            if ((answer === null || answer === void 0 ? void 0 : answer.title) === "Yes") {
                cb();
            }
        });
    }
    handleOnSave() {
        const config = vscode_1.workspace.getConfiguration("checkpoints");
        const addCheckpointOnSave = config.get("addCheckpointOnSave");
        if (addCheckpointOnSave === true) {
            vscode_1.commands.executeCommand("checkpoints.addCheckpoint");
        }
    }
}
