...
class CheckpointsModel {
    ...
    set checkpointContext(fileUri) {
        ...
        if (this.currentCheckpointContext &&
            (this.currentCheckpointContext.toString() === (fileUri === null || fileUri === void 0 ? void 0 : fileUri.toString()) ||
                (fileUri === null || fileUri === void 0 ? void 0 : fileUri.scheme) === 'checkpointsDocumentView')) {
            return;
        }
