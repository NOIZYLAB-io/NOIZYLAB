...
# Determine the script location and set paths accordingly
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
NOIZYLAB_ROOT="$(dirname "$SCRIPT_DIR")"
GABRIEL_ROOT="${GABRIEL_ROOT:-/Users/m2ultra/NOIZYLAB/GABRIEL}"
CODEMASTER="$SCRIPT_DIR"
ORGANIZED="$CODEMASTER"

echo "🚀 NOIZYLAB-io GitHub Organization Script"
echo "=========================================="
echo "GABRIEL_ROOT: $GABRIEL_ROOT"
echo "CODEMASTER: $CODEMASTER"
echo ""
