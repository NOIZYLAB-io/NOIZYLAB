...
with Stage(r"assign", prog_num=7):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"16-20250906122359"
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"doit", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906122359.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906122359.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/doit-output-16-20250906122359.log", r"--run")
    ...
    config_vars['__INVOCATION_RANDOM_ID__'] = r"pisvxmawhhwphare"
    config_vars['__JUST_WITH_NUMBER__'] = 0
    config_vars['__MAIN_COMMAND__'] = r"doit"
    config_vars['__MAIN_DB_FILE__'] = r":memory:"
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906122359.yaml"
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906122359.py"
    config_vars['__NOW__'] = r"2025-09-06 12:24:00.463189"
...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:18.177s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:18.175s
        with Stage(r"Shutting down WavesPluginaServer(s)...", prog_num=12):  # 0m:10.911s
            # --- Begin STOP_WAVES_PLUGINS_SERVER Shutting down WavesPluginaServer(s)
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=13) as shell_command_001_13:  # 0m:0.006s
            ...
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=15) as shell_command_003_15:  # 0m:4.837s
            ...
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=17) as shell_command_005_17:  # 0m:4.991s
                shell_command_005_17()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=18) as shell_command_006_18:  # 0m:1.066s
                shell_command_006_18()
            # --- End STOP_WAVES_PLUGINS_SERVER Shutting down WavesPluginaServer(s)
        with Stage(r"Shutting down WavesPluginaServer(s)...", prog_num=19):  # 0m:7.264s
            # --- Begin STOP_WAVES_LOCAL_SERVER Shutting down WavesPluginaServer(s)
            with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wls.shutdown', message=r"Stop Waves Local Client", ignore_all_errors=True, prog_num=20, suspend=5) as shell_command_007_20:  # 0m:2.261s
...
with Stage(r"epilog", prog_num=22):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906122359.py", prog_num=23) as patch_py_batch_with_timings_008_23:  # ?
