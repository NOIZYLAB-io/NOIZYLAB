...
with Stage(r"assign", prog_num=7):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"16-20250823213832"
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"doit", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/permission-fixer_16-20250823213832.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/permission-fixer_16-20250823213832.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/doit-output-16-20250823213832.log", r"--run")
    ...
    config_vars['__INVOCATION_RANDOM_ID__'] = r"wmoxtrnltfposmlf"
    config_vars['__JUST_WITH_NUMBER__'] = 0
    config_vars['__MAIN_COMMAND__'] = r"doit"
    config_vars['__MAIN_DB_FILE__'] = r":memory:"
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/permission-fixer_16-20250823213832.yaml"
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/permission-fixer_16-20250823213832.py"
    config_vars['__NOW__'] = r"2025-08-23 21:38:34.618139"
...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:28.839s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:28.839s
        with Stage(r"Prefix /Applications/Waves...", prog_num=12):  # 0m:21.386s
            ...
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=13) as make_dir_001_13:  # 0m:0.003s
                make_dir_001_13()
            with Chown(path=r"/Applications/Waves", user_id=501, group_id=20, prog_num=14, recursive=True) as chown_002_14:  # 0m:15.630s
                chown_002_14()
            with Chmod(path=r"/Applications/Waves", mode="a+rwX", prog_num=15, recursive=True) as chmod_003_15:  # 0m:5.753s
                chmod_003_15()
            # --- End PREFIX_WAVES_DIR Prefix /Applications/Waves
        with Stage(r"Prefix /Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central...", prog_num=16):  # 0m:0.033s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central", chowner=True, prog_num=17) as make_dir_004_17:  # 0m:0.005s
                make_dir_004_17()
            with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central", mode="a+rwX", prog_num=18, recursive=True) as chmod_005_18:  # 0m:0.027s
                chmod_005_18()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs...", prog_num=19):  # 0m:0.008s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs", chowner=True, prog_num=20) as make_dir_006_20:  # 0m:0.003s
                make_dir_006_20()
            with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs", mode="a+rwX", prog_num=21, recursive=True) as chmod_007_21:  # 0m:0.005s
                chmod_007_21()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Application Support/Waves Audio...", prog_num=22):  # 0m:0.009s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio", chowner=True, prog_num=23) as make_dir_008_23:  # 0m:0.003s
                make_dir_008_23()
            with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio", mode="a+rwX", prog_num=24, recursive=True) as chmod_009_24:  # 0m:0.006s
                chmod_009_24()
            # --- End PREFIX_USER_WAVES_DIR Prefix /Users/rsp_ms/Library/Application Support/Waves Audio
        with Stage(r"Prefix /Users/rsp_ms/Library/Caches/Waves Audio...", prog_num=25):  # 0m:5.992s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio", chowner=True, prog_num=26) as make_dir_010_26:  # 0m:0.003s
                make_dir_010_26()
            with Chown(path=r"/Users/rsp_ms/Library/Caches/Waves Audio", user_id=501, group_id=20, prog_num=27, recursive=True) as chown_011_27:  # 0m:4.835s
                chown_011_27()
            with Chmod(path=r"/Users/rsp_ms/Library/Caches/Waves Audio", mode="a+rwX", prog_num=28, recursive=True) as chmod_012_28:  # 0m:1.154s
                chmod_012_28()
            # --- End PREFIX_CACHE_DIR Prefix /Users/rsp_ms/Library/Caches/Waves Audio
        with Stage(r"Prefix /Library/Audio/Plug-Ins/VST...", prog_num=29):  # 0m:0.027s
            # --- Begin PREFIX_WAVESHELL_VST_DIR Prefix /Library/Audio/Plug-Ins/VST
            with MakeDir(r"/Library/Audio/Plug-Ins/VST", prog_num=30) as make_dir_013_30:  # 0m:0.003s
                make_dir_013_30()
            with Chmod(path=r"/Library/Audio/Plug-Ins/VST", mode="a+rwX", ignore_if_not_exist=True, prog_num=31) as chmod_014_31:  # 0m:0.001s
                chmod_014_31()
            with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*.vst", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=32) as glober_015_32:  # 0m:0.014s
                glober_015_32()
            with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*.vst", Chmod, None, r"a+rwX", recursive=True, prog_num=33) as glober_016_33:  # 0m:0.008s
                glober_016_33()
            # --- End PREFIX_WAVESHELL_VST_DIR Prefix /Library/Audio/Plug-Ins/VST
        with Stage(r"Prefix /Library/Audio/Plug-Ins/VST3...", prog_num=34):  # 0m:0.076s
            # --- Begin PREFIX_WAVESHELL_VST3_DIR Prefix /Library/Audio/Plug-Ins/VST3
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=35) as make_dir_017_35:  # 0m:0.002s
                make_dir_017_35()
            with Chmod(path=r"/Library/Audio/Plug-Ins/VST3", mode="a+rwX", ignore_if_not_exist=True, prog_num=36) as chmod_018_36:  # 0m:0.000s
                chmod_018_36()
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=37) as glober_019_37:  # 0m:0.048s
                glober_019_37()
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Chmod, None, r"a+rwX", recursive=True, prog_num=38) as glober_020_38:  # 0m:0.026s
                glober_020_38()
            # --- End PREFIX_WAVESHELL_VST3_DIR Prefix /Library/Audio/Plug-Ins/VST3
        with Stage(r"Prefix /Library/Application Support/Avid/Audio/Plug-Ins...", prog_num=39):  # 0m:0.093s
            # --- Begin PREFIX_WAVESHELL_AAX_DIR Prefix /Library/Application Support/Avid/Audio/Plug-Ins
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=40) as make_dir_021_40:  # 0m:0.002s
                make_dir_021_40()
            with Chmod(path=r"/Library/Application Support/Avid/Audio/Plug-Ins", mode="a+rwX", ignore_if_not_exist=True, prog_num=41) as chmod_022_41:  # 0m:0.000s
                chmod_022_41()
            with Glober(r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell*.aaxplugin", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=42) as glober_023_42:  # 0m:0.059s
                glober_023_42()
            with Glober(r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell*.aaxplugin", Chmod, None, r"a+rwX", recursive=True, prog_num=43) as glober_024_43:  # 0m:0.031s
                glober_024_43()
            # --- End PREFIX_WAVESHELL_AAX_DIR Prefix /Library/Application Support/Avid/Audio/Plug-Ins
        with Stage(r"Prefix /Library/Audio/Plug-Ins/WPAPI...", prog_num=44):  # 0m:0.048s
            ...
            with Chmod(path=r"/Library/Audio/Plug-Ins/WPAPI", mode="a+rwX", prog_num=46) as chmod_026_46:  # 0m:0.000s
                chmod_026_46()
            with Glober(r"/Library/Audio/Plug-Ins/WPAPI/WaveShell*.bundle", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=47) as glober_027_47:  # 0m:0.028s
                glober_027_47()
            with Glober(r"/Library/Audio/Plug-Ins/WPAPI/WaveShell*.bundle", Chmod, None, r"a+rwX", recursive=True, prog_num=48) as glober_028_48:  # 0m:0.017s
                glober_028_48()
            # --- End PREFIX_WAVES_WPAPI_DIR Prefix /Library/Audio/Plug-Ins/WPAPI
        with Stage(r"Prefix /Library/Application Support/Waves...", prog_num=49):  # 0m:0.870s
            ...
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=50) as make_dir_029_50:  # 0m:0.003s
                make_dir_029_50()
            with Chown(path=r"/Library/Application Support/Waves", user_id=501, group_id=20, ignore_all_errors=True, prog_num=51, recursive=True) as chown_030_51:  # 0m:0.676s
                chown_030_51()
            with Chmod(path=r"/Library/Application Support/Waves", mode="a+rwX", prog_num=52, recursive=True) as chmod_031_52:  # 0m:0.192s
                chmod_031_52()
            # --- End PREFIX_WAVES_PROGRAMDATA_DIR Prefix /Library/Application Support/Waves
        with Stage(r"Prefix /Library/Application Support/Waves/Licenses...", prog_num=53):  # 0m:0.006s
            # --- Begin PREFIX_WAVES_LICENSES_DIR Prefix /Library/Application Support/Waves/Licenses
            with MakeDir(r"/Library/Application Support/Waves/Licenses", chowner=True, prog_num=54) as make_dir_032_54:  # 0m:0.003s
                make_dir_032_54()
        ...
        with Stage(r"Prefix /Users/Shared/Waves...", prog_num=58):  # 0m:0.045s
            # --- Begin PREFIX_WAVES_SHARED_DIR Prefix /Users/Shared/Waves
            with MakeDir(r"/Users/Shared/Waves", prog_num=59) as make_dir_035_59:  # 0m:0.002s
                make_dir_035_59()
            with Chmod(path=r"/Users/Shared/Waves", mode="a+rwX", prog_num=60, recursive=True) as chmod_036_60:  # 0m:0.043s
                chmod_036_60()
            # --- End PREFIX_WAVES_SHARED_DIR Prefix /Users/Shared/Waves
        with Stage(r"Prefix /Library/Audio/Plug-Ins/Components...", prog_num=61):  # 0m:0.161s
            # --- Begin PREFIX_WAVESHELL_AU_DIR Prefix /Library/Audio/Plug-Ins/Components
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=62) as make_dir_037_62:  # 0m:0.002s
                make_dir_037_62()
            with Chmod(path=r"/Library/Audio/Plug-Ins/Components", mode="a+rwX", ignore_if_not_exist=True, prog_num=63) as chmod_038_63:  # 0m:0.000s
                chmod_038_63()
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*.component", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=64) as glober_039_64:  # 0m:0.109s
                glober_039_64()
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*.component", Chmod, None, r"a+rwX", recursive=True, prog_num=65) as glober_040_65:  # 0m:0.049s
                glober_040_65()
        ...
        with Stage(r"Prefix /Library/Application Support/Digidesign/Plug-Ins...", prog_num=66):  # 0m:0.001s
            ...
            with Chmod(path=r"/Library/Application Support/Digidesign/Plug-Ins", mode="a+rwX", ignore_if_not_exist=True, prog_num=67) as chmod_041_67:  # 0m:0.000s
                chmod_041_67()
            with Glober(r"/Library/Application Support/Digidesign/Plug-Ins/WaveShell*.dpm", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=68) as glober_042_68:  # 0m:0.001s
                glober_042_68()
        ...
        with Stage(r"Prefix /Library/Application Support/Propellerhead Software/ReWire...", prog_num=77):  # 0m:0.020s
        ...
        with Stage(r"Prefix Native Instruments .plist files on Mac...", prog_num=84):  # 0m:0.023s
            # --- Begin PREFIX_NATIVE_INSTRUMENTS_PLIST Prefix Native Instruments .plist files on Mac
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*.plist", Chown, r"path", user_id=501, group_id=20, prog_num=85) as glober_056_85:  # 0m:0.015s
                glober_056_85()
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*.plist", Chmod, None, r"a+rwX", prog_num=86) as glober_057_86:  # 0m:0.008s
                glober_057_86()
        ...
        with Stage(r"Prefix /Library/Application Support/Native Instruments/Service Center...", prog_num=87):  # 0m:0.022s
            ...
            with Chmod(path=r"/Library/Application Support/Native Instruments/Service Center", mode="a+rwX", ignore_if_not_exist=True, prog_num=89) as chmod_059_89:  # 0m:0.000s
                chmod_059_89()
            with Glober(r"/Library/Application Support/Native Instruments/Service Center/Waves-*", Chown, r"path", user_id=501, group_id=20, prog_num=90) as glober_060_90:  # 0m:0.012s
                glober_060_90()
            with Glober(r"/Library/Application Support/Native Instruments/Service Center/Waves-*", Chmod, None, r"a+rw", prog_num=91) as glober_061_91:  # 0m:0.006s
                glober_061_91()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Caches/numba to read write all...", prog_num=98):  # 0m:0.009s
            # --- Begin PREFIX_NUMBA_CACHE_FOLDER Prefix /Users/rsp_ms/Library/Caches/numba to read write all
            with Chown(path=r"/Users/rsp_ms/Library/Caches/numba", user_id=501, group_id=20, ignore_all_errors=True, prog_num=99, recursive=True) as chown_066_99:  # 0m:0.005s
                chown_066_99()
            with Chmod(path=r"/Users/rsp_ms/Library/Caches/numba", mode="a+rwX", ignore_if_not_exist=True, prog_num=100, recursive=True) as chmod_067_100:  # 0m:0.004s
                chmod_067_100()
            # --- End PREFIX_NUMBA_CACHE_FOLDER Prefix /Users/rsp_ms/Library/Caches/numba to read write all
    with Stage(r"post_doit", prog_num=101):  # 0m:0.000s
        print("Done Doing it")

with Stage(r"epilog", prog_num=102):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/permissionFixer/permission-fixer_16-20250823213832.py", prog_num=103) as patch_py_batch_with_timings_068_103:  # ?
