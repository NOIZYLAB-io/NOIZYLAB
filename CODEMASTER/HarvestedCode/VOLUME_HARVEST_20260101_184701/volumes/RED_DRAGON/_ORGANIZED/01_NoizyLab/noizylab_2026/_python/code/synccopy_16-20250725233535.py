...
with Stage(r"assign", prog_num=555):
...
with PythonBatchRuntime(r"synccopy", prog_num=556):
    with Stage(r"begin", prog_num=557):
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=558):
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233535_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=559) as copy_file_to_file_001_559:
            copy_file_to_file_001_559()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233535_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=560) as copy_file_to_file_002_560:
            copy_file_to_file_002_560()
    with Stage(r"sync", prog_num=561):
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=562) as shell_command_003_562:
            shell_command_003_562()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=563) as shell_command_004_563:
            shell_command_004_563()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=564) as shell_command_005_564:
            shell_command_005_564()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=565) as shell_command_006_565:
            shell_command_006_565()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=566) as shell_command_007_566:
            shell_command_007_566()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=567) as shell_command_008_567:
            shell_command_008_567()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=568) as shell_command_009_568:
            shell_command_009_568()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=569) as shell_command_010_569:
            shell_command_010_569()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=570) as shell_command_011_570:
            shell_command_011_570()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=571):
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=572) as make_dir_012_572:
                make_dir_012_572()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=573) as cd_013_573:
                cd_013_573()
                Progress(r"670 files already in cache", own_progress_count=670, prog_num=1243)()
                with Stage(r"post_sync", prog_num=1244):
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1245) as copy_file_to_file_014_1245:
                        copy_file_to_file_014_1245()
            Progress(r"Done sync", prog_num=1246)()
    with Stage(r"copy", prog_num=1247):
        with RunInThread(Ls(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", out_file=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/before-copy-sync-folder-manifest.txt"), thread_name=r"list_sync_folder", daemon=True, ignore_all_errors=True, prog_num=1248) as run_in_thread_015_1248:
            run_in_thread_015_1248()
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1249)()
        with Stage(r"create folders", prog_num=1250):
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=1251) as make_dir_016_1251:
                make_dir_016_1251()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=1252) as make_dir_017_1252:
                make_dir_017_1252()
            with MakeDir(r"/Applications/Waves/Data/Presets", chowner=True, prog_num=1253) as make_dir_018_1253:
                make_dir_018_1253()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=1254) as make_dir_019_1254:
                make_dir_019_1254()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=1255) as make_dir_020_1255:
                make_dir_020_1255()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=1256) as make_dir_021_1256:
                make_dir_021_1256()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1257) as make_dir_022_1257:
                make_dir_022_1257()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=1258) as make_dir_023_1258:
                make_dir_023_1258()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=1259) as make_dir_024_1259:
                make_dir_024_1259()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=1260) as make_dir_025_1260:
                make_dir_025_1260()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=1261) as make_dir_026_1261:
                make_dir_026_1261()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=1262) as make_dir_027_1262:
                make_dir_027_1262()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=1263) as make_dir_028_1263:
                make_dir_028_1263()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=1264) as make_dir_029_1264:
                make_dir_029_1264()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=1265) as make_dir_030_1265:
                make_dir_030_1265()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=1266) as make_dir_031_1266:
                make_dir_031_1266()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=1267) as make_dir_032_1267:
                make_dir_032_1267()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=1268) as make_dir_033_1268:
                make_dir_033_1268()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=1269) as make_dir_034_1269:
                make_dir_034_1269()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=1270) as make_dir_035_1270:
                make_dir_035_1270()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=1271) as make_dir_036_1271:
                make_dir_036_1271()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=1272) as rm_file_or_dir_037_1272:
            rm_file_or_dir_037_1272()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=1273) as shell_command_038_1273:
            shell_command_038_1273()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=1274) as shell_command_039_1274:
            shell_command_039_1274()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=1275) as shell_command_040_1275:
            shell_command_040_1275()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=1276) as shell_command_041_1276:
            shell_command_041_1276()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1277) as shell_command_042_1277:
            shell_command_042_1277()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1278) as shell_command_043_1278:
            shell_command_043_1278()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=1279) as shell_command_044_1279:
            shell_command_044_1279()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=1280) as shell_command_045_1280:
            shell_command_045_1280()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=1281) as shell_command_046_1281:
            shell_command_046_1281()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1282) as cd_stage_047_1282:
            cd_stage_047_1282()
            with SetExecPermissionsInSyncFolder(prog_num=1283) as set_exec_permissions_in_sync_folder_048_1283:
                set_exec_permissions_in_sync_folder_048_1283()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data", prog_num=1284) as cd_stage_049_1284:
            cd_stage_049_1284()
            with Stage(r"copy", r"ChainersChildExcludeList v1.0.0.1", prog_num=1285):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/ChainersChildExcludeList", r"/Applications/Waves/Data", skip_progress_count=3, prog_num=1286) as should_copy_source_050_1286:
                    ...
                    with Stage(r"copy source", r"Common/Data/ChainersChildExcludeList", prog_num=1287):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/ChainersChildExcludeList", user_id=-1, group_id=-1, prog_num=1289, recursive=True) as chown_052_1289:
                            chown_052_1289()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/Presets", prog_num=1290) as cd_stage_053_1290:
            cd_stage_053_1290()
            with Stage(r"copy", r"CLA MixHub Presets v1.0.0.8", prog_num=1291):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/CLA MixHub", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=1292) as should_copy_source_054_1292:
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/CLA MixHub", prog_num=1293):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/CLA MixHub", user_id=-1, group_id=-1, prog_num=1295, recursive=True) as chown_056_1295:
                            chown_056_1295()
            with Stage(r"copy", r"Scheps Omni Channel Presets v1.0.0.6", prog_num=1296):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/Scheps Omni Channel", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=1297) as should_copy_source_057_1297:
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/Scheps Omni Channel", prog_num=1298):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/Scheps Omni Channel", user_id=-1, group_id=-1, prog_num=1300, recursive=True) as chown_059_1300:
                            chown_059_1300()
            with RmFileOrDir(r"/Applications/Waves/Data/CLA MixHub Data", prog_num=1301) as rm_file_or_dir_060_1301:
                rm_file_or_dir_060_1301()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=1302) as cd_stage_061_1302:
            cd_stage_061_1302()
            with Stage(r"copy", r"CLA MixHub v16.0.64.65", prog_num=1303):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA MixHub.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1304) as should_copy_source_062_1304:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA MixHub.bundle", prog_num=1305):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA MixHub.bundle", where_to_unwtar=r".", prog_num=1307) as unwtar_064_1307:
                            unwtar_064_1307()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA MixHub.bundle", user_id=-1, group_id=-1, prog_num=1308, recursive=True) as chown_065_1308:
                            chown_065_1308()
            with Stage(r"copy", r"Scheps Omni Channel v16.0.64.65", prog_num=1309):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Scheps Omni Channel.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1310) as should_copy_source_066_1310:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/Scheps Omni Channel.bundle", prog_num=1311):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Scheps Omni Channel.bundle", where_to_unwtar=r".", prog_num=1313) as unwtar_068_1313:
                            unwtar_068_1313()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/Scheps Omni Channel.bundle", user_id=-1, group_id=-1, prog_num=1314, recursive=True) as chown_069_1314:
                            chown_069_1314()
            with Stage(r"copy", r"TRACT v16.0.64.65", prog_num=1315):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/TRACT.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1316) as should_copy_source_070_1316:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/TRACT.bundle", prog_num=1317):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/TRACT.bundle", where_to_unwtar=r".", prog_num=1319) as unwtar_072_1319:
                            unwtar_072_1319()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/TRACT.bundle", user_id=-1, group_id=-1, prog_num=1320, recursive=True) as chown_073_1320:
                            chown_073_1320()
            with Stage(r"copy", r"WavesLib1_16_0_64_65 v16.0.64.65", prog_num=1321):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.64.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1322) as should_copy_source_074_1322:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.64.framework", prog_num=1323):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.64.framework", where_to_unwtar=r".", prog_num=1325) as unwtar_076_1325:
                            unwtar_076_1325()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.64.framework", user_id=-1, group_id=-1, prog_num=1326, recursive=True) as chown_077_1326:
                            chown_077_1326()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=1328) as resolve_symlink_files_in_folder_078_1328:
                resolve_symlink_files_in_folder_078_1328()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=1329) as shell_command_079_1329:
                shell_command_079_1329()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=1330) as script_command_080_1330:
                script_command_080_1330()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1331) as shell_command_081_1331:
                shell_command_081_1331()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1332) as create_symlink_082_1332:
                create_symlink_082_1332()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1333) as create_symlink_083_1333:
                create_symlink_083_1333()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=1334) as copy_glob_to_dir_084_1334:
                copy_glob_to_dir_084_1334()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=1335) as cd_stage_085_1335:
            cd_stage_085_1335()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=1336):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=1337) as should_copy_source_086_1337:
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=1338):
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=1340) as chmod_and_chown_088_1340:
                            chmod_and_chown_088_1340()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=1341) as cd_stage_089_1341:
            cd_stage_089_1341()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1342):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1343) as should_copy_source_090_1343:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1344):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1347, recursive=True) as chown_093_1347:
                            chown_093_1347()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1348) as shell_command_094_1348:
                            shell_command_094_1348()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1349):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=1350) as should_copy_source_095_1350:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1351):
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1357, recursive=True) as chown_101_1357:
                            chown_101_1357()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1358, recursive=True) as chmod_102_1358:
                            chmod_102_1358()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1359):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1360) as should_copy_source_103_1360:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1361):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1364, recursive=True) as chown_106_1364:
                            chown_106_1364()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1365) as shell_command_107_1365:
                            shell_command_107_1365()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1366):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Applications/Waves/WaveShells V16", skip_progress_count=7, prog_num=1367) as should_copy_source_108_1367:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1368):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1374) as shell_command_114_1374:
                            shell_command_114_1374()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=1375):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=1376) as should_copy_source_115_1376:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=1377):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=1379) as unwtar_117_1379:
                            unwtar_117_1379()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=1380, recursive=True) as chown_118_1380:
                            chown_118_1380()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=1381) as shell_command_119_1381:
                shell_command_119_1381()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1382) as cd_stage_120_1382:
            cd_stage_120_1382()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1383):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=1384) as should_copy_source_121_1384:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1385):
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1388, recursive=True) as chown_124_1388:
                            chown_124_1388()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1389) as shell_command_125_1389:
                            shell_command_125_1389()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=1390) as cd_stage_126_1390:
            cd_stage_126_1390()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=1391):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=1392) as should_copy_source_127_1392:
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=1393):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=1395, recursive=True) as chown_129_1395:
                            chown_129_1395()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V16", prog_num=1396) as cd_stage_130_1396:
            cd_stage_130_1396()
            with Stage(r"copy", r"Demo Mode V16 1.1 v1.1", prog_num=1397):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V16/1", r"/Library/Application Support/Waves/Demo Mode/V16", skip_progress_count=3, prog_num=1398) as should_copy_source_131_1398:
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V16/1", prog_num=1399):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V16/1", user_id=-1, group_id=-1, prog_num=1401, recursive=True) as chown_133_1401:
                            chown_133_1401()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/License Notifications/V16", prog_num=1402) as cd_stage_134_1402:
            cd_stage_134_1402()
            with Stage(r"copy", r"License Notifications V16 1.1 v1.1", prog_num=1403):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/License Notifications/V16/1", r"/Library/Application Support/Waves/License Notifications/V16", skip_progress_count=3, prog_num=1404) as should_copy_source_135_1404:
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V16/1", prog_num=1405):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V16/1", user_id=-1, group_id=-1, prog_num=1407, recursive=True) as chown_137_1407:
                            chown_137_1407()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=1408) as cd_stage_138_1408:
            cd_stage_138_1408()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=1409) as rm_file_or_dir_139_1409:
                rm_file_or_dir_139_1409()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=1410):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=1411) as should_copy_source_140_1411:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=1412):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=1414) as unwtar_142_1414:
                            unwtar_142_1414()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=1415, recursive=True) as chown_143_1415:
                            chown_143_1415()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=1416):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=1417) as should_copy_source_144_1417:
                    should_copy_source_144_1417()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=1418):
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=1419) as unwtar_145_1419:
                            unwtar_145_1419()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=1420):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=1421) as should_copy_source_146_1421:
                    should_copy_source_146_1421()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=1422):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=1423) as copy_dir_to_dir_147_1423:
                            copy_dir_to_dir_147_1423()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=1424) as unwtar_148_1424:
                            unwtar_148_1424()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=1425, recursive=True) as chown_149_1425:
                            chown_149_1425()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=1426):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=1427) as should_copy_source_150_1427:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=1428):
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=1431) as chmod_153_1431:
                            chmod_153_1431()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=1432, recursive=True) as chown_154_1432:
                            chown_154_1432()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=1435) as resolve_symlink_files_in_folder_155_1435:
                resolve_symlink_files_in_folder_155_1435()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1436) as shell_command_156_1436:
                shell_command_156_1436()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=1437) as cd_stage_157_1437:
            cd_stage_157_1437()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=1438):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=1439) as should_copy_source_158_1439:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=1440):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=1442, recursive=True) as chown_160_1442:
                            chown_160_1442()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=1443) as cd_stage_161_1443:
            cd_stage_161_1443()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=1444):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=1445) as should_copy_source_162_1445:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=1446):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=1448, recursive=True) as chown_164_1448:
                            chown_164_1448()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=1449) as cd_stage_165_1449:
            cd_stage_165_1449()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=1450):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=1451) as should_copy_source_166_1451:
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=1452):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=1456, recursive=True) as chown_170_1456:
                            chown_170_1456()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233535-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=1457) as if_171_1457:
                            if_171_1457()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=1458) as cd_stage_172_1458:
            cd_stage_172_1458()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1459):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=1460) as should_copy_source_173_1460:
                    should_copy_source_173_1460()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1461):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=1462) as copy_dir_to_dir_174_1462:
                            copy_dir_to_dir_174_1462()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=1463) as unwtar_175_1463:
                            unwtar_175_1463()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1464, recursive=True) as chown_176_1464:
                            chown_176_1464()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=1465) as break_hard_link_177_1465:
                            break_hard_link_177_1465()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=1466) as shell_command_178_1466:
                            shell_command_178_1466()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1467, recursive=True) as chown_179_1467:
                            chown_179_1467()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1468, recursive=True) as chmod_180_1468:
                            chmod_180_1468()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=1469) as cd_stage_181_1469:
            cd_stage_181_1469()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1470):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=1471) as should_copy_source_182_1471:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1472):
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1475, recursive=True) as chown_185_1475:
                            chown_185_1475()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1476) as shell_command_186_1476:
                            shell_command_186_1476()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1477) as cd_stage_187_1477:
            cd_stage_187_1477()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1478):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=1479) as should_copy_source_188_1479:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1480):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1486) as shell_command_194_1486:
                            shell_command_194_1486()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1487) as create_symlink_195_1487:
                create_symlink_195_1487()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1488) as create_symlink_196_1488:
                create_symlink_196_1488()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=1489) as rm_file_or_dir_197_1489:
            rm_file_or_dir_197_1489()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=1490) as shell_command_198_1490:
            shell_command_198_1490()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=1491) as script_command_199_1491:
            script_command_199_1491()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=1492) as rm_file_or_dir_200_1492:
            rm_file_or_dir_200_1492()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=1493) as glober_201_1493:
            glober_201_1493()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=1494) as glober_202_1494:
            glober_202_1494()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=1495) as glober_203_1495:
            glober_203_1495()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1496) as shell_command_204_1496:
            shell_command_204_1496()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1497) as shell_command_205_1497:
            shell_command_205_1497()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1498) as shell_command_206_1498:
            shell_command_206_1498()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1499) as shell_command_207_1499:
            shell_command_207_1499()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=1500) as shell_command_208_1500:
            shell_command_208_1500()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=1501) as script_command_209_1501:
            script_command_209_1501()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=1502) as if_210_1502:
            if_210_1502()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=1503) as if_211_1503:
            if_211_1503()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=1504) as shell_command_212_1504:
            shell_command_212_1504()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=1505) as script_command_213_1505:
            script_command_213_1505()
    with Stage(r"post-copy", prog_num=1506):
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1507) as make_dir_214_1507:
            make_dir_214_1507()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1508) as copy_file_to_file_215_1508:
            copy_file_to_file_215_1508()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1509) as chmod_216_1509:
            chmod_216_1509()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1510) as chmod_217_1510:
            chmod_217_1510()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=1511) as copy_file_to_file_218_1511:
            copy_file_to_file_218_1511()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1512) as chmod_219_1512:
            chmod_219_1512()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=1513) as copy_file_to_file_220_1513:
            copy_file_to_file_220_1513()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1514) as chmod_221_1514:
            chmod_221_1514()
        Progress(r"Done copy", prog_num=1515)()
        Progress(r"Done synccopy", prog_num=1516)()
    with Stage(r"post", prog_num=1517):
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1518) as make_dir_222_1518:
            make_dir_222_1518()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=1519) as copy_file_to_file_223_1519:
            copy_file_to_file_223_1519()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1520) as make_dir_224_1520:
            make_dir_224_1520()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/9/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=1521) as copy_file_to_file_225_1521:
            copy_file_to_file_225_1521()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1522) as make_dir_226_1522:
            make_dir_226_1522()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/9/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=1523) as copy_file_to_file_227_1523:
