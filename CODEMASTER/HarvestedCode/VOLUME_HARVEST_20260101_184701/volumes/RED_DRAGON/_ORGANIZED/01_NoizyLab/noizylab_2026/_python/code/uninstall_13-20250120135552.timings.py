...
with Stage(r"assign", prog_num=307):  # 0m:0.000s
...
with PythonBatchRuntime(r"uninstall", prog_num=308):  # 0m:0.001s
    with Stage(r"begin", prog_num=309):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=310):  # 0m:0.000s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V13/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/uninstall/uninstall_13-20250120135552_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=311) as copy_file_to_file_001_311:  # 0m:0.000s
            copy_file_to_file_001_311()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V13/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/uninstall/uninstall_13-20250120135552_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=312) as copy_file_to_file_002_312:  # 0m:0.000s
