...
def main():
    ...
    subprocess.run(["launchctl", "unload", str(pathlib.Path.home() / "Library/LaunchAgents/com.noizyfish.catalog.plist")])
    subprocess.run("launchctl list | grep noizyfish", shell=True)
