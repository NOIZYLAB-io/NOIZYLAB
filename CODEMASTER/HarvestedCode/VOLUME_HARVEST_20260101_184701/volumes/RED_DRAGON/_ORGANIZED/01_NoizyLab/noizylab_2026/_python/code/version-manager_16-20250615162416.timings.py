...
with PythonBatchRuntime(r"exec", prog_num=1):  # 0m:0.483s
    with Stage(r"doit", prog_num=2):  # 0m:0.483s
        with ShellCommand(r"'/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility' -s", ignore_all_errors=True, prog_num=3) as shell_command_001_3:  # 0m:0.421s
            shell_command_001_3()
        with ShellCommand(r"'/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility' -s", ignore_all_errors=True, prog_num=4) as shell_command_002_4:  # 0m:0.061s
            shell_command_002_4()
