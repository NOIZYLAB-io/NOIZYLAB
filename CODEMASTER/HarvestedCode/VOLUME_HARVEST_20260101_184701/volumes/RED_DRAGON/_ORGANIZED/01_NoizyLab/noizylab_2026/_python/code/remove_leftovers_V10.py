...
the_current_os = config_vars["__CURRENT_OS__"].str()
...
if not 'get_info_from_plugin' in dir(utils):
    ...
    log.info('Not supported instl version')
    sys.exit(0)
...
def main():
    ...
    plugin_path = str(config_vars["WAVES_PLUGINS_DIR"])
    #venue_path = var_stack.ResolveVarToStr("WAVES_SOUNDGRID_FOR_VENUE_DIR")
    venue_path = str(config_vars["WAVES_SOUNDGRID_FOR_VENUE_DIR"])
    #studio_path = var_stack.ResolveVarToStr("WAVES_SOUNDGRID_STUDIO_DIR")
    studio_path = str(config_vars["WAVES_SOUNDGRID_STUDIO_DIR"])
    ...
    ignore_folder_regex_list = list(config_vars["CHECK_BINARIES_VERSION_FOLDER_EXCLUDE_REGEX_FOR_REMOVE_LEFTOVERS"])
    ignore_regexes_filter.set_folder_ignore_regexes(ignore_folder_regex_list)

    #build list of plugin dictionaries, list of ArtistDlls folders and list of waveslib's
    ...
    artistdlls_list = list()
    waveslib_list = list()
    for a_item in binaries_version_from_plugin_folder:
        if 'ArtistDlls' in a_item[0]:
            artistdlls_list.append(os.path.split(a_item[0])[0])
        elif 'bundle' in a_item[0]:
            plugin_info_list.append(utils.get_info_from_plugin(None,a_item[0]))
        elif 'WavesLib' in a_item[0]:
            waveslib_list.append(a_item)

    for artistdlls_item in artistdlls_list:
        if os.path.exists(artistdlls_item):
            remove_item = True
            for plugin_item in plugin_info_list:
                artistdlls_name = plugin_item.get('ArtistDlls', None)
                if artistdlls_name in artistdlls_item:
                    remove_item = False
                    break
            if remove_item:
                #print('Removing left over - '+artistdlls_item,flush=True)
                log.info('Removing left over - '+artistdlls_item)
                utils.safe_remove_file_system_object(artistdlls_item)
    ...
    for waveslib_item in waveslib_list:
        ...
        if remove_item:
            ...
            log.info('Removing left over - '+waveslib_item[0])
            ...
            if 'WavesLib_9.6' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls1')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls1')
            ...
            if 'WavesLib_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls2')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls2')
            ...
            if 'WavesLib3_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls3')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls3')
            ...
            if 'WavesLib4_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls4')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls4')
            ...
            if 'WavesLib5_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls5')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls5')
            ...
            if 'WavesLib6_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls6')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls6')
            ...
            if 'WavesLib7_9.91' in waveslib_item[0]:
                if the_current_os == "Mac":
                    ...
                    log.info('Removing left over - /Applications/Waves/Plug-Ins V9/ArtistDlls7')
                ...
                if the_current_os == "Win":
                    ...
                    log.info('Removing left over - C:\Program Files (x86)\Waves\Plug-Ins V9\ArtistDlls7')
    ...
    shells_dirs = list(config_vars["WAVES_SHELL_DIRS"])
            ...
            if 'WaveShell' in shell_item[0] and 'Waves AU Reg Utility' not in shell_item[0]:
                ...
                if remove_item and plugin_ver in shell_item[0]:
                    if 'WPAPI' not in shell_item[0]:
                        ...
                        log.info('Removing left over - '+shell_item[0])
                    ...
                    if the_current_os == "Mac":
                        if '-AU ' in shell_item[0] and '/Applications/Waves/WaveShells' in shell_item[0]:
                            ...
                            log.info('Removing left over - '+waveshell_path+'Waves AU Reg Utility'+infra+' '+major+'.'+minor+'.app')
