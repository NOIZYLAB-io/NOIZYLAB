...
Onboarding & Advanced Extension Points:
To get started, create and activate a Python 3 virtual environment, install requirements, and launch the assistant. Choose your workflow (Audio/Media Automation or General Automation). Extend by adding new handler functions and registering them in the menu. For advanced features, add new menu actions and handlers. For NGR integration, add new handler functions for routing, approval, and feedback, and register NGR-specific actions and workflows. For market adaptation, create new menu functions and register them. Handlers can be reused or customized per market.

Example NGR Extension:
def ngr_menu():
        return {'1': handle_ng_voice, '2': handle_ng_batch, '3': help_menu}
