...
with Stage(r"assign", prog_num=560):
...
with PythonBatchRuntime(r"synccopy", prog_num=561):
    with Stage(r"begin", prog_num=562):
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=563):
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233326_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=564) as copy_file_to_file_001_564:
    ...
    with Stage(r"sync", prog_num=566):
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=567) as shell_command_003_567:
            shell_command_003_567()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=568) as shell_command_004_568:
            shell_command_004_568()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=569) as shell_command_005_569:
            shell_command_005_569()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=570) as shell_command_006_570:
            shell_command_006_570()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=571) as shell_command_007_571:
            shell_command_007_571()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=572) as shell_command_008_572:
            shell_command_008_572()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=573) as shell_command_009_573:
            shell_command_009_573()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=574) as shell_command_010_574:
            shell_command_010_574()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=575) as shell_command_011_575:
            shell_command_011_575()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=576):
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=577) as make_dir_012_577:
                make_dir_012_577()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=578) as cd_013_578:
                cd_013_578()
                Progress(r"614 files already in cache", own_progress_count=614, prog_num=1192)()
                with CreateSyncFolders(own_progress_count=35, prog_num=1227) as create_sync_folders_014_1227:
                    create_sync_folders_014_1227()
                Progress(r"Downloading with 50 processes in parallel", prog_num=1228)()
                Progress(r"Downloading with curl parallel", prog_num=1229)()
                with CurlWithInternalParallel(curl_path=r"curl", config_file_path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233326.py_curl/dl-00", total_files_to_download=56, previously_downloaded_files=0, total_bytes_to_download=35101503, own_progress_count=40, prog_num=1269, report_own_progress=False) as curl_with_internal_parallel_015_1269:
                ...
                Progress(r"Downloading 56 files done", prog_num=1286)()
                ...
                Progress(r"Check checksum ...", prog_num=1288)()
                with CheckDownloadFolderChecksum(print_report=True, raise_on_bad_checksum=True, max_bad_files_to_redownload=32, own_progress_count=56, prog_num=1344) as check_download_folder_checksum_018_1344:
                    check_download_folder_checksum_018_1344()
                with Stage(r"post_sync", prog_num=1345):
                    Progress(r"Adjust ownership and permissions /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16...", prog_num=1346)()
                    with ChmodAndChown(path=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", mode="a+rwX", user_id=-1, group_id=-1, ignore_all_errors=True, prog_num=1347, recursive=True) as chmod_and_chown_019_1347:
                        chmod_and_chown_019_1347()
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1348) as copy_file_to_file_020_1348:
                        copy_file_to_file_020_1348()
            Progress(r"Done sync", prog_num=1349)()
    with Stage(r"copy", prog_num=1350):
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1351)()
        with Stage(r"create folders", prog_num=1352):
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=1353) as make_dir_021_1353:
                make_dir_021_1353()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=1354) as make_dir_022_1354:
                make_dir_022_1354()
            with MakeDir(r"/Applications/Waves/Data/Presets", chowner=True, prog_num=1355) as make_dir_023_1355:
                make_dir_023_1355()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=1356) as make_dir_024_1356:
                make_dir_024_1356()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=1357) as make_dir_025_1357:
                make_dir_025_1357()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=1358) as make_dir_026_1358:
                make_dir_026_1358()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1359) as make_dir_027_1359:
                make_dir_027_1359()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=1360) as make_dir_028_1360:
                make_dir_028_1360()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=1361) as make_dir_029_1361:
                make_dir_029_1361()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=1362) as make_dir_030_1362:
                make_dir_030_1362()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=1363) as make_dir_031_1363:
                make_dir_031_1363()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=1364) as make_dir_032_1364:
                make_dir_032_1364()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=1365) as make_dir_033_1365:
                make_dir_033_1365()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=1366) as make_dir_034_1366:
                make_dir_034_1366()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=1367) as make_dir_035_1367:
                make_dir_035_1367()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=1368) as make_dir_036_1368:
                make_dir_036_1368()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=1369) as make_dir_037_1369:
                make_dir_037_1369()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=1370) as make_dir_038_1370:
                make_dir_038_1370()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=1371) as make_dir_039_1371:
                make_dir_039_1371()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=1372) as make_dir_040_1372:
                make_dir_040_1372()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=1373) as make_dir_041_1373:
                make_dir_041_1373()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=1374) as rm_file_or_dir_042_1374:
            rm_file_or_dir_042_1374()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=1375) as shell_command_043_1375:
            shell_command_043_1375()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=1376) as shell_command_044_1376:
            shell_command_044_1376()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=1377) as shell_command_045_1377:
            shell_command_045_1377()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=1378) as shell_command_046_1378:
            shell_command_046_1378()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1379) as shell_command_047_1379:
            shell_command_047_1379()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1380) as shell_command_048_1380:
            shell_command_048_1380()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=1381) as shell_command_049_1381:
            shell_command_049_1381()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=1382) as shell_command_050_1382:
            shell_command_050_1382()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=1383) as shell_command_051_1383:
            shell_command_051_1383()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1384) as cd_stage_052_1384:
            cd_stage_052_1384()
            with SetExecPermissionsInSyncFolder(prog_num=1385) as set_exec_permissions_in_sync_folder_053_1385:
                set_exec_permissions_in_sync_folder_053_1385()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data", prog_num=1386) as cd_stage_054_1386:
            cd_stage_054_1386()
            with Stage(r"copy", r"ChainersChildExcludeList v1.0.0.1", prog_num=1387):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/ChainersChildExcludeList", r"/Applications/Waves/Data", skip_progress_count=3, prog_num=1388) as should_copy_source_055_1388:
                    ...
                    with Stage(r"copy source", r"Common/Data/ChainersChildExcludeList", prog_num=1389):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/ChainersChildExcludeList", user_id=-1, group_id=-1, prog_num=1391, recursive=True) as chown_057_1391:
                            chown_057_1391()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/Presets", prog_num=1392) as cd_stage_058_1392:
            cd_stage_058_1392()
            with Stage(r"copy", r"CLA MixHub Presets v1.0.0.8", prog_num=1393):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/CLA MixHub", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=1394) as should_copy_source_059_1394:
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/CLA MixHub", prog_num=1395):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/CLA MixHub", user_id=-1, group_id=-1, prog_num=1397, recursive=True) as chown_061_1397:
                            chown_061_1397()
            with Stage(r"copy", r"Scheps Omni Channel Presets v1.0.0.6", prog_num=1398):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/Scheps Omni Channel", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=1399) as should_copy_source_062_1399:
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/Scheps Omni Channel", prog_num=1400):
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/Scheps Omni Channel", user_id=-1, group_id=-1, prog_num=1402, recursive=True) as chown_064_1402:
                            chown_064_1402()
            with RmFileOrDir(r"/Applications/Waves/Data/CLA MixHub Data", prog_num=1403) as rm_file_or_dir_065_1403:
                rm_file_or_dir_065_1403()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=1404) as cd_stage_066_1404:
            cd_stage_066_1404()
            with Stage(r"copy", r"CLA MixHub v16.0.64.65", prog_num=1405):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA MixHub.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1406) as should_copy_source_067_1406:
                    should_copy_source_067_1406()
                    with Stage(r"copy source", r"Mac/Plugins/CLA MixHub.bundle", prog_num=1407):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA MixHub.bundle", r".", delete_extraneous_files=True, prog_num=1408) as copy_dir_to_dir_068_1408:
                            copy_dir_to_dir_068_1408()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA MixHub.bundle", where_to_unwtar=r".", prog_num=1409) as unwtar_069_1409:
                            unwtar_069_1409()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA MixHub.bundle", user_id=-1, group_id=-1, prog_num=1410, recursive=True) as chown_070_1410:
                            chown_070_1410()
            with Stage(r"copy", r"Scheps Omni Channel v16.0.64.65", prog_num=1411):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Scheps Omni Channel.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1412) as should_copy_source_071_1412:
                    should_copy_source_071_1412()
                    with Stage(r"copy source", r"Mac/Plugins/Scheps Omni Channel.bundle", prog_num=1413):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Scheps Omni Channel.bundle", r".", delete_extraneous_files=True, prog_num=1414) as copy_dir_to_dir_072_1414:
                            copy_dir_to_dir_072_1414()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Scheps Omni Channel.bundle", where_to_unwtar=r".", prog_num=1415) as unwtar_073_1415:
                            unwtar_073_1415()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/Scheps Omni Channel.bundle", user_id=-1, group_id=-1, prog_num=1416, recursive=True) as chown_074_1416:
                            chown_074_1416()
            with Stage(r"copy", r"TRACT v16.0.64.65", prog_num=1417):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/TRACT.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1418) as should_copy_source_075_1418:
                    should_copy_source_075_1418()
                    with Stage(r"copy source", r"Mac/Plugins/TRACT.bundle", prog_num=1419):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/TRACT.bundle", r".", delete_extraneous_files=True, prog_num=1420) as copy_dir_to_dir_076_1420:
                            copy_dir_to_dir_076_1420()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/TRACT.bundle", where_to_unwtar=r".", prog_num=1421) as unwtar_077_1421:
                            unwtar_077_1421()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/TRACT.bundle", user_id=-1, group_id=-1, prog_num=1422, recursive=True) as chown_078_1422:
                            chown_078_1422()
            with Stage(r"copy", r"WavesLib1_16_0_64_65 v16.0.64.65", prog_num=1423):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.64.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1424) as should_copy_source_079_1424:
                    should_copy_source_079_1424()
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.64.framework", prog_num=1425):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.64.framework", r".", delete_extraneous_files=True, prog_num=1426) as copy_dir_to_dir_080_1426:
                            copy_dir_to_dir_080_1426()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.64.framework", where_to_unwtar=r".", prog_num=1427) as unwtar_081_1427:
                            unwtar_081_1427()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.64.framework", user_id=-1, group_id=-1, prog_num=1428, recursive=True) as chown_082_1428:
                            chown_082_1428()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=1430) as resolve_symlink_files_in_folder_083_1430:
                resolve_symlink_files_in_folder_083_1430()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=1431) as shell_command_084_1431:
                shell_command_084_1431()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=1432) as script_command_085_1432:
                script_command_085_1432()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1433) as shell_command_086_1433:
                shell_command_086_1433()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1434) as create_symlink_087_1434:
                create_symlink_087_1434()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1435) as create_symlink_088_1435:
                create_symlink_088_1435()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=1436) as copy_glob_to_dir_089_1436:
                copy_glob_to_dir_089_1436()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=1437) as cd_stage_090_1437:
            cd_stage_090_1437()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=1438):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=1439) as should_copy_source_091_1439:
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=1440):
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=1442) as chmod_and_chown_093_1442:
                            chmod_and_chown_093_1442()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=1443) as cd_stage_094_1443:
            cd_stage_094_1443()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1444):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1445) as should_copy_source_095_1445:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1446):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1449, recursive=True) as chown_098_1449:
                            chown_098_1449()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1450) as shell_command_099_1450:
                            shell_command_099_1450()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1451):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=1452) as should_copy_source_100_1452:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1453):
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1459, recursive=True) as chown_106_1459:
                            chown_106_1459()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1460, recursive=True) as chmod_107_1460:
                            chmod_107_1460()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1461):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1462) as should_copy_source_108_1462:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1463):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1466, recursive=True) as chown_111_1466:
                            chown_111_1466()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1467) as shell_command_112_1467:
                            shell_command_112_1467()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1468):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Applications/Waves/WaveShells V16", skip_progress_count=7, prog_num=1469) as should_copy_source_113_1469:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1470):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1476) as shell_command_119_1476:
                            shell_command_119_1476()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=1477):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=1478) as should_copy_source_120_1478:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=1479):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=1481) as unwtar_122_1481:
                            unwtar_122_1481()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=1482, recursive=True) as chown_123_1482:
                            chown_123_1482()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=1483) as shell_command_124_1483:
                shell_command_124_1483()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1484) as cd_stage_125_1484:
            cd_stage_125_1484()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1485):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=1486) as should_copy_source_126_1486:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1487):
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1490, recursive=True) as chown_129_1490:
                            chown_129_1490()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1491) as shell_command_130_1491:
                            shell_command_130_1491()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=1492) as cd_stage_131_1492:
            cd_stage_131_1492()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=1493):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=1494) as should_copy_source_132_1494:
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=1495):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=1497, recursive=True) as chown_134_1497:
                            chown_134_1497()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V16", prog_num=1498) as cd_stage_135_1498:
            cd_stage_135_1498()
            with Stage(r"copy", r"Demo Mode V16 1.1 v1.1", prog_num=1499):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V16/1", r"/Library/Application Support/Waves/Demo Mode/V16", skip_progress_count=3, prog_num=1500) as should_copy_source_136_1500:
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V16/1", prog_num=1501):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V16/1", user_id=-1, group_id=-1, prog_num=1503, recursive=True) as chown_138_1503:
                            chown_138_1503()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/License Notifications/V16", prog_num=1504) as cd_stage_139_1504:
            cd_stage_139_1504()
            with Stage(r"copy", r"License Notifications V16 1.1 v1.1", prog_num=1505):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/License Notifications/V16/1", r"/Library/Application Support/Waves/License Notifications/V16", skip_progress_count=3, prog_num=1506) as should_copy_source_140_1506:
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V16/1", prog_num=1507):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V16/1", user_id=-1, group_id=-1, prog_num=1509, recursive=True) as chown_142_1509:
                            chown_142_1509()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=1510) as cd_stage_143_1510:
            cd_stage_143_1510()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=1511) as rm_file_or_dir_144_1511:
                rm_file_or_dir_144_1511()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=1512):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=1513) as should_copy_source_145_1513:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=1514):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=1516) as unwtar_147_1516:
                            unwtar_147_1516()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=1517, recursive=True) as chown_148_1517:
                            chown_148_1517()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=1518):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=1519) as should_copy_source_149_1519:
                    should_copy_source_149_1519()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=1520):
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=1521) as unwtar_150_1521:
                            unwtar_150_1521()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=1522):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=1523) as should_copy_source_151_1523:
                    should_copy_source_151_1523()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=1524):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=1525) as copy_dir_to_dir_152_1525:
                            copy_dir_to_dir_152_1525()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=1526) as unwtar_153_1526:
                            unwtar_153_1526()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=1527, recursive=True) as chown_154_1527:
                            chown_154_1527()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=1528):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=1529) as should_copy_source_155_1529:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=1530):
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=1533) as chmod_158_1533:
                            chmod_158_1533()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=1534, recursive=True) as chown_159_1534:
                            chown_159_1534()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=1537) as resolve_symlink_files_in_folder_160_1537:
                resolve_symlink_files_in_folder_160_1537()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1538) as shell_command_161_1538:
                shell_command_161_1538()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=1539) as cd_stage_162_1539:
            cd_stage_162_1539()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=1540):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=1541) as should_copy_source_163_1541:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=1542):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=1544, recursive=True) as chown_165_1544:
                            chown_165_1544()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=1545) as cd_stage_166_1545:
            cd_stage_166_1545()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=1546):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=1547) as should_copy_source_167_1547:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=1548):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=1550, recursive=True) as chown_169_1550:
                            chown_169_1550()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=1551) as cd_stage_170_1551:
            cd_stage_170_1551()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=1552):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=1553) as should_copy_source_171_1553:
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=1554):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=1558, recursive=True) as chown_175_1558:
                            chown_175_1558()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250725233326-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=1559) as if_176_1559:
                            if_176_1559()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=1560) as cd_stage_177_1560:
            cd_stage_177_1560()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1561):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=1562) as should_copy_source_178_1562:
                    should_copy_source_178_1562()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1563):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=1564) as copy_dir_to_dir_179_1564:
                            copy_dir_to_dir_179_1564()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=1565) as unwtar_180_1565:
                            unwtar_180_1565()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1566, recursive=True) as chown_181_1566:
                            chown_181_1566()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=1567) as break_hard_link_182_1567:
                            break_hard_link_182_1567()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=1568) as shell_command_183_1568:
                            shell_command_183_1568()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1569, recursive=True) as chown_184_1569:
                            chown_184_1569()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1570, recursive=True) as chmod_185_1570:
                            chmod_185_1570()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=1571) as cd_stage_186_1571:
            cd_stage_186_1571()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1572):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=1573) as should_copy_source_187_1573:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1574):
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1577, recursive=True) as chown_190_1577:
                            chown_190_1577()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1578) as shell_command_191_1578:
                            shell_command_191_1578()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1579) as cd_stage_192_1579:
            cd_stage_192_1579()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1580):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=1581) as should_copy_source_193_1581:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1582):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1588) as shell_command_199_1588:
                            shell_command_199_1588()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1589) as create_symlink_200_1589:
                create_symlink_200_1589()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1590) as create_symlink_201_1590:
                create_symlink_201_1590()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=1591) as rm_file_or_dir_202_1591:
            rm_file_or_dir_202_1591()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=1592) as shell_command_203_1592:
            shell_command_203_1592()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=1593) as script_command_204_1593:
            script_command_204_1593()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=1594) as rm_file_or_dir_205_1594:
            rm_file_or_dir_205_1594()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=1595) as glober_206_1595:
            glober_206_1595()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=1596) as glober_207_1596:
            glober_207_1596()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=1597) as glober_208_1597:
            glober_208_1597()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1598) as shell_command_209_1598:
            shell_command_209_1598()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1599) as shell_command_210_1599:
            shell_command_210_1599()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1600) as shell_command_211_1600:
            shell_command_211_1600()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1601) as shell_command_212_1601:
            shell_command_212_1601()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=1602) as shell_command_213_1602:
            shell_command_213_1602()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=1603) as script_command_214_1603:
            script_command_214_1603()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=1604) as if_215_1604:
            if_215_1604()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=1605) as if_216_1605:
            if_216_1605()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=1606) as shell_command_217_1606:
            shell_command_217_1606()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=1607) as script_command_218_1607:
            script_command_218_1607()
    with Stage(r"post-copy", prog_num=1608):
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1609) as make_dir_219_1609:
            make_dir_219_1609()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1610) as copy_file_to_file_220_1610:
            copy_file_to_file_220_1610()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1611) as chmod_221_1611:
            chmod_221_1611()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1612) as chmod_222_1612:
            chmod_222_1612()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=1613) as copy_file_to_file_223_1613:
            copy_file_to_file_223_1613()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1614) as chmod_224_1614:
            chmod_224_1614()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=1615) as copy_file_to_file_225_1615:
            copy_file_to_file_225_1615()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1616) as chmod_226_1616:
            chmod_226_1616()
        Progress(r"Done copy", prog_num=1617)()
        Progress(r"Done synccopy", prog_num=1618)()
    with Stage(r"post", prog_num=1619):
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1620) as make_dir_227_1620:
            make_dir_227_1620()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=1621) as copy_file_to_file_228_1621:
            copy_file_to_file_228_1621()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1622) as make_dir_229_1622:
            make_dir_229_1622()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/9/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=1623) as copy_file_to_file_230_1623:
            copy_file_to_file_230_1623()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1624) as make_dir_231_1624:
            make_dir_231_1624()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/9/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=1625) as copy_file_to_file_232_1625:
