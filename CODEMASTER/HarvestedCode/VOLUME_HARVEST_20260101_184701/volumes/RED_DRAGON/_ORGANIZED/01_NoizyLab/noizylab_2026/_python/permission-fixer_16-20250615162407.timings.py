...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:7.780s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:7.779s
        with Stage(r"Prefix /Applications/Waves...", prog_num=12):  # 0m:5.899s
            ...
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=13) as make_dir_001_13:  # 0m:0.003s
                make_dir_001_13()
            with Chown(path=r"/Applications/Waves", user_id=501, group_id=20, prog_num=14, recursive=True) as chown_002_14:  # 0m:5.148s
                chown_002_14()
            with Chmod(path=r"/Applications/Waves", mode="a+rwX", prog_num=15, recursive=True) as chmod_003_15:  # 0m:0.747s
                chmod_003_15()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central...", prog_num=16):  # 0m:0.010s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central", chowner=True, prog_num=17) as make_dir_004_17:  # 0m:0.003s
                make_dir_004_17()
            with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central", mode="a+rwX", prog_num=18, recursive=True) as chmod_005_18:  # 0m:0.007s
                chmod_005_18()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs...", prog_num=19):  # 0m:0.006s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs", chowner=True, prog_num=20) as make_dir_006_20:  # 0m:0.003s
                make_dir_006_20()
            with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs", mode="a+rwX", prog_num=21, recursive=True) as chmod_007_21:  # 0m:0.003s
                chmod_007_21()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Caches/Waves Audio...", prog_num=25):  # 0m:1.117s
            ...
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio", chowner=True, prog_num=26) as make_dir_010_26:  # 0m:0.002s
                make_dir_010_26()
            with Chown(path=r"/Users/rsp_ms/Library/Caches/Waves Audio", user_id=501, group_id=20, prog_num=27, recursive=True) as chown_011_27:  # 0m:0.895s
                chown_011_27()
            with Chmod(path=r"/Users/rsp_ms/Library/Caches/Waves Audio", mode="a+rwX", prog_num=28, recursive=True) as chmod_012_28:  # 0m:0.219s
                chmod_012_28()
            # --- End PREFIX_CACHE_DIR Prefix /Users/rsp_ms/Library/Caches/Waves Audio
        with Stage(r"Prefix /Library/Audio/Plug-Ins/VST...", prog_num=29):  # 0m:0.024s
            ...
            with Chmod(path=r"/Library/Audio/Plug-Ins/VST", mode="a+rwX", ignore_if_not_exist=True, prog_num=31) as chmod_014_31:  # 0m:0.000s
                chmod_014_31()
            with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*.vst", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=32) as glober_015_32:  # 0m:0.013s
                glober_015_32()
        ...
        with Stage(r"Prefix /Library/Audio/Plug-Ins/VST3...", prog_num=34):  # 0m:0.056s
            ...
            with Chmod(path=r"/Library/Audio/Plug-Ins/VST3", mode="a+rwX", ignore_if_not_exist=True, prog_num=36) as chmod_018_36:  # 0m:0.000s
                chmod_018_36()
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=37) as glober_019_37:  # 0m:0.032s
                glober_019_37()
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Chmod, None, r"a+rwX", recursive=True, prog_num=38) as glober_020_38:  # 0m:0.020s
                glober_020_38()
            # --- End PREFIX_WAVESHELL_VST3_DIR Prefix /Library/Audio/Plug-Ins/VST3
        with Stage(r"Prefix /Library/Application Support/Avid/Audio/Plug-Ins...", prog_num=39):  # 0m:0.071s
            ...
            with Chmod(path=r"/Library/Application Support/Avid/Audio/Plug-Ins", mode="a+rwX", ignore_if_not_exist=True, prog_num=41) as chmod_022_41:  # 0m:0.000s
                chmod_022_41()
            with Glober(r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell*.aaxplugin", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=42) as glober_023_42:  # 0m:0.047s
                glober_023_42()
        ...
        with Stage(r"Prefix /Library/Audio/Plug-Ins/WPAPI...", prog_num=44):  # 0m:0.036s
        ...
        with Stage(r"Prefix /Library/Application Support/Waves...", prog_num=49):  # 0m:0.378s
            ...
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=50) as make_dir_029_50:  # 0m:0.003s
                make_dir_029_50()
            with Chown(path=r"/Library/Application Support/Waves", user_id=501, group_id=20, ignore_all_errors=True, prog_num=51, recursive=True) as chown_030_51:  # 0m:0.317s
                chown_030_51()
            with Chmod(path=r"/Library/Application Support/Waves", mode="a+rwX", prog_num=52, recursive=True) as chmod_031_52:  # 0m:0.058s
                chmod_031_52()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Preferences/Waves Preferences...", prog_num=56):  # 0m:0.003s
            ...
            with Chmod(path=r"/Users/rsp_ms/Library/Preferences/Waves Preferences", mode="a+rwX", ignore_if_not_exist=True, prog_num=57, recursive=True) as chmod_034_57:  # 0m:0.002s
                chmod_034_57()
            # --- End PREFIX_WAVES_PREFERENCES_DIR Prefix /Users/rsp_ms/Library/Preferences/Waves Preferences
        with Stage(r"Prefix /Users/Shared/Waves...", prog_num=58):  # 0m:0.006s
        ...
        with Stage(r"Prefix /Library/Audio/Plug-Ins/Components...", prog_num=61):  # 0m:0.088s
            ...
            with Chmod(path=r"/Library/Audio/Plug-Ins/Components", mode="a+rwX", ignore_if_not_exist=True, prog_num=63) as chmod_038_63:  # 0m:0.000s
                chmod_038_63()
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*.component", Chown, r"path", user_id=501, group_id=20, recursive=True, prog_num=64) as glober_039_64:  # 0m:0.054s
                glober_039_64()
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*.component", Chmod, None, r"a+rwX", recursive=True, prog_num=65) as glober_040_65:  # 0m:0.030s
                glober_040_65()
        ...
        with Stage(r"Prefix /Library/Application Support/Propellerhead Software/ReWire...", prog_num=77):  # 0m:0.017s
            ...
            with Chmod(path=r"/Library/Application Support/Propellerhead Software/ReWire", mode="a+rwX", ignore_if_not_exist=True, prog_num=79) as chmod_051_79:  # 0m:0.000s
                chmod_051_79()
            with Chown(path=r"/Library/Application Support/Propellerhead Software/ReWire/ReWire.bundle", user_id=501, group_id=20, ignore_all_errors=True, prog_num=80, recursive=True) as chown_052_80:  # 0m:0.004s
                chown_052_80()
        ...
        with Stage(r"Prefix Native Instruments .plist files on Mac...", prog_num=84):  # 0m:0.023s
            ...
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*.plist", Chown, r"path", user_id=501, group_id=20, prog_num=85) as glober_056_85:  # 0m:0.016s
                glober_056_85()
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*.plist", Chmod, None, r"a+rwX", prog_num=86) as glober_057_86:  # 0m:0.007s
                glober_057_86()
        ...
        with Stage(r"Prefix /Users/rsp_ms/Library/Caches/numba to read write all...", prog_num=98):  # 0m:0.007s
