...
# Save report
with open('/Volumes/4TBSG/2025_NOIZYFISH/Python_Codes/fabfilter_integrity_report_all_volumes.txt', 'w') as f:
    for path, status in report:
        f.write(f'{path}: {status}\n')

print('FabFilter integrity scan across all volumes complete. See fabfilter_integrity_report_all_volumes.txt for details.')
