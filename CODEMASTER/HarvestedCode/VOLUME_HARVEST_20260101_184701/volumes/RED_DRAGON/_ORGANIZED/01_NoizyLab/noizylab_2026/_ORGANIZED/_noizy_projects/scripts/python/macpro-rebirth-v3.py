...
def notify():
    try:
        run("osascript -e 'display notification \"MacPro rebirth complete!\" with title \"NOIZYGRID\"'", require_sudo=False)
        run("afplay /System/Library/Sounds/Glass.aiff", require_sudo=False)
    except Exception as e:
