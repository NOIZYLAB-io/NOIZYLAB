...
# Save as: ~/Desktop/NoizyFish/scripts/shell/run_webador_extract.sh

#!/bin/zsh
export WEBADOR_EMAIL="your-email@example.com"
export WEBADOR_PASS="your-password"
export OUTPUT_DIR=~/Desktop/NoisyFish/utilities/webador_migrate/output

mkdir -p "$OUTPUT_DIR"
source ~/Desktop/NoizyFish/utilities/webador_migrate/.venv/bin/activate
python ~/Desktop/NoizyFish/utilities/webador_migrate/webador_extract.py
