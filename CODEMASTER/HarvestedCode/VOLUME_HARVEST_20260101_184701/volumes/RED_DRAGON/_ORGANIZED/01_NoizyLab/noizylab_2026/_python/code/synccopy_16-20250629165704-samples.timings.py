...
with Stage(r"assign", prog_num=508):  # 0m:0.000s
...
with PythonBatchRuntime(r"synccopy", prog_num=509):  # 0m:0.405s
    with Stage(r"begin", prog_num=510):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=511):  # 0m:0.007s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250629165704-samples_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=512) as copy_file_to_file_001_512:  # 0m:0.004s
            copy_file_to_file_001_512()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250629165704-samples_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=513) as copy_file_to_file_002_513:  # 0m:0.003s
            copy_file_to_file_002_513()
    with Stage(r"sync", prog_num=514):  # 0m:0.008s
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=515):  # 0m:0.008s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=516) as make_dir_003_516:  # 0m:0.003s
                make_dir_003_516()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=517) as cd_004_517:  # 0m:0.005s
                cd_004_517()
                Progress(r"150 files already in cache", own_progress_count=150, prog_num=667)()  # 0m:0.000s
                with Stage(r"post_sync", prog_num=668):  # 0m:0.005s
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=669) as copy_file_to_file_005_669:  # 0m:0.005s
                        copy_file_to_file_005_669()
            Progress(r"Done sync", prog_num=670)()  # 0m:0.000s
    with Stage(r"copy", prog_num=671):  # 0m:0.335s
        with RunInThread(Ls(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", out_file=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/before-copy-sync-folder-manifest.txt"), thread_name=r"list_sync_folder", daemon=True, ignore_all_errors=True, prog_num=672) as run_in_thread_006_672:  # 0m:0.000s
            run_in_thread_006_672()
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=673)()  # 0m:0.000s
        with Stage(r"create folders", prog_num=674):  # 0m:0.015s
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=675) as make_dir_007_675:  # 0m:0.004s
                make_dir_007_675()
            with MakeDir(r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries", chowner=True, prog_num=676) as make_dir_008_676:  # 0m:0.003s
                make_dir_008_676()
            with MakeDir(r"/Users/Shared/Waves/Sample Libraries Locations", chowner=True, prog_num=677) as make_dir_009_677:  # 0m:0.007s
                make_dir_009_677()
        with CdStage(r"create_copy_instructions_for_no_copy_folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries", prog_num=678) as cd_stage_010_678:  # 0m:0.218s
            cd_stage_010_678()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Fingers SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Fingers SD", no_artifacts=True, prog_num=679) as un_zip_011_679:  # 0m:0.076s
                un_zip_011_679()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Bass Fingers Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Fingers SD", prog_num=680) as create_symlink_012_680:  # 0m:0.001s
                create_symlink_012_680()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Slapper SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Slapper SD", no_artifacts=True, prog_num=681) as un_zip_013_681:  # 0m:0.027s
                un_zip_013_681()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Bass Slapper Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Bass Slapper SD", prog_num=682) as create_symlink_014_682:  # 0m:0.003s
                create_symlink_014_682()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Clavinet SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Clavinet SD", no_artifacts=True, prog_num=683) as un_zip_015_683:  # 0m:0.004s
                un_zip_015_683()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Clavinet Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Clavinet SD", prog_num=684) as create_symlink_016_684:  # 0m:0.003s
                create_symlink_016_684()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric200 SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric200 SD", no_artifacts=True, prog_num=685) as un_zip_017_685:  # 0m:0.009s
                un_zip_017_685()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Electric200 Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric200 SD", prog_num=686) as create_symlink_018_686:  # 0m:0.001s
                create_symlink_018_686()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric88 SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric88 SD", no_artifacts=True, prog_num=687) as un_zip_019_687:  # 0m:0.007s
                un_zip_019_687()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Electric88 Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Electric88 SD", prog_num=688) as create_symlink_020_688:  # 0m:0.003s
                create_symlink_020_688()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/ElectricG80 SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/ElectricG80 SD", no_artifacts=True, prog_num=689) as un_zip_021_689:  # 0m:0.007s
                un_zip_021_689()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/ElectricGrand80 Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/ElectricG80 SD", prog_num=690) as create_symlink_022_690:  # 0m:0.001s
                create_symlink_022_690()
            with RmSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/ElectricG80 Samples Folder", prog_num=691) as rm_symlink_023_691:  # 0m:0.000s
                rm_symlink_023_691()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Grand Rhapsody SD", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Grand Rhapsody SD", no_artifacts=True, prog_num=692) as un_zip_024_692:  # 0m:0.061s
                un_zip_024_692()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/GrandRhapsody Samples Folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Grand Rhapsody SD", prog_num=693) as create_symlink_025_693:  # 0m:0.003s
                create_symlink_025_693()
            with RmSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Grand Rhapsody Samples Folder", prog_num=694) as rm_symlink_026_694:  # 0m:0.000s
                rm_symlink_026_694()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", no_artifacts=True, prog_num=695) as un_zip_027_695:  # 0m:0.010s
                un_zip_027_695()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Waves Audio Factory Pack", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", prog_num=696) as create_symlink_028_696:  # 0m:0.001s
                create_symlink_028_696()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=697) as shell_command_029_697:  # 0m:0.092s
            shell_command_029_697()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=698) as script_command_030_698:  # 0m:0.009s
            script_command_030_698()
    with Stage(r"post-copy", prog_num=699):  # 0m:0.027s
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=700) as make_dir_031_700:  # 0m:0.004s
            make_dir_031_700()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=701) as copy_file_to_file_032_701:  # 0m:0.008s
            copy_file_to_file_032_701()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=702) as chmod_033_702:  # 0m:0.002s
            chmod_033_702()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=703) as chmod_034_703:  # 0m:0.000s
            chmod_034_703()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=704) as copy_file_to_file_035_704:  # 0m:0.004s
            copy_file_to_file_035_704()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=705) as chmod_036_705:  # 0m:0.000s
            chmod_036_705()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=706) as copy_file_to_file_037_706:  # 0m:0.006s
            copy_file_to_file_037_706()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=707) as chmod_038_707:  # 0m:0.000s
            chmod_038_707()
        Progress(r"Done copy", prog_num=708)()  # 0m:0.000s
        Progress(r"Done synccopy", prog_num=709)()  # 0m:0.000s
    with Stage(r"post", prog_num=710):  # 0m:0.028s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=711) as make_dir_039_711:  # 0m:0.005s
            make_dir_039_711()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=712) as copy_file_to_file_040_712:  # 0m:0.004s
            copy_file_to_file_040_712()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=713) as make_dir_041_713:  # 0m:0.006s
            make_dir_041_713()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/6/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=714) as copy_file_to_file_042_714:  # 0m:0.005s
            copy_file_to_file_042_714()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=715) as make_dir_043_715:  # 0m:0.003s
            make_dir_043_715()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/6/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=716) as copy_file_to_file_044_716:  # 0m:0.005s
