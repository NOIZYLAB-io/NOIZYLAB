...
from pybatch import *
PythonBatchCommandBase.total_progress = 3505
PythonBatchCommandBase.running_progress = 529
if __name__ == '__main__':
    from utils import log_utils
    log_utils.config_logger()

with Stage(r"assign", prog_num=530):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"16-20250906114524-samples"
    config_vars['ALL_SYNC_DIRS'] = (r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries")
    ...
    config_vars['MAIN_INSTALL_TARGETS'] = (r"aeafdce2-ab51-4a48-8878-0f72e2e97e6f", r"e9325d8c-9b84-4ecd-b435-07252b4b1c85")
    config_vars['MAX_BAD_FILES_TO_REDOWNLOAD'] = 32
    config_vars['MAX_REPO_REV'] = 32
    ...
    config_vars['TOTAL_ITEMS_FOR_PROGRESS_REPORT'] = 2971
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"synccopy", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy-output-20250906114524.log", r"--run")
    ...
    config_vars['__FULL_LIST_OF_DIRECT_SYNC_TARGETS__'] = (r"InTrigger_Factory_Pack_IID", r"Waves_Audio_Factory_Pack_IID")
    config_vars['__FULL_LIST_OF_INSTALL_TARGETS__'] = (r"InTrigger_Factory_Pack_IID", r"Instrument_Data_Folder_IID", r"Sample_Libraries_Locations_Folder_IID", r"Waves_Audio_Factory_Pack_IID", r"Waves_Data_folder_IID")
    ...
    config_vars['__INVOCATION_RANDOM_ID__'] = r"xrunavoinetsjtey"
    ...
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.yaml"
    config_vars['__MAIN_INSTALL_IIDS__'] = (r"InTrigger_Factory_Pack_IID", r"Waves_Audio_Factory_Pack_IID")
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.py"
    config_vars['__MAIN_UPDATE_IIDS__'] = ""
    config_vars['__NOW__'] = r"2025-09-06 11:50:50.861539"
    config_vars['__NUM_BYTES_TO_DOWNLOAD__'] = 247502569
    config_vars['__NUM_FILES_TO_DOWNLOAD__'] = 1415
...
with PythonBatchRuntime(r"synccopy", prog_num=531):  # 0m:17.914s
    with Stage(r"begin", prog_num=532):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=533):  # 0m:0.008s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=534) as copy_file_to_file_001_534:  # 0m:0.004s
            copy_file_to_file_001_534()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=535) as copy_file_to_file_002_535:  # 0m:0.004s
            copy_file_to_file_002_535()
    with Stage(r"sync", prog_num=536):  # 0m:17.690s
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=537):  # 0m:17.690s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=538) as make_dir_003_538:  # 0m:0.003s
                make_dir_003_538()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=539) as cd_004_539:  # 0m:17.686s
                cd_004_539()
                Progress(r"40 files already in cache", own_progress_count=40, prog_num=579)()  # 0m:0.000s
                with CreateSyncFolders(own_progress_count=54, prog_num=633) as create_sync_folders_005_633:  # 0m:0.018s
                    create_sync_folders_005_633()
                Progress(r"Downloading with 4 processes in parallel", prog_num=634)()  # 0m:0.000s
                Progress(r"Downloading with curl parallel", prog_num=635)()  # 0m:0.000s
                with CurlWithInternalParallel(curl_path=r"curl", config_file_path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.py_curl/dl-00", total_files_to_download=1415, previously_downloaded_files=0, total_bytes_to_download=247502569, own_progress_count=1414, prog_num=2049, report_own_progress=False) as curl_with_internal_parallel_006_2049:  # 0m:16.934s
                    curl_with_internal_parallel_006_2049()
                with CurlWithInternalParallel(curl_path=r"curl", config_file_path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.py_curl/dl-01", total_files_to_download=1415, previously_downloaded_files=1414, total_bytes_to_download=247502569, prog_num=2050, report_own_progress=False) as curl_with_internal_parallel_007_2050:  # 0m:0.108s
                    curl_with_internal_parallel_007_2050()
                Progress(r"Downloading 1415 files done", prog_num=2051)()  # 0m:0.000s
                with RunInThread(Ls(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", out_file=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/after-sync-sync-folder-manifest.txt"), thread_name=r"list_sync_folder", daemon=True, ignore_all_errors=True, prog_num=2052) as run_in_thread_008_2052:  # 0m:0.001s
                    run_in_thread_008_2052()
                Progress(r"Check checksum ...", prog_num=2053)()  # 0m:0.001s
                with CheckDownloadFolderChecksum(print_report=True, raise_on_bad_checksum=True, max_bad_files_to_redownload=32, own_progress_count=1415, prog_num=3468) as check_download_folder_checksum_009_3468:  # 0m:0.558s
                    check_download_folder_checksum_009_3468()
                with Stage(r"post_sync", prog_num=3469):  # 0m:0.065s
                    Progress(r"Adjust ownership and permissions /Applications/Waves/Data/Instrument Data/Waves Sample Libraries/InTrigger Factory Pack...", prog_num=3470)()  # 0m:0.000s
                    with ChmodAndChown(path=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/InTrigger Factory Pack", mode="a+rwX", user_id=-1, group_id=-1, ignore_all_errors=True, prog_num=3471, recursive=True) as chmod_and_chown_010_3471:  # 0m:0.056s
                        chmod_and_chown_010_3471()
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=3472) as copy_file_to_file_011_3472:  # 0m:0.008s
                        copy_file_to_file_011_3472()
            Progress(r"Done sync", prog_num=3473)()  # 0m:0.000s
    with Stage(r"copy", prog_num=3474):  # 0m:0.160s
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=3475)()  # 0m:0.000s
        with Stage(r"create folders", prog_num=3476):  # 0m:0.013s
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=3477) as make_dir_012_3477:  # 0m:0.005s
                make_dir_012_3477()
            with MakeDir(r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries", chowner=True, prog_num=3478) as make_dir_013_3478:  # 0m:0.004s
                make_dir_013_3478()
            with MakeDir(r"/Users/Shared/Waves/Sample Libraries Locations", chowner=True, prog_num=3479) as make_dir_014_3479:  # 0m:0.004s
                make_dir_014_3479()
        with CdStage(r"create_copy_instructions_for_no_copy_folder", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries", prog_num=3480) as cd_stage_015_3480:  # 0m:0.015s
            cd_stage_015_3480()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/InTrigger Factory Pack", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/InTrigger Factory Pack", prog_num=3481) as create_symlink_016_3481:  # 0m:0.001s
                create_symlink_016_3481()
            with UnZip(source_zip=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", target_folder=r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", no_artifacts=True, prog_num=3482) as un_zip_017_3482:  # 0m:0.011s
                un_zip_017_3482()
            with CreateSymlink(r"/Users/Shared/Waves/Sample Libraries Locations/Waves Audio Factory Pack", r"/Applications/Waves/Data/Instrument Data/Waves Sample Libraries/Waves Audio Factory Pack", prog_num=3483) as create_symlink_018_3483:  # 0m:0.001s
                create_symlink_018_3483()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=3484) as shell_command_019_3484:  # 0m:0.122s
            shell_command_019_3484()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=3485) as script_command_020_3485:  # 0m:0.008s
            script_command_020_3485()
    with Stage(r"post-copy", prog_num=3486):  # 0m:0.028s
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=3487) as make_dir_021_3487:  # 0m:0.004s
            make_dir_021_3487()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=3488) as copy_file_to_file_022_3488:  # 0m:0.007s
            copy_file_to_file_022_3488()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=3489) as chmod_023_3489:  # 0m:0.000s
            chmod_023_3489()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=3490) as chmod_024_3490:  # 0m:0.000s
            chmod_024_3490()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=3491) as copy_file_to_file_025_3491:  # 0m:0.008s
            copy_file_to_file_025_3491()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=3492) as chmod_026_3492:  # 0m:0.000s
            chmod_026_3492()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=3493) as copy_file_to_file_027_3493:  # 0m:0.005s
            copy_file_to_file_027_3493()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=3494) as chmod_028_3494:  # 0m:0.002s
            chmod_028_3494()
        Progress(r"Done copy", prog_num=3495)()  # 0m:0.000s
        Progress(r"Done synccopy", prog_num=3496)()  # 0m:0.000s
    with Stage(r"post", prog_num=3497):  # 0m:0.027s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=3498) as make_dir_029_3498:  # 0m:0.004s
            make_dir_029_3498()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=3499) as copy_file_to_file_030_3499:  # 0m:0.005s
            copy_file_to_file_030_3499()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=3500) as make_dir_031_3500:  # 0m:0.004s
            make_dir_031_3500()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/19/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=3501) as copy_file_to_file_032_3501:  # 0m:0.005s
            copy_file_to_file_032_3501()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=3502) as make_dir_033_3502:  # 0m:0.004s
            make_dir_033_3502()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/19/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=3503) as copy_file_to_file_034_3503:  # 0m:0.005s
            copy_file_to_file_034_3503()

with Stage(r"epilog", prog_num=3504):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250906114524-samples.py", prog_num=3505) as patch_py_batch_with_timings_035_3505:  # ?
        patch_py_batch_with_timings_035_3505()

log.info("Shakespeare says: All's Well That Ends Well")
# eof


# downloaded 247502569 bytes in 0m:17.690s, 13991203 bytes per second
# copy time 0m:0.160s
