...
with Stage(r"assign", prog_num=7):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"14-20240411182434"
    config_vars['BASE_REPO_REV'] = 1
    config_vars['BATCH_EXT'] = r"py"
    config_vars['CENTRAL_VERSION'] = r"14.6.2"
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"doit", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/cleanup_14-20240411182434.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/cleanup_14-20240411182434.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/doit-output-14-20240411182434.log", r"--run")
    ...
    config_vars['__COMPILATION_TIME__'] = r"2024-02-01 09:40:10.179943"
    config_vars['__CURRENT_OS_DESCRIPTION__'] = r"macOS 14.4.1"
    ...
    config_vars['__INSTL_VERSION_STR_LONG__'] = r"instl version 2.4.1.0 2024-02-01 09:40:10.179943 bm-mac9"
    config_vars['__INSTL_VERSION_STR_SHORT__'] = r"2.4.1.0"
    config_vars['__INSTL_VERSION__'] = (2, 4, 1, 0)
    config_vars['__INVOCATION_RANDOM_ID__'] = r"qaqerqppdtksjszr"
    config_vars['__JUST_WITH_NUMBER__'] = 0
    config_vars['__MAIN_COMMAND__'] = r"doit"
    config_vars['__MAIN_DB_FILE__'] = r":memory:"
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/cleanup_14-20240411182434.yaml"
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/cleanup_14-20240411182434.py"
    config_vars['__NOW__'] = r"2024-04-11 18:24:35.377030"
    config_vars['__PLATFORM_NODE__'] = r"bm-mac9"
    ...
    config_vars['__SOCKET_HOSTNAME__'] = r"bm-mac9"
...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:10.643s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:10.643s
        with Stage(r"Shutting down servers...", prog_num=12):  # 0m:6.069s
            # --- Begin STOP_SERVERS Shutting down servers
            with ShellCommand(r'launchctl unload "/Users/rsp_ms/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=13) as shell_command_001_13:  # 0m:0.004s
                shell_command_001_13()
            with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=14) as shell_command_002_14:  # 0m:0.008s
                shell_command_002_14()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=15) as shell_command_003_15:  # 0m:0.002s
                shell_command_003_15()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=16) as shell_command_004_16:  # 0m:0.002s
                shell_command_004_16()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=17) as shell_command_005_17:  # 0m:0.835s
                shell_command_005_17()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.1", ignore_all_errors=True, prog_num=18) as shell_command_006_18:  # 0m:0.004s
                shell_command_006_18()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.1", ignore_all_errors=True, prog_num=19) as shell_command_007_19:  # 0m:0.003s
                shell_command_007_19()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=20) as shell_command_008_20:  # 0m:0.003s
                shell_command_008_20()
            with If(IsFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient"), if_true=ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop Waves Local Server", suspend=5), ignore_all_errors=True, prog_num=21) as if_009_21:  # 0m:5.208s
                if_009_21()
            # --- End STOP_SERVERS Shutting down servers
        with Stage(r"Clean main waves dir...", prog_num=22):  # 0m:0.270s
            # --- Begin CLEAN_WAVES_PROGRAMDATA_DIR Clean main waves dir
            with Glober(r"/Library/Application Support/Waves/*", RmFileOrDir, r"path", excludes=[r"Redis*"], prog_num=23) as glober_010_23:  # 0m:0.269s
                glober_010_23()
            # --- End CLEAN_WAVES_PROGRAMDATA_DIR Clean main waves dir
        with Stage(r"Clean /Users/rsp_ms/Library/Caches/Waves Audio...", prog_num=24):  # 0m:1.019s
            # --- Begin CLEAN_USER_CACHE_DIR Clean /Users/rsp_ms/Library/Caches/Waves Audio
            with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves Audio", prog_num=25) as rm_file_or_dir_011_25:  # 0m:1.019s
                rm_file_or_dir_011_25()
            # --- End CLEAN_USER_CACHE_DIR Clean /Users/rsp_ms/Library/Caches/Waves Audio
        with Stage(r"Clean waves cache dir...", prog_num=26):  # 0m:0.005s
            # --- Begin CLEAN_WAVES_CACHE_DIR Clean waves cache dir
            with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=27) as rm_file_or_dir_012_27:  # 0m:0.005s
                rm_file_or_dir_012_27()
            # --- End CLEAN_WAVES_CACHE_DIR Clean waves cache dir
        with Stage(r"Clean /Applications/Waves/ReWire...", prog_num=28):  # 0m:0.003s
            # --- Begin CLEAN_REWIRE_DIR Clean /Applications/Waves/ReWire
            with RmFileOrDir(r"/Applications/Waves/ReWire", prog_num=29) as rm_file_or_dir_013_29:  # 0m:0.003s
                rm_file_or_dir_013_29()
            # --- End CLEAN_REWIRE_DIR Clean /Applications/Waves/ReWire
        with Stage(r"Clean /Applications/Waves/SoundGrid for Venue...", prog_num=30):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_SOUNDGRID_FOR_VENUE_DIR Clean /Applications/Waves/SoundGrid for Venue
            with RmFileOrDir(r"/Applications/Waves/SoundGrid for Venue", prog_num=31) as rm_file_or_dir_014_31:  # 0m:0.000s
                rm_file_or_dir_014_31()
            # --- End CLEAN_WAVES_SOUNDGRID_FOR_VENUE_DIR Clean /Applications/Waves/SoundGrid for Venue
        with Stage(r"Clean /Applications/Waves/WaveShells...", prog_num=32):  # 0m:0.074s
            # --- Begin CLEAN_SHELLS_DIR Clean /Applications/Waves/WaveShells
            with Glober(r"/Applications/Waves/WaveShells V*", RmFileOrDir, r"path", prog_num=33) as glober_015_33:  # 0m:0.074s
                glober_015_33()
            # --- End CLEAN_SHELLS_DIR Clean /Applications/Waves/WaveShells
        with Stage(r"Clean /Applications/Waves/Plug-Ins...", prog_num=34):  # 0m:1.976s
            # --- Begin CLEAN_PLUGINS_DIR Clean /Applications/Waves/Plug-Ins
            with Glober(r"/Applications/Waves/Plug-Ins V*", RmFileOrDir, r"path", prog_num=35) as glober_016_35:  # 0m:1.976s
                glober_016_35()
            with Glober(r"/Applications/Waves/Unused Plug-Ins V*", RmFileOrDir, r"path", prog_num=36) as glober_017_36:  # 0m:0.000s
                glober_017_36()
            # --- End CLEAN_PLUGINS_DIR Clean /Applications/Waves/Plug-Ins
        with Stage(r"Clean session files originated from /Users/Shared/Waves...", prog_num=37):  # 0m:0.002s
            # --- Begin CLEAN_WAVES_SESSION_FILES Clean session files originated from /Users/Shared/Waves
            with Glober(r"/Users/Shared/Waves/eMotion/Sessions/CurrentLV1.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=38) as glober_018_38:  # 0m:0.000s
                glober_018_38()
            with Glober(r"/Users/Shared/Waves/eMotion LV1 Native/Sessions/CurrentLV1Native.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=39) as glober_019_39:  # 0m:0.000s
                glober_019_39()
            with Glober(r"/Users/Shared/Waves/SuperRack SoundGrid/Sessions/CurrentSPRK.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=40) as glober_020_40:  # 0m:0.000s
                glober_020_40()
            with Glober(r"/Users/Shared/Waves/SuperRack/Sessions/CurrentSPRKN.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=41) as glober_021_41:  # 0m:0.000s
                glober_021_41()
            with Glober(r"/Users/Shared/Waves/SoundGrid Studio/Sessions/CurrentSGStudio.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=42) as glober_022_42:  # 0m:0.001s
                glober_022_42()
            with Glober(r"/Users/Shared/Waves/SoundGrid Inventory/Sessions/CurrentSoundGridForVenue.dat*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=43) as glober_023_43:  # 0m:0.000s
                glober_023_43()
            with Glober(r"/Users/Shared/Waves/*", RmSymlink, r"path", ignore_all_errors=True, prog_num=44) as glober_024_44:  # 0m:0.001s
                glober_024_44()
            # --- End CLEAN_WAVES_SESSION_FILES Clean session files originated from /Users/Shared/Waves
        with Stage(r"Clean /Applications/Waves/Applications...", prog_num=45):  # 0m:0.009s
            # --- Begin CLEAN_WAVES_APPLICATIONS_DIR Clean /Applications/Waves/Applications
            with Glober(r"/Applications/Waves/Applications V*", RmFileOrDir, r"path", prog_num=46) as glober_025_46:  # 0m:0.009s
                glober_025_46()
            with RmFileOrDir(r"/Applications/Waves/Applications", ignore_all_errors=True, prog_num=47) as rm_file_or_dir_026_47:  # 0m:0.000s
                rm_file_or_dir_026_47()
            # --- End CLEAN_WAVES_APPLICATIONS_DIR Clean /Applications/Waves/Applications
        with Stage(r"Clean /Applications/Waves/SoundGrid Studio...", prog_num=48):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_SOUNDGRID_STUDIO_DIR Clean /Applications/Waves/SoundGrid Studio
            with RmFileOrDir(r"/Applications/Waves/SoundGrid Studio", prog_num=49) as rm_file_or_dir_027_49:  # 0m:0.000s
                rm_file_or_dir_027_49()
            # --- End CLEAN_WAVES_SOUNDGRID_STUDIO_DIR Clean /Applications/Waves/SoundGrid Studio
        with Stage(r"Clean /Applications/Waves/eMotion LV1...", prog_num=50):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_EMOTION_LV1_DIR Clean /Applications/Waves/eMotion LV1
            with Glober(r"/Applications/Waves/eMotion LV1*", RmFileOrDir, r"path", prog_num=51) as glober_028_51:  # 0m:0.000s
                glober_028_51()
            # --- End CLEAN_WAVES_EMOTION_LV1_DIR Clean /Applications/Waves/eMotion LV1
        with Stage(r"Clean ${WAVES_NDI_DIR}...", prog_num=52):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_NDI_DIR Clean ${WAVES_NDI_DIR}
            with RmFileOrDir(r"/${WAVES_NDI_DIR}", prog_num=53) as rm_file_or_dir_029_53:  # 0m:0.000s
                rm_file_or_dir_029_53()
            # --- End CLEAN_WAVES_NDI_DIR Clean ${WAVES_NDI_DIR}
        with Stage(r"Clean /Applications/Waves/SuperRack...", prog_num=54):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_SUPERRACK_DIR Clean /Applications/Waves/SuperRack
            with Glober(r"/Applications/Waves/SuperRack*", RmFileOrDir, r"path", prog_num=55) as glober_030_55:  # 0m:0.000s
                glober_030_55()
            # --- End CLEAN_WAVES_SUPERRACK_DIR Clean /Applications/Waves/SuperRack
        with Stage(r"Clean /Applications/Waves/MultiRack...", prog_num=56):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_MULTIRACK_DIR Clean /Applications/Waves/MultiRack
            with RmFileOrDir(r"/Applications/Waves/MultiRack", prog_num=57) as rm_file_or_dir_031_57:  # 0m:0.000s
                rm_file_or_dir_031_57()
            # --- End CLEAN_WAVES_MULTIRACK_DIR Clean /Applications/Waves/MultiRack
        with Stage(r"Clean /Applications/Waves/SoundGrid QRec...", prog_num=58):  # 0m:0.000s
            # --- Begin CLEAN_WAVES_SOUNDGRID_QREC_DIR Clean /Applications/Waves/SoundGrid QRec
            with RmFileOrDir(r"/Applications/Waves/SoundGrid QRec", prog_num=59) as rm_file_or_dir_032_59:  # 0m:0.000s
                rm_file_or_dir_032_59()
            # --- End CLEAN_WAVES_SOUNDGRID_QREC_DIR Clean /Applications/Waves/SoundGrid QRec
        with Stage(r"Clean /Applications/Waves/COSMOS...", prog_num=60):  # 0m:0.030s
            # --- Begin CLEAN_WAVES_COSMOS_DIR Clean /Applications/Waves/COSMOS
            with RmFileOrDir(r"/Applications/Waves/COSMOS", prog_num=61) as rm_file_or_dir_033_61:  # 0m:0.030s
                rm_file_or_dir_033_61()
            # --- End CLEAN_WAVES_COSMOS_DIR Clean /Applications/Waves/COSMOS
        with Stage(r"Clean /Applications/Waves/Data with a few exceptions...", prog_num=62):  # 0m:0.651s
            # --- Begin CLEAN_WAVES_DATA_DIR Clean /Applications/Waves/Data with a few exceptions
            with Glober(r"/Applications/Waves/Data/*", RmFileOrDir, r"path", excludes=[r"Instrument Data*",r"IR1Impulses*",r"Presets*",r"Setup Libraries*",r"Waves Gems*"], prog_num=63) as glober_034_63:  # 0m:0.651s
                glober_034_63()
            # --- End CLEAN_WAVES_DATA_DIR Clean /Applications/Waves/Data with a few exceptions
        with Stage(r"Clean /Users/rsp_ms/Library/Preferences/Waves Preferences...", prog_num=64):  # 0m:0.005s
            # --- Begin CLEAN_WAVES_PREFERENCES_DIR Clean /Users/rsp_ms/Library/Preferences/Waves Preferences
            with Glober(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins*", RmSymlink, r"path", prog_num=65) as glober_035_65:  # 0m:0.000s
                glober_035_65()
            with Glober(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/*Studio Modules*", RmSymlink, r"path", prog_num=66) as glober_036_66:  # 0m:0.000s
                glober_036_66()
            with RmSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves EMotion LV1 Modules", prog_num=67) as rm_symlink_037_67:  # 0m:0.000s
                rm_symlink_037_67()
            with Glober(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/*", RmFileOrDir, r"path", excludes=[r"wls.config*",r"FeatureFlags.yaml*",r"ForceUseGUIScanner*",r"Waves Central.json*"], prog_num=68) as glober_038_68:  # 0m:0.004s
                glober_038_68()
            # --- End CLEAN_WAVES_PREFERENCES_DIR Clean /Users/rsp_ms/Library/Preferences/Waves Preferences
        with Stage(r"Clean /Users/rsp_ms/Library/Application Support/Waves Audio\Waves Local Server and database...", prog_num=69):  # 0m:0.003s
            ...
            with RmFileOrDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Local Server", prog_num=70) as rm_file_or_dir_039_70:  # 0m:0.003s
        ...
        with Stage(r"Clean user Waves Audio directory...", prog_num=71):  # 0m:0.001s
            # --- Begin CLEAN_USER_WAVES_DIR Clean user Waves Audio directory
            with Glober(r"/Users/rsp_ms/Library/Application Support/Waves Audio/*", RmFileOrDir, r"path", excludes=[r"Waves Central*",r"Waves Plugin Server*"], prog_num=72) as glober_040_72:  # 0m:0.000s
                glober_040_72()
            with Glober(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/*", RmFileOrDir, r"path", excludes=[r"Logs*"], prog_num=73) as glober_041_73:  # 0m:0.000s
                glober_041_73()
            with Glober(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/*", RmFileOrDir, r"path", excludes=[r"cosmos.sqlit*"], prog_num=74) as glober_042_74:  # 0m:0.001s
                glober_042_74()
            # --- End CLEAN_USER_WAVES_DIR Clean user Waves Audio directory
        with Stage(r"Clean /Library/Audio/Plug-Ins/WPAPI...", prog_num=75):  # 0m:0.011s
            # --- Begin CLEAN_WAVES_WPAPI_DIR Clean /Library/Audio/Plug-Ins/WPAPI
            with Glober(r"/Library/Audio/Plug-Ins/WPAPI/WaveShell*", RmFileOrDir, r"path", prog_num=76) as glober_043_76:  # 0m:0.011s
                glober_043_76()
            # --- End CLEAN_WAVES_WPAPI_DIR Clean /Library/Audio/Plug-Ins/WPAPI
        with Stage(r"Clean /Library/Application Support/Avid/Audio/Plug-Ins...", prog_num=77):  # 0m:0.021s
            # --- Begin CLEAN_WAVESHELL_AAX_DIR Clean /Library/Application Support/Avid/Audio/Plug-Ins
            with Glober(r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell*", RmFileOrDir, r"path", prog_num=78) as glober_044_78:  # 0m:0.021s
                glober_044_78()
            # --- End CLEAN_WAVESHELL_AAX_DIR Clean /Library/Application Support/Avid/Audio/Plug-Ins
        with Stage(r"Clean /Library/Audio/Plug-Ins/Components...", prog_num=79):  # 0m:0.048s
            # --- Begin CLEAN_MACOS_WAVESHELL_AU_DIR Clean /Library/Audio/Plug-Ins/Components
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*", RmFileOrDir, r"path", prog_num=80) as glober_045_80:  # 0m:0.048s
                glober_045_80()
            # --- End CLEAN_MACOS_WAVESHELL_AU_DIR Clean /Library/Audio/Plug-Ins/Components
        with Stage(r"Clean vst dir...", prog_num=81):  # 0m:0.014s
            # --- Begin CLEAN_WAVESHELL_VST_DIR Clean vst dir
            with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*", RmFileOrDir, r"path", prog_num=82) as glober_046_82:  # 0m:0.011s
                glober_046_82()
            with RmFileOrDir(r"/Library/Audio/Plug-Ins/VST/Waves StudioRack for OBS.vst", prog_num=83) as rm_file_or_dir_047_83:  # 0m:0.002s
                rm_file_or_dir_047_83()
            # --- End CLEAN_WAVESHELL_VST_DIR Clean vst dir
        with Stage(r"Clean vst3 dir...", prog_num=84):  # 0m:0.011s
            # --- Begin CLEAN_WAVESHELL_VST3_DIR Clean vst3 dir
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*", RmFileOrDir, r"path", prog_num=85) as glober_048_85:  # 0m:0.011s
                glober_048_85()
            # --- End CLEAN_WAVESHELL_VST3_DIR Clean vst3 dir
        with Stage(r"Clean /Library/Application Support/Native Instruments/Service Center...", prog_num=86):  # 0m:0.015s
            # --- Begin CLEAN_NATIVE_INSTRUMENTS_DIR Clean /Library/Application Support/Native Instruments/Service Center
            with Glober(r"/Library/Application Support/Native Instruments/Service Center/Waves-*.xml", RmFileOrDir, r"path", prog_num=87) as glober_049_87:  # 0m:0.015s
                glober_049_87()
            # --- End CLEAN_NATIVE_INSTRUMENTS_DIR Clean /Library/Application Support/Native Instruments/Service Center
        with Stage(r"Clean /Applications/Waves/SoundGrid...", prog_num=88):  # 0m:0.364s
            ...
            with If(IsFile(r"/Applications/Waves/SoundGrid/Utilities/SoundGrid Driver Uninstaller.app/Contents/MacOS//SoundGridDriverUninstaller.py"), if_true=ShellCommand(r'"/Applications/Waves/SoundGrid/Utilities/SoundGrid Driver Uninstaller.app/Contents/MacOS//SoundGridDriverUninstaller.py"', message=r"Uninstalling SoundGrid Driver", ignore_all_errors=True), prog_num=89) as if_050_89:  # 0m:0.000s
                if_050_89()
            with RmFileOrDir(r"/Applications/Waves/SoundGrid", prog_num=90) as rm_file_or_dir_051_90:  # 0m:0.363s
                rm_file_or_dir_051_90()
            # --- End CLEAN_WAVES_SOUNDGRID_DIR Clean /Applications/Waves/SoundGrid
        with Stage(r"Clean /Library/Preferences/com.native-instruments.Waves...", prog_num=91):  # 0m:0.037s
            # --- Begin CLEAN_NI_PLIST_FILES Clean /Library/Preferences/com.native-instruments.Waves
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=92) as glober_052_92:  # 0m:0.036s
                glober_052_92()
            with Glober(r"/tmp/com.native-instruments.Waves-*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=93) as glober_053_93:  # 0m:0.000s
                glober_053_93()
            # --- End CLEAN_NI_PLIST_FILES Clean /Library/Preferences/com.native-instruments.Waves
        with Stage(r"clean waves plist files in /Library/LaunchAgents directory...", prog_num=94):  # 0m:0.000s
            # --- Begin CLEAN_LAUNCH_AGENTS_DIR clean waves plist files in /Library/LaunchAgents directory
            with RmFile(r"/Library/LaunchAgents/com.waves.wls.agent.plist", prog_num=95) as rm_file_054_95:  # 0m:0.000s
                rm_file_054_95()
            # --- End CLEAN_LAUNCH_AGENTS_DIR clean waves plist files in /Library/LaunchAgents directory
        with Stage(r"clean COSMOS related files...", prog_num=96):  # 0m:0.000s
            # --- Begin CLEAN_COSMOS_FILES clean COSMOS related files
            with RmFile(r"/Users/rsp_ms/Library/Application Support/COSMOS", prog_num=97) as rm_file_055_97:  # 0m:0.000s
                rm_file_055_97()
            with RmFile(r"/Users/rsp_ms/Library/Preferences/com.waves.COSMOS.plist", prog_num=98) as rm_file_056_98:  # 0m:0.000s
                rm_file_056_98()
            # --- End CLEAN_COSMOS_FILES clean COSMOS related files
        with Stage(r"Clean SoundGrid-related .plist files...", prog_num=99):  # 0m:0.002s
            # --- Begin CLEAN_SOUNDGRID_RELATED_FILES Clean SoundGrid-related .plist files
            with Glober(r"/Library/LaunchDaemons/com.waves.daemon.SoundGrid*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=100) as glober_057_100:  # 0m:0.001s
                glober_057_100()
            with Glober(r"/Library/LaunchAgents/com.waves.daemon.SoundGrid*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=101) as glober_058_101:  # 0m:0.000s
                glober_058_101()
            with RmFileOrDir(r"/Users/rsp_ms/Library/LaunchAgents/com.WavesAudio.SoundGridStudioSilent.plist", prog_num=102) as rm_file_or_dir_059_102:  # 0m:0.000s
                rm_file_or_dir_059_102()
            # --- End CLEAN_SOUNDGRID_RELATED_FILES Clean SoundGrid-related .plist files
    with Stage(r"post_doit", prog_num=103):  # 0m:0.000s
        print("Done Doing it")

with Stage(r"epilog", prog_num=104):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/cleanup/cleanup_14-20240411182434.py", prog_num=105) as patch_py_batch_with_timings_060_105:  # ?
