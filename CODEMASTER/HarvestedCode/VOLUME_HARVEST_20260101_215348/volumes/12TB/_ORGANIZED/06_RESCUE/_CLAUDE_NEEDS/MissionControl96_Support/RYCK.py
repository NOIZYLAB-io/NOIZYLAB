...
# To run this script, set your GoDaddy API credentials as environment variables in your shell before running:
# For bash/zsh, run these in your terminal (not in Python):
