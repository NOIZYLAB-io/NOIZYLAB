...
mkdir -p ~/Desktop/NoizyFish/scripts/shell
mkdir -p ~/Desktop/NoizyFish/scripts/python
mkdir -p ~/Desktop/NoizyFish/scripts/powershell
mkdir -p ~/Desktop/NoizyFish/scripts/js
cd ~/Desktop/NoizyFish/scripts/powershell
