...
# Example usage:
# speak_with_sarah("Your summary here.", api_key="your-elevenlabs-api-key")
...
if __name__ == "__main__":
    # Run the volume alias creation and summary
    # (Assumes VOLUMES, SUBFOLDER, SKIP_VOLUMES are defined above)
    summary = []
    ...
    for line in summary[-2:]:
        print(line)
    # Auto-run Sarah to speak the summary
    if summary:
