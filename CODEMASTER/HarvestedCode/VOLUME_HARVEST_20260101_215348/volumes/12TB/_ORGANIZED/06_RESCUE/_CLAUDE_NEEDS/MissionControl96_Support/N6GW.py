...
os.system('python3 /Users/rsp_ms/Desktop/KONTAKT_LAB/PROJECT_ORGANIZER/check_and_move_ni_libraries.py')
os.system('cd ~/Desktop/The_Perfectionist/ui && pyinstaller --onefile --windowed --icon perfectionist.icns --name "The Perfectionist" perfectionist_gui.py')