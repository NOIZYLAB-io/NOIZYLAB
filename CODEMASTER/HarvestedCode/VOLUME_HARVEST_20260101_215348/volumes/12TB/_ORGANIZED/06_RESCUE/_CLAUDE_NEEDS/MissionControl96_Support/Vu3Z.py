...
DEEP_PROJECT_STRUCTURE = {
    "01_ORCHESTRAL_PREMIUM": {
        ...
        "subfolders": ["strings", "brass", "woodwinds", "full_orchestra", "solo_instruments", "project_sam", "cinesamples", "szidzlichek", "eastwest"]
    },
    "02_ETHNIC_WORLD": {
            ...
            for pattern in patterns:
                if (pattern in item_name or 
                    ...
                    if category == "01_ORCHESTRAL_PREMIUM":
                        if any(x in item_name.upper() for x in ["PIETER SZIDZLICHEK", "SZIDZLICHEK"]):
