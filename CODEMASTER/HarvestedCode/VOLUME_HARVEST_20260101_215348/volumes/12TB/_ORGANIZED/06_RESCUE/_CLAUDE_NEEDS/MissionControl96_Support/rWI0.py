...
chmod +x ~/NoizyFish_Aquarium/Master_AutoRun.sh
python3 ~/NoizyFish_Aquarium/NoizyFish_Aquarium_Complete.py
chmod +x ~/NoizyFish_Aquarium/move_scripts.sh
~/NoizyFish_Aquarium/move_scripts.sh
