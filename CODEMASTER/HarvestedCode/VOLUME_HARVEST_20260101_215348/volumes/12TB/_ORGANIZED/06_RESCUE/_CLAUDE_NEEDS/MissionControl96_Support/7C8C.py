...
root = tk.Tk()
root.title("iCon Widget (in the Aquarium)")
root.geometry("400x200")
label = tk.Label(root, text="Drag & Drop Files or Folders Here\n(in the Aquarium)", font=("Arial", 16))
...
# Move this script to the new location
shutil.move(os.path.expanduser("~/Documents/five_sorry_five_associates_2026/*"), os.path.expanduser("~/Documents/the_aquarium/"))