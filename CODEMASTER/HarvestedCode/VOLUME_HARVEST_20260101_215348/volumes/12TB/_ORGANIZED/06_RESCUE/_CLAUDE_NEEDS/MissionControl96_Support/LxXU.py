...
python3 ~/Desktop/NoizyFish/scripts/copilot_to_sarah_voice.py

ln -s ~/Desktop/NoizyFish/scripts ~/Desktop/NoizyScripts

~/Desktop/NoizyFish/utilities/webador_migrate
