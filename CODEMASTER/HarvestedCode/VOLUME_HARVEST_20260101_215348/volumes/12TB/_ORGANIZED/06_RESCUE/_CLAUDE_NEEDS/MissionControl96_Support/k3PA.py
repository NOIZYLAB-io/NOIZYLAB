...
- python forward1_all_in_one.py open microsoft
- python forward1_all_in_one.py open social
- python forward1_all_in_one.py flow register-noizy-ai
- python forward1_all_in_one.py flow transfer-noizyfish
- python forward1_all_in_one.py flow activate-m365
- python forward1_all_in_one.py flow enable-2fa
- python forward1_all_in_one.py vault add "Facebook backup codes: XXXXX"
- python forward1_all_in_one.py vault read
- python forward1_all_in_one.py cfg set-domain-status noizy.ai registered
- python forward1_all_in_one.py cfg set-mailbox-status rp@fishmusicinc.com active
- python forward1_all_in_one.py cfg set-2fa GoDaddy enabled
    """)
