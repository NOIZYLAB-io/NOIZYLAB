...
# Upload platform_trace.csv to GCS
...
if __name__ == "__main__":
    # Run sync status and deep email summary
    print("\n--- Deep Email Sync ---\n")
    deep_email_summary()
    # Try to upload platform_trace.csv if it exists
    import os
    ...
    if os.path.exists(local_csv):
        ...
        print(f"⚠️ {local_csv} not found. Skipping upload.")
# Key search email
...
def save_sync_log(results, filepath="/Users/rsp_ms/Downloads/sync_log.csv"):
    if results:
...
with open('data/platform_trace.csv', newline='') as csvfile:
...
mv /Users/rsp_ms/Downloads/credentials.json /Users/rsp_ms/NoizyFish_Aquarium/🐍 Python_Projects/NoizyCockPit/

gsutil mb gs://fishmusic-cockpit-sink

python3 inbox_scan.py
