...
import os, platform, json, subprocess, time
from pathlib import Path
from datetime import datetime

# ---- Configuration ----
FLEET = {
    "MacStudio":     {"ip": "10.0.0.25", "role": "Commander"},  # Current machine
    "MacPro":        {"ip": "10.0.0.130", "role": "AudioCore"},
    "HP_OMEN":       {"ip": "10.0.0.140", "role": "Compute"},
    "Dell_7779":     {"ip": "10.0.0.151", "role": "Diagnostics"}
}
...
if __name__ == "__main__":
    ...
    data = handshake()
    summary_table(data)
    print("\n✨  Handshake Complete.  Ready for Fleet Restart.")