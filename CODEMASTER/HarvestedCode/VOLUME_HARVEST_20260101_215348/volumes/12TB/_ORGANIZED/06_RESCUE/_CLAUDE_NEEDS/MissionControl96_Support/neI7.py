#!/usr/bin/env python3
import wave, audioop, json, sys, math, pathlib, subprocess
...
def main():
    ...
    subprocess.run(["launchctl", "load", "~/Library/LaunchAgents/com.noizyfish.catalog.plist"])
    subprocess.run(["launchctl", "list", "|", "grep", "noizyfish"])

if __name__ == "__main__":
    main()
/usr/bin/python3 /Users/rsp_ms/Desktop/NoizyFish/quantum_orchestrator.py ignition