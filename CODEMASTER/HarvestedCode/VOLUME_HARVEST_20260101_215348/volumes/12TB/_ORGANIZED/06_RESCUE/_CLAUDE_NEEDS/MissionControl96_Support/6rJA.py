...
FILES = {
		...
		PROJECT_ROOT / "dlink_dashboard" / "app.py": textwrap.dedent(r"""
				import sys, os
				sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))  # import DLink_Control
		...
		PROJECT_ROOT / "dlink_dashboard" / "config.py": textwrap.dedent(r"""
				...
				class Config:
						SECRET_KEY = os.environ.get("DASHBOARD_SECRET", "dev-secret")
						DEVICE_CACHE_TTL = int(os.environ.get("DEVICE_CACHE_TTL", "10"))
						STATUS_CACHE_TTL = int(os.environ.get("STATUS_CACHE_TTL", "5"))
		"""),

		PROJECT_ROOT / "dlink_dashboard" / "routes" / "__init__.py": "",
