...
def save_html_masterlist(libraries, broken_birds, classifications, complete, partial, fragment, unknown):
    ...
    html.append(".stats { text-align:center; font-size:16px; margin:20px 0; padding:15px; background:#fff; border-radius:8px; }")
    html.append("table { border-collapse: collapse; width: 100%; margin-top:20px; background:#fff; }")
    html.append("th, td { border:1px solid #ccc; padding:8px 12px; text-align:left; }")
    html.append("th { background:#34495e; color:#fff; font-weight:bold; }")
    ...
    html.append(".timestamp { text-align:center; color:#7f8c8d; font-size:12px; margin-top:20px; }")
...
def run_complete_scan():
    ...
    save_html_masterlist(libraries, broken_birds, classifications, complete, partial, fragment, unknown)
