...
if __name__ == "__main__":
    ...
    # os.system("./emergency_wake.sh")
    # os.system("ps aux | grep 'noizylab_autokeep_daemon.py' | grep -v grep | awk '{print $2}' | xargs -r kill -9")
    # os.system("killall -9 afplay")
    # os.system("ps aux | grep 'advanced_spam_blocker.py' | grep -v grep | awk '{print $2}' | xargs -r kill -9")