...
SOURCE_DIR = "/Users/m2ultra/Documents/PROJECTS"
OUTPUT_FILE = os.path.join(SOURCE_DIR, "PROJECTS_OMNIBUS.md")

SKIP_EXTENSIONS = {'.png', '.jpg', '.jpeg', '.gif', '.zip', '.tar', '.gz', '.pyc', '.DS_Store', '.gitkeep'}
SKIP_DIRS = {'.git', '.claude-worktrees', '__pycache__', 'node_modules', 'dist', 'build'}
...
def generate_omnibus():
    ...
    with open(OUTPUT_FILE, 'w', encoding='utf-8') as outfile:
        # Header
        outfile.write(f"# PROJECTS OMNIBUS - COMPLETE INGESTION\n")
        ...
        for relpath, filepath in files_to_ingest:
            ...
            if lang in ['js', 'jsx', 'ts', 'tsx']: lang = 'javascript'
...
Š*cascade08"(4bfcf0e9987d3368ff091fa570500f0f11b0dea22;file:///Users/m2ultra/Documents/PROJECTS/ingest_projects.py:file:///Users/m2ultra