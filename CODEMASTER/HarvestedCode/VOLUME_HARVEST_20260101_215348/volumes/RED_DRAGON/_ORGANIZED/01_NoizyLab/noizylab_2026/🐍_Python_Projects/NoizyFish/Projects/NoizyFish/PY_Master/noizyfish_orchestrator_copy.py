def write_vscode_files():
    ...
    ua_tasks = {
        ...
        "tasks": [
            ...
            {
                "label": "Logic Pro X: Apply Tracking Vocal",
                "type": "shell",
                "command": "python3",
                "args": [f"{ROOT}/logic_pro_x_commands.json", "apply", "tracking_vocal"],
                "isBackground": False,
                "problemMatcher": []
            },
            {
                "label": "Logic Pro X: Apply Guitar Unison",
                "type": "shell",
                "command": "python3",
                "args": [f"{ROOT}/logic_pro_x_commands.json", "apply", "guitar_unison"],
                "isBackground": False,
                "problemMatcher": []
            },
            {
                "label": "Logic Pro X: Apply Mixdown Lowlat",
                "type": "shell",
                "command": "python3",
                "args": [f"{ROOT}/logic_pro_x_commands.json", "apply", "mixdown_lowlat"],
                "isBackground": False,
                "problemMatcher": []
            }
        ]
