...
with Stage(r"assign", prog_num=479):
...
with PythonBatchRuntime(r"synccopy", prog_num=480):
    with Stage(r"begin", prog_num=481):
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=482):
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V15/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_15-20250629165446_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=483) as copy_file_to_file_001_483:
            copy_file_to_file_001_483()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V15/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_15-20250629165446_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=484) as copy_file_to_file_002_484:
            copy_file_to_file_002_484()
    with Stage(r"sync", prog_num=485):
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=486) as shell_command_003_486:
            shell_command_003_486()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=487) as shell_command_004_487:
            shell_command_004_487()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=488) as shell_command_005_488:
            shell_command_005_488()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=489) as shell_command_006_489:
            shell_command_006_489()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=490) as shell_command_007_490:
            shell_command_007_490()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=491) as shell_command_008_491:
            shell_command_008_491()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=492) as shell_command_009_492:
            shell_command_009_492()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=493) as shell_command_010_493:
            shell_command_010_493()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V15", prog_num=494):
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15", chowner=True, prog_num=495) as make_dir_011_495:
                make_dir_011_495()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15", prog_num=496) as cd_012_496:
                cd_012_496()
                Progress(r"244 files already in cache", own_progress_count=244, prog_num=740)()
                with Stage(r"post_sync", prog_num=741):
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=742) as copy_file_to_file_013_742:
                        copy_file_to_file_013_742()
            Progress(r"Done sync", prog_num=743)()
    with Stage(r"copy", prog_num=744):
        with RunInThread(Ls(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15", out_file=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/before-copy-sync-folder-manifest.txt"), thread_name=r"list_sync_folder", daemon=True, ignore_all_errors=True, prog_num=745) as run_in_thread_014_745:
            run_in_thread_014_745()
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15", prog_num=746)()
        with Stage(r"create folders", prog_num=747):
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=748) as make_dir_015_748:
                make_dir_015_748()
            with MakeDir(r"/Applications/Waves/Plug-Ins V15", chowner=True, prog_num=749) as make_dir_016_749:
                make_dir_016_749()
            with MakeDir(r"/Applications/Waves/Plug-Ins V15/Documents", chowner=True, prog_num=750) as make_dir_017_750:
                make_dir_017_750()
            with MakeDir(r"/Applications/Waves/WaveShells V15", chowner=True, prog_num=751) as make_dir_018_751:
                make_dir_018_751()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=752) as make_dir_019_752:
                make_dir_019_752()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=753) as make_dir_020_753:
                make_dir_020_753()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=754) as make_dir_021_754:
                make_dir_021_754()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V15", chowner=True, prog_num=755) as make_dir_022_755:
                make_dir_022_755()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=756) as make_dir_023_756:
                make_dir_023_756()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=757) as make_dir_024_757:
                make_dir_024_757()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=758) as make_dir_025_758:
                make_dir_025_758()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=759) as make_dir_026_759:
                make_dir_026_759()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=760) as make_dir_027_760:
                make_dir_027_760()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=761) as make_dir_028_761:
                make_dir_028_761()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=762) as make_dir_029_762:
                make_dir_029_762()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=763) as make_dir_030_763:
                make_dir_030_763()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=764) as make_dir_031_764:
                make_dir_031_764()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=765) as rm_file_or_dir_032_765:
            rm_file_or_dir_032_765()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=766) as shell_command_033_766:
            shell_command_033_766()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=767) as shell_command_034_767:
            shell_command_034_767()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=768) as shell_command_035_768:
            shell_command_035_768()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=769) as shell_command_036_769:
            shell_command_036_769()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=770) as shell_command_037_770:
            shell_command_037_770()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=771) as shell_command_038_771:
            shell_command_038_771()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=772) as shell_command_039_772:
            shell_command_039_772()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=773) as shell_command_040_773:
            shell_command_040_773()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15", prog_num=774) as cd_stage_041_774:
            cd_stage_041_774()
            with SetExecPermissionsInSyncFolder(prog_num=775) as set_exec_permissions_in_sync_folder_042_775:
                set_exec_permissions_in_sync_folder_042_775()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V15", prog_num=776) as cd_stage_043_776:
            cd_stage_043_776()
            with Stage(r"copy", r"CLA Bass v15.5.79.262", prog_num=777):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/CLA Bass.bundle", r"/Applications/Waves/Plug-Ins V15", skip_progress_count=4, prog_num=778) as should_copy_source_044_778:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Bass.bundle", prog_num=779):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/CLA Bass.bundle", where_to_unwtar=r".", prog_num=781) as unwtar_046_781:
                            unwtar_046_781()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V15/CLA Bass.bundle", user_id=-1, group_id=-1, prog_num=782, recursive=True) as chown_047_782:
                            chown_047_782()
            with Stage(r"copy", r"CLA Vocals v15.5.79.262", prog_num=783):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/CLA Vocals.bundle", r"/Applications/Waves/Plug-Ins V15", skip_progress_count=4, prog_num=784) as should_copy_source_048_784:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Vocals.bundle", prog_num=785):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/CLA Vocals.bundle", where_to_unwtar=r".", prog_num=787) as unwtar_050_787:
                            unwtar_050_787()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V15/CLA Vocals.bundle", user_id=-1, group_id=-1, prog_num=788, recursive=True) as chown_051_788:
                            chown_051_788()
            with Stage(r"copy", r"WavesLib1_15_5_79_262 v15.5.79.262", prog_num=789):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/WavesLib1_15.5.79.framework", r"/Applications/Waves/Plug-Ins V15", skip_progress_count=4, prog_num=790) as should_copy_source_052_790:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_15.5.79.framework", prog_num=791):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Plugins/WavesLib1_15.5.79.framework", where_to_unwtar=r".", prog_num=793) as unwtar_054_793:
                            unwtar_054_793()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V15/WavesLib1_15.5.79.framework", user_id=-1, group_id=-1, prog_num=794, recursive=True) as chown_055_794:
                            chown_055_794()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V15", own_progress_count=2, prog_num=796) as resolve_symlink_files_in_folder_056_796:
                resolve_symlink_files_in_folder_056_796()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V15" -c', ignore_all_errors=True, prog_num=797) as shell_command_057_797:
                shell_command_057_797()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V15"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V15"/Icon?; fi', prog_num=798) as script_command_058_798:
                script_command_058_798()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=799) as shell_command_059_799:
                shell_command_059_799()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V15", r"/Applications/Waves/Plug-Ins V15", prog_num=800) as create_symlink_060_800:
                create_symlink_060_800()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V15", r"/Applications/Waves/Plug-Ins V15", prog_num=801) as create_symlink_061_801:
                create_symlink_061_801()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=802) as copy_glob_to_dir_062_802:
                copy_glob_to_dir_062_802()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V15/Documents", prog_num=803) as cd_stage_063_803:
            cd_stage_063_803()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=804):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V15/Documents", skip_progress_count=3, prog_num=805) as should_copy_source_064_805:
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=806):
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=808) as chmod_and_chown_066_808:
                            chmod_and_chown_066_808()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V15", prog_num=809) as cd_stage_067_809:
            cd_stage_067_809()
            with Stage(r"copy", r"WaveShell1-AAX 15.5 v15.5.139.322", prog_num=810):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AAX 15.5.aaxplugin", r"/Applications/Waves/WaveShells V15", skip_progress_count=5, prog_num=811) as should_copy_source_068_811:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 15.5.aaxplugin", prog_num=812):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V15/WaveShell1-AAX 15.5.aaxplugin", user_id=-1, group_id=-1, prog_num=815, recursive=True) as chown_071_815:
                            chown_071_815()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 15.5.aaxplugin"', ignore_all_errors=True, prog_num=816) as shell_command_072_816:
                            shell_command_072_816()
            with Stage(r"copy", r"WaveShell1-AU 15.5 v15.5.79.262", prog_num=817):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AU 15.5.component", r"/Applications/Waves/WaveShells V15", skip_progress_count=8, prog_num=818) as should_copy_source_073_818:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 15.5.component", prog_num=819):
                        ...
                        with Chown(path=r"WaveShell1-AU 15.5.component", user_id=-1, group_id=-1, prog_num=825, recursive=True) as chown_079_825:
                            chown_079_825()
                        with Chmod(path=r"WaveShell1-AU 15.5.component", mode="a+rwX", prog_num=826, recursive=True) as chmod_080_826:
                            chmod_080_826()
            with Stage(r"copy", r"WaveShell1-VST3 15.5 v15.5.79.262", prog_num=827):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-VST3 15.5.vst3", r"/Applications/Waves/WaveShells V15", skip_progress_count=5, prog_num=828) as should_copy_source_081_828:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 15.5.vst3", prog_num=829):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V15/WaveShell1-VST3 15.5.vst3", user_id=-1, group_id=-1, prog_num=832, recursive=True) as chown_084_832:
                            chown_084_832()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 15.5.vst3"', ignore_all_errors=True, prog_num=833) as shell_command_085_833:
                            shell_command_085_833()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 15.5 v15.5.79.262", prog_num=834):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/WPAPI/WaveShell1-WPAPI_2 15.5.bundle", r"/Applications/Waves/WaveShells V15", skip_progress_count=7, prog_num=835) as should_copy_source_086_835:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 15.5.bundle", prog_num=836):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=842) as shell_command_092_842:
                            shell_command_092_842()
            with Stage(r"copy", r"WaveShell-AU registration utility v15.5.79.262", prog_num=843):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/Waves AU Reg Utility 15.app", r"/Applications/Waves/WaveShells V15", skip_progress_count=4, prog_num=844) as should_copy_source_093_844:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 15.app", prog_num=845):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/Waves AU Reg Utility 15.app", where_to_unwtar=r".", prog_num=847) as unwtar_095_847:
                            unwtar_095_847()
                        with Chown(path=r"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app", user_id=-1, group_id=-1, prog_num=848, recursive=True) as chown_096_848:
                            chown_096_848()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 15.app"', ignore_all_errors=True, prog_num=849) as shell_command_097_849:
                shell_command_097_849()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=850) as cd_stage_098_850:
            cd_stage_098_850()
            with Stage(r"copy", r"WaveShell1-AAX 15.5 v15.5.139.322", prog_num=851):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AAX 15.5.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=852) as should_copy_source_099_852:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 15.5.aaxplugin", prog_num=853):
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 15.5.aaxplugin", user_id=-1, group_id=-1, prog_num=856, recursive=True) as chown_102_856:
                            chown_102_856()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 15.5.aaxplugin"', ignore_all_errors=True, prog_num=857) as shell_command_103_857:
                            shell_command_103_857()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=858) as cd_stage_104_858:
            cd_stage_104_858()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=859):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=860) as should_copy_source_105_860:
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=861):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=863, recursive=True) as chown_107_863:
                            chown_107_863()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/License Notifications/V15", prog_num=864) as cd_stage_108_864:
            cd_stage_108_864()
            with Stage(r"copy", r"License Notifications 1.1 v1.1", prog_num=865):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/License Notifications/V15/1", r"/Library/Application Support/Waves/License Notifications/V15", skip_progress_count=3, prog_num=866) as should_copy_source_109_866:
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V15/1", prog_num=867):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V15/1", user_id=-1, group_id=-1, prog_num=869, recursive=True) as chown_111_869:
                            chown_111_869()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=870) as cd_stage_112_870:
            cd_stage_112_870()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=871) as rm_file_or_dir_113_871:
                rm_file_or_dir_113_871()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=872):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=873) as should_copy_source_114_873:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=874):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=876) as unwtar_116_876:
                            unwtar_116_876()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=877, recursive=True) as chown_117_877:
                            chown_117_877()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=878):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=879) as should_copy_source_118_879:
                    should_copy_source_118_879()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=880):
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=881) as unwtar_119_881:
                            unwtar_119_881()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=882):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=883) as should_copy_source_120_883:
                    should_copy_source_120_883()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=884):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=885) as copy_dir_to_dir_121_885:
                            copy_dir_to_dir_121_885()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=886) as unwtar_122_886:
                            unwtar_122_886()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=887, recursive=True) as chown_123_887:
                            chown_123_887()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=888):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=889) as should_copy_source_124_889:
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=890):
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=893) as chmod_127_893:
                            chmod_127_893()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=894, recursive=True) as chown_128_894:
                            chown_128_894()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=897) as resolve_symlink_files_in_folder_129_897:
                resolve_symlink_files_in_folder_129_897()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=898) as shell_command_130_898:
                shell_command_130_898()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=899) as cd_stage_131_899:
            cd_stage_131_899()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=900):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=901) as should_copy_source_132_901:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=902):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=904, recursive=True) as chown_134_904:
                            chown_134_904()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=905) as cd_stage_135_905:
            cd_stage_135_905()
            with Stage(r"copy", r"Waves Local Server v12.16.0.1", prog_num=906):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=907) as should_copy_source_136_907:
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=908):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=912, recursive=True) as chown_140_912:
                            chown_140_912()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_15-20250629165446-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=913) as if_141_913:
                            if_141_913()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=914) as cd_stage_142_914:
            cd_stage_142_914()
            with Stage(r"copy", r"WaveShell1-AU 15.5 v15.5.79.262", prog_num=915):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AU 15.5.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=916) as should_copy_source_143_916:
                    should_copy_source_143_916()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 15.5.component", prog_num=917):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AU 15.5.component", r".", delete_extraneous_files=True, prog_num=918) as copy_dir_to_dir_144_918:
                            copy_dir_to_dir_144_918()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-AU 15.5.component", where_to_unwtar=r".", prog_num=919) as unwtar_145_919:
                            unwtar_145_919()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 15.5.component", user_id=-1, group_id=-1, prog_num=920, recursive=True) as chown_146_920:
                            chown_146_920()
                        with BreakHardLink(r"WaveShell1-AU 15.5.component/Contents/Info.plist", prog_num=921) as break_hard_link_147_921:
                            break_hard_link_147_921()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 15.5.component"', ignore_all_errors=True, prog_num=922) as shell_command_148_922:
                            shell_command_148_922()
                        with Chown(path=r"WaveShell1-AU 15.5.component", user_id=-1, group_id=-1, prog_num=923, recursive=True) as chown_149_923:
                            chown_149_923()
                        with Chmod(path=r"WaveShell1-AU 15.5.component", mode="a+rwX", prog_num=924, recursive=True) as chmod_150_924:
                            chmod_150_924()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=925) as cd_stage_151_925:
            cd_stage_151_925()
            with Stage(r"copy", r"WaveShell1-VST3 15.5 v15.5.79.262", prog_num=926):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Shells/WaveShell1-VST3 15.5.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=927) as should_copy_source_152_927:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 15.5.vst3", prog_num=928):
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 15.5.vst3", user_id=-1, group_id=-1, prog_num=931, recursive=True) as chown_155_931:
                            chown_155_931()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 15.5.vst3"', ignore_all_errors=True, prog_num=932) as shell_command_156_932:
                            shell_command_156_932()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=933) as cd_stage_157_933:
            cd_stage_157_933()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 15.5 v15.5.79.262", prog_num=934):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/WPAPI/WaveShell1-WPAPI_2 15.5.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=935) as should_copy_source_158_935:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 15.5.bundle", prog_num=936):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=942) as shell_command_164_942:
                            shell_command_164_942()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=943) as create_symlink_165_943:
                create_symlink_165_943()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=944) as create_symlink_166_944:
                create_symlink_166_944()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=945) as rm_file_or_dir_167_945:
            rm_file_or_dir_167_945()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=946) as shell_command_168_946:
            shell_command_168_946()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=947) as script_command_169_947:
            script_command_169_947()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=948) as rm_file_or_dir_170_948:
            rm_file_or_dir_170_948()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=949) as glober_171_949:
            glober_171_949()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=950) as glober_172_950:
            glober_172_950()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=951) as glober_173_951:
            glober_173_951()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=952) as shell_command_174_952:
            shell_command_174_952()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V15" -c', ignore_all_errors=True, prog_num=953) as shell_command_175_953:
            shell_command_175_953()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V15"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V15"/Icon?; fi', prog_num=954) as script_command_176_954:
            script_command_176_954()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=955) as if_177_955:
            if_177_955()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=956) as if_178_956:
            if_178_956()
    with Stage(r"post-copy", prog_num=957):
        with MakeDir(r"/Library/Application Support/Waves/Central/V15", chowner=True, prog_num=958) as make_dir_179_958:
            make_dir_179_958()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V15/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=959) as copy_file_to_file_180_959:
            copy_file_to_file_180_959()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V15/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=960) as chmod_181_960:
            chmod_181_960()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V15/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=961) as chmod_182_961:
            chmod_182_961()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V15/require.yaml", r"/Library/Application Support/Waves/Central/V15/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=962) as copy_file_to_file_183_962:
            copy_file_to_file_183_962()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V15/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=963) as chmod_184_963:
            chmod_184_963()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V15/new_require.yaml", r"/Library/Application Support/Waves/Central/V15/require.yaml", hard_links=False, copy_owner=True, prog_num=964) as copy_file_to_file_185_964:
            copy_file_to_file_185_964()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V15/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=965) as chmod_186_965:
            chmod_186_965()
        Progress(r"Done copy", prog_num=966)()
        Progress(r"Done synccopy", prog_num=967)()
    with Stage(r"post", prog_num=968):
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping", chowner=True, prog_num=969) as make_dir_187_969:
            make_dir_187_969()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V15_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/V15_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=970) as copy_file_to_file_188_970:
            copy_file_to_file_188_970()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping", chowner=True, prog_num=971) as make_dir_189_971:
            make_dir_189_971()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/59/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=972) as copy_file_to_file_190_972:
            copy_file_to_file_190_972()
        with MakeDir(r"/Library/Application Support/Waves/Central/V15", chowner=True, prog_num=973) as make_dir_191_973:
            make_dir_191_973()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V15/bookkeeping/59/index.yaml", r"/Library/Application Support/Waves/Central/V15/index.yaml", hard_links=False, copy_owner=True, prog_num=974) as copy_file_to_file_192_974:
