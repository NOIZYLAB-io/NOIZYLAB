...
with Stage(r"assign", prog_num=558):  # 0m:0.000s
...
with PythonBatchRuntime(r"synccopy", prog_num=559):  # 0m:17.430s
    with Stage(r"begin", prog_num=560):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=561):  # 0m:0.007s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163752_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=562) as copy_file_to_file_001_562:  # 0m:0.004s
            copy_file_to_file_001_562()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163752_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=563) as copy_file_to_file_002_563:  # 0m:0.003s
            copy_file_to_file_002_563()
    with Stage(r"sync", prog_num=564):  # 0m:5.204s
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=565) as shell_command_003_565:  # 0m:0.006s
            shell_command_003_565()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=566) as shell_command_004_566:  # 0m:0.009s
            shell_command_004_566()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=567) as shell_command_005_567:  # 0m:3.084s
            shell_command_005_567()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=568) as shell_command_006_568:  # 0m:0.960s
            shell_command_006_568()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=569) as shell_command_007_569:  # 0m:0.006s
            shell_command_007_569()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=570) as shell_command_008_570:  # 0m:0.977s
            shell_command_008_570()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=571) as shell_command_009_571:  # 0m:0.006s
            shell_command_009_571()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=572) as shell_command_010_572:  # 0m:0.004s
            shell_command_010_572()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=573) as shell_command_011_573:  # 0m:0.140s
            shell_command_011_573()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=574):  # 0m:0.011s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=575) as make_dir_012_575:  # 0m:0.005s
                make_dir_012_575()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=576) as cd_013_576:  # 0m:0.005s
                cd_013_576()
                Progress(r"507 files already in cache", own_progress_count=507, prog_num=1083)()  # 0m:0.000s
                with Stage(r"post_sync", prog_num=1084):  # 0m:0.005s
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1085) as copy_file_to_file_014_1085:  # 0m:0.005s
                        copy_file_to_file_014_1085()
            Progress(r"Done sync", prog_num=1086)()  # 0m:0.000s
    with Stage(r"copy", prog_num=1087):  # 0m:12.168s
        ...
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1089)()  # 0m:0.000s
        with Stage(r"create folders", prog_num=1090):  # 0m:0.077s
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=1091) as make_dir_016_1091:  # 0m:0.003s
                make_dir_016_1091()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=1092) as make_dir_017_1092:  # 0m:0.003s
                make_dir_017_1092()
            with MakeDir(r"/Applications/Waves/Data/WavesGTR", chowner=True, prog_num=1093) as make_dir_018_1093:  # 0m:0.006s
                make_dir_018_1093()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=1094) as make_dir_019_1094:  # 0m:0.003s
                make_dir_019_1094()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=1095) as make_dir_020_1095:  # 0m:0.003s
                make_dir_020_1095()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=1096) as make_dir_021_1096:  # 0m:0.004s
                make_dir_021_1096()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1097) as make_dir_022_1097:  # 0m:0.003s
                make_dir_022_1097()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=1098) as make_dir_023_1098:  # 0m:0.004s
                make_dir_023_1098()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=1099) as make_dir_024_1099:  # 0m:0.003s
                make_dir_024_1099()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=1100) as make_dir_025_1100:  # 0m:0.003s
                make_dir_025_1100()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=1101) as make_dir_026_1101:  # 0m:0.003s
                make_dir_026_1101()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=1102) as make_dir_027_1102:  # 0m:0.005s
                make_dir_027_1102()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=1103) as make_dir_028_1103:  # 0m:0.004s
                make_dir_028_1103()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=1104) as make_dir_029_1104:  # 0m:0.003s
                make_dir_029_1104()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=1105) as make_dir_030_1105:  # 0m:0.003s
                make_dir_030_1105()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=1106) as make_dir_031_1106:  # 0m:0.004s
                make_dir_031_1106()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=1107) as make_dir_032_1107:  # 0m:0.006s
                make_dir_032_1107()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=1108) as make_dir_033_1108:  # 0m:0.004s
                make_dir_033_1108()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=1109) as make_dir_034_1109:  # 0m:0.003s
                make_dir_034_1109()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=1110) as make_dir_035_1110:  # 0m:0.004s
                make_dir_035_1110()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=1111) as make_dir_036_1111:  # 0m:0.003s
                make_dir_036_1111()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=1112) as rm_file_or_dir_037_1112:  # 0m:0.000s
            rm_file_or_dir_037_1112()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=1113) as shell_command_038_1113:  # 0m:0.006s
            shell_command_038_1113()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=1114) as shell_command_039_1114:  # 0m:0.010s
            shell_command_039_1114()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=1115) as shell_command_040_1115:  # 0m:1.037s
            shell_command_040_1115()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=1116) as shell_command_041_1116:  # 0m:1.040s
            shell_command_041_1116()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1117) as shell_command_042_1117:  # 0m:0.005s
            shell_command_042_1117()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=1118) as shell_command_043_1118:  # 0m:1.050s
            shell_command_043_1118()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=1119) as shell_command_044_1119:  # 0m:0.004s
            shell_command_044_1119()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=1120) as shell_command_045_1120:  # 0m:0.004s
            shell_command_045_1120()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=1121) as shell_command_046_1121:  # 0m:0.154s
            shell_command_046_1121()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=1122) as cd_stage_047_1122:  # 0m:0.010s
            cd_stage_047_1122()
            with SetExecPermissionsInSyncFolder(prog_num=1123) as set_exec_permissions_in_sync_folder_048_1123:  # 0m:0.009s
                set_exec_permissions_in_sync_folder_048_1123()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/WavesGTR", prog_num=1124) as cd_stage_049_1124:  # 0m:0.030s
            cd_stage_049_1124()
            with Stage(r"copy", r"GTR Amps and Cabinets v2.0.0.0", prog_num=1125):  # 0m:0.030s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/WavesGTR/Amps", r"/Applications/Waves/Data/WavesGTR", skip_progress_count=2, prog_num=1126) as should_copy_source_050_1126:  # 0m:0.006s
                    should_copy_source_050_1126()
                    with Stage(r"copy source", r"Common/Data/WavesGTR/Amps", prog_num=1127):  # 0m:0.006s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/WavesGTR/Amps.wtar.aa", where_to_unwtar=r".", prog_num=1128) as unwtar_051_1128:  # 0m:0.006s
                            unwtar_051_1128()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/WavesGTR/Cabinets", r"/Applications/Waves/Data/WavesGTR", skip_progress_count=2, prog_num=1129) as should_copy_source_052_1129:  # 0m:0.023s
                    should_copy_source_052_1129()
                    with Stage(r"copy source", r"Common/Data/WavesGTR/Cabinets", prog_num=1130):  # 0m:0.023s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/WavesGTR/Cabinets.wtar.aa", where_to_unwtar=r".", prog_num=1131) as unwtar_053_1131:  # 0m:0.023s
                            unwtar_053_1131()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=1132) as cd_stage_054_1132:  # 0m:0.730s
            cd_stage_054_1132()
            with Stage(r"copy", r"CLA Bass v16.0.23.24", prog_num=1133):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Bass.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1134) as should_copy_source_055_1134:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Bass.bundle", prog_num=1135):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Bass.bundle", where_to_unwtar=r".", prog_num=1137) as unwtar_057_1137:  # ?
                            unwtar_057_1137()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Bass.bundle", user_id=-1, group_id=-1, prog_num=1138, recursive=True) as chown_058_1138:  # 0m:0.000s
                            chown_058_1138()
            with Stage(r"copy", r"CLA Drums v16.0.23.24", prog_num=1139):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Drums.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1140) as should_copy_source_059_1140:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Drums.bundle", prog_num=1141):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Drums.bundle", where_to_unwtar=r".", prog_num=1143) as unwtar_061_1143:  # ?
                            unwtar_061_1143()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Drums.bundle", user_id=-1, group_id=-1, prog_num=1144, recursive=True) as chown_062_1144:  # 0m:0.000s
                            chown_062_1144()
            with Stage(r"copy", r"CLA Effects v16.0.23.24", prog_num=1145):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Effects.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1146) as should_copy_source_063_1146:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Effects.bundle", prog_num=1147):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Effects.bundle", where_to_unwtar=r".", prog_num=1149) as unwtar_065_1149:  # ?
                            unwtar_065_1149()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Effects.bundle", user_id=-1, group_id=-1, prog_num=1150, recursive=True) as chown_066_1150:  # 0m:0.000s
                            chown_066_1150()
            with Stage(r"copy", r"CLA Guitars v16.0.23.24", prog_num=1151):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Guitars.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1152) as should_copy_source_067_1152:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Guitars.bundle", prog_num=1153):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Guitars.bundle", where_to_unwtar=r".", prog_num=1155) as unwtar_069_1155:  # ?
                            unwtar_069_1155()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Guitars.bundle", user_id=-1, group_id=-1, prog_num=1156, recursive=True) as chown_070_1156:  # 0m:0.000s
                            chown_070_1156()
            with Stage(r"copy", r"CLA Unplugged v16.0.23.24", prog_num=1157):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Unplugged.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1158) as should_copy_source_071_1158:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Unplugged.bundle", prog_num=1159):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Unplugged.bundle", where_to_unwtar=r".", prog_num=1161) as unwtar_073_1161:  # ?
                            unwtar_073_1161()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Unplugged.bundle", user_id=-1, group_id=-1, prog_num=1162, recursive=True) as chown_074_1162:  # 0m:0.000s
                            chown_074_1162()
            with Stage(r"copy", r"CLA Vocals v16.0.23.24", prog_num=1163):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Vocals.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1164) as should_copy_source_075_1164:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/CLA Vocals.bundle", prog_num=1165):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/CLA Vocals.bundle", where_to_unwtar=r".", prog_num=1167) as unwtar_077_1167:  # ?
                            unwtar_077_1167()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/CLA Vocals.bundle", user_id=-1, group_id=-1, prog_num=1168, recursive=True) as chown_078_1168:  # 0m:0.000s
                            chown_078_1168()
            with Stage(r"copy", r"WavesLib1_16_0_23_24 v16.0.23.24", prog_num=1169):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=1170) as should_copy_source_079_1170:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.23.framework", prog_num=1171):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", where_to_unwtar=r".", prog_num=1173) as unwtar_081_1173:  # ?
                            unwtar_081_1173()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.23.framework", user_id=-1, group_id=-1, prog_num=1174, recursive=True) as chown_082_1174:  # 0m:0.000s
                            chown_082_1174()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=1176) as resolve_symlink_files_in_folder_083_1176:  # 0m:0.512s
                resolve_symlink_files_in_folder_083_1176()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=1177) as shell_command_084_1177:  # 0m:0.098s
                shell_command_084_1177()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=1178) as script_command_085_1178:  # 0m:0.006s
                script_command_085_1178()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1179) as shell_command_086_1179:  # 0m:0.016s
                shell_command_086_1179()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1180) as create_symlink_087_1180:  # 0m:0.002s
                create_symlink_087_1180()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=1181) as create_symlink_088_1181:  # 0m:0.001s
                create_symlink_088_1181()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=1182) as copy_glob_to_dir_089_1182:  # 0m:0.092s
                copy_glob_to_dir_089_1182()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=1183) as cd_stage_090_1183:  # 0m:0.003s
            cd_stage_090_1183()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=1184):  # 0m:0.003s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=1185) as should_copy_source_091_1185:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=1186):  # ?
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=1188) as chmod_and_chown_093_1188:  # 0m:0.003s
                            chmod_and_chown_093_1188()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=1189) as cd_stage_094_1189:  # 0m:0.010s
            cd_stage_094_1189()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1190):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1191) as should_copy_source_095_1191:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1192):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1195, recursive=True) as chown_098_1195:  # ?
                            chown_098_1195()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1196) as shell_command_099_1196:  # 0m:0.000s
                            shell_command_099_1196()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1197):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=1198) as should_copy_source_100_1198:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1199):  # ?
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1205, recursive=True) as chown_106_1205:  # ?
                            chown_106_1205()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1206, recursive=True) as chmod_107_1206:  # 0m:0.000s
                            chmod_107_1206()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1207):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=1208) as should_copy_source_108_1208:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1209):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1212, recursive=True) as chown_111_1212:  # ?
                            chown_111_1212()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1213) as shell_command_112_1213:  # 0m:0.000s
                            shell_command_112_1213()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1214):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Applications/Waves/WaveShells V16", skip_progress_count=7, prog_num=1215) as should_copy_source_113_1215:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1216):  # ?
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1222) as shell_command_119_1222:  # 0m:0.000s
                            shell_command_119_1222()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=1223):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=1224) as should_copy_source_120_1224:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=1225):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=1227) as unwtar_122_1227:  # ?
                            unwtar_122_1227()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=1228, recursive=True) as chown_123_1228:  # 0m:0.000s
                            chown_123_1228()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=1229) as shell_command_124_1229:  # 0m:0.008s
                shell_command_124_1229()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=1230) as cd_stage_125_1230:  # 0m:0.001s
            cd_stage_125_1230()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=1231):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=1232) as should_copy_source_126_1232:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=1233):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=1236, recursive=True) as chown_129_1236:  # ?
                            chown_129_1236()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=1237) as shell_command_130_1237:  # 0m:0.000s
                            shell_command_130_1237()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=1238) as cd_stage_131_1238:  # 0m:0.000s
            cd_stage_131_1238()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=1239):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=1240) as should_copy_source_132_1240:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=1241):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=1243, recursive=True) as chown_134_1243:  # 0m:0.000s
                            chown_134_1243()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V16", prog_num=1244) as cd_stage_135_1244:  # 0m:0.000s
            cd_stage_135_1244()
            with Stage(r"copy", r"Demo Mode V16 1.1 v1.1", prog_num=1245):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V16/1", r"/Library/Application Support/Waves/Demo Mode/V16", skip_progress_count=3, prog_num=1246) as should_copy_source_136_1246:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V16/1", prog_num=1247):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V16/1", user_id=-1, group_id=-1, prog_num=1249, recursive=True) as chown_138_1249:  # 0m:0.000s
                            chown_138_1249()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/License Notifications/V16", prog_num=1250) as cd_stage_139_1250:  # 0m:0.000s
            cd_stage_139_1250()
            with Stage(r"copy", r"License Notifications V16 1.1 v1.1", prog_num=1251):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/License Notifications/V16/1", r"/Library/Application Support/Waves/License Notifications/V16", skip_progress_count=3, prog_num=1252) as should_copy_source_140_1252:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V16/1", prog_num=1253):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V16/1", user_id=-1, group_id=-1, prog_num=1255, recursive=True) as chown_142_1255:  # 0m:0.000s
                            chown_142_1255()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=1256) as cd_stage_143_1256:  # 0m:4.146s
            cd_stage_143_1256()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=1257) as rm_file_or_dir_144_1257:  # 0m:0.000s
                rm_file_or_dir_144_1257()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=1258):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=1259) as should_copy_source_145_1259:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=1260):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=1262) as unwtar_147_1262:  # ?
                            unwtar_147_1262()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=1263, recursive=True) as chown_148_1263:  # 0m:0.000s
                            chown_148_1263()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=1264):  # 0m:0.005s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=1265) as should_copy_source_149_1265:  # 0m:0.005s
                    should_copy_source_149_1265()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=1266):  # 0m:0.005s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=1267) as unwtar_150_1267:  # 0m:0.005s
                            unwtar_150_1267()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=1268):  # 0m:4.129s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=1269) as should_copy_source_151_1269:  # 0m:4.129s
                    should_copy_source_151_1269()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=1270):  # 0m:4.128s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=1271) as copy_dir_to_dir_152_1271:  # 0m:0.011s
                            copy_dir_to_dir_152_1271()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=1272) as unwtar_153_1272:  # 0m:4.117s
                            unwtar_153_1272()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=1273, recursive=True) as chown_154_1273:  # 0m:0.000s
                            chown_154_1273()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=1274):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=1275) as should_copy_source_155_1275:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=1276):  # ?
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=1279) as chmod_158_1279:  # ?
                            chmod_158_1279()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=1280, recursive=True) as chown_159_1280:  # 0m:0.000s
                            chown_159_1280()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=1283) as resolve_symlink_files_in_folder_160_1283:  # 0m:0.002s
                resolve_symlink_files_in_folder_160_1283()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1284) as shell_command_161_1284:  # 0m:0.009s
                shell_command_161_1284()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=1285) as cd_stage_162_1285:  # 0m:0.003s
            cd_stage_162_1285()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=1286):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=1287) as should_copy_source_163_1287:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=1288):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=1290, recursive=True) as chown_165_1290:  # 0m:0.000s
                            chown_165_1290()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=1291) as cd_stage_166_1291:  # 0m:0.000s
            cd_stage_166_1291()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=1292):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=1293) as should_copy_source_167_1293:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=1294):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=1296, recursive=True) as chown_169_1296:  # 0m:0.000s
                            chown_169_1296()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=1297) as cd_stage_170_1297:  # 0m:0.000s
            cd_stage_170_1297()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=1298):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=1299) as should_copy_source_171_1299:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=1300):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=1304, recursive=True) as chown_175_1304:  # ?
                            chown_175_1304()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_15-20250712163752-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=1305) as if_176_1305:  # 0m:0.000s
                            if_176_1305()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=1306) as cd_stage_177_1306:  # 0m:0.937s
            cd_stage_177_1306()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=1307):  # 0m:0.937s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=1308) as should_copy_source_178_1308:  # 0m:0.937s
                    should_copy_source_178_1308()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=1309):  # 0m:0.936s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=1310) as copy_dir_to_dir_179_1310:  # 0m:0.036s
                            copy_dir_to_dir_179_1310()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=1311) as unwtar_180_1311:  # 0m:0.843s
                            unwtar_180_1311()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1312, recursive=True) as chown_181_1312:  # 0m:0.000s
                            chown_181_1312()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=1313) as break_hard_link_182_1313:  # 0m:0.009s
                            break_hard_link_182_1313()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=1314) as shell_command_183_1314:  # 0m:0.044s
                            shell_command_183_1314()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=1315, recursive=True) as chown_184_1315:  # 0m:0.000s
                            chown_184_1315()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1316, recursive=True) as chmod_185_1316:  # 0m:0.004s
                            chmod_185_1316()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=1317) as cd_stage_186_1317:  # 0m:0.001s
            cd_stage_186_1317()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1318):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=1319) as should_copy_source_187_1319:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1320):  # ?
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1323, recursive=True) as chown_190_1323:  # ?
                            chown_190_1323()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1324) as shell_command_191_1324:  # 0m:0.000s
                            shell_command_191_1324()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1325) as cd_stage_192_1325:  # 0m:0.001s
            cd_stage_192_1325()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1326):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=1327) as should_copy_source_193_1327:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1328):  # ?
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1334) as shell_command_199_1334:  # 0m:0.001s
                            shell_command_199_1334()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1335) as create_symlink_200_1335:  # 0m:0.000s
                create_symlink_200_1335()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1336) as create_symlink_201_1336:  # 0m:0.000s
                create_symlink_201_1336()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=1337) as rm_file_or_dir_202_1337:  # 0m:0.000s
            rm_file_or_dir_202_1337()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=1338) as shell_command_203_1338:  # 0m:0.096s
            shell_command_203_1338()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=1339) as script_command_204_1339:  # 0m:0.006s
            script_command_204_1339()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=1340) as rm_file_or_dir_205_1340:  # 0m:0.000s
            rm_file_or_dir_205_1340()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=1341) as glober_206_1341:  # 0m:0.001s
            glober_206_1341()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=1342) as glober_207_1342:  # 0m:0.001s
            glober_207_1342()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=1343) as glober_208_1343:  # 0m:0.004s
            glober_208_1343()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1344) as shell_command_209_1344:  # 0m:0.005s
            shell_command_209_1344()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1345) as shell_command_210_1345:  # 0m:2.161s
            shell_command_210_1345()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1346) as shell_command_211_1346:  # 0m:0.282s
            shell_command_211_1346()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1347) as shell_command_212_1347:  # 0m:0.140s
            shell_command_212_1347()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=1348) as shell_command_213_1348:  # 0m:0.096s
            shell_command_213_1348()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=1349) as script_command_214_1349:  # 0m:0.006s
            script_command_214_1349()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=1350) as if_215_1350:  # 0m:0.000s
            if_215_1350()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=1351) as if_216_1351:  # 0m:0.000s
            if_216_1351()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=1352) as shell_command_217_1352:  # 0m:0.096s
            shell_command_217_1352()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=1353) as script_command_218_1353:  # 0m:0.007s
            script_command_218_1353()
    with Stage(r"post-copy", prog_num=1354):  # 0m:0.023s
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1355) as make_dir_219_1355:  # 0m:0.003s
            make_dir_219_1355()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1356) as copy_file_to_file_220_1356:  # 0m:0.007s
            copy_file_to_file_220_1356()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1357) as chmod_221_1357:  # 0m:0.000s
            chmod_221_1357()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1358) as chmod_222_1358:  # 0m:0.000s
            chmod_222_1358()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=1359) as copy_file_to_file_223_1359:  # 0m:0.005s
            copy_file_to_file_223_1359()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1360) as chmod_224_1360:  # 0m:0.000s
            chmod_224_1360()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=1361) as copy_file_to_file_225_1361:  # 0m:0.006s
            copy_file_to_file_225_1361()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1362) as chmod_226_1362:  # 0m:0.001s
            chmod_226_1362()
        Progress(r"Done copy", prog_num=1363)()  # 0m:0.000s
        Progress(r"Done synccopy", prog_num=1364)()  # 0m:0.000s
    with Stage(r"post", prog_num=1365):  # 0m:0.027s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1366) as make_dir_227_1366:  # 0m:0.004s
            make_dir_227_1366()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=1367) as copy_file_to_file_228_1367:  # 0m:0.005s
            copy_file_to_file_228_1367()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1368) as make_dir_229_1368:  # 0m:0.003s
            make_dir_229_1368()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/8/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=1369) as copy_file_to_file_230_1369:  # 0m:0.005s
            copy_file_to_file_230_1369()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1370) as make_dir_231_1370:  # 0m:0.004s
            make_dir_231_1370()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/8/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=1371) as copy_file_to_file_232_1371:  # 0m:0.006s
