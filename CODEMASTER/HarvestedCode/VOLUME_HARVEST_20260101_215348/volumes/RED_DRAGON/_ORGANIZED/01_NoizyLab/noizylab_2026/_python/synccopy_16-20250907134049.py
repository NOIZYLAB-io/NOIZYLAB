...
with Stage(r"assign", prog_num=561):
...
with PythonBatchRuntime(r"synccopy", prog_num=562):
    with Stage(r"begin", prog_num=563):
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=564):
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250907134049_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=565) as copy_file_to_file_001_565:
            copy_file_to_file_001_565()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250907134049_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=566) as copy_file_to_file_002_566:
            copy_file_to_file_002_566()
    with Stage(r"sync", prog_num=567):
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=568) as shell_command_003_568:
            shell_command_003_568()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=569) as shell_command_004_569:
            shell_command_004_569()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=570) as shell_command_005_570:
            shell_command_005_570()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=571) as shell_command_006_571:
            shell_command_006_571()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=572) as shell_command_007_572:
            shell_command_007_572()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=573) as shell_command_008_573:
            shell_command_008_573()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=574) as shell_command_009_574:
            shell_command_009_574()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=575) as shell_command_010_575:
            shell_command_010_575()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=576) as shell_command_011_576:
            shell_command_011_576()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=577):
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=578) as make_dir_012_578:
                make_dir_012_578()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=579) as cd_013_579:
                cd_013_579()
                Progress(r"220 files already in cache", own_progress_count=220, prog_num=799)()
    ...
    with Stage(r"copy", prog_num=803):
        ...
        with Stage(r"create folders", prog_num=806):
            ...
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=808) as make_dir_017_808:
                make_dir_017_808()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=809) as make_dir_018_809:
                make_dir_018_809()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=810) as make_dir_019_810:
                make_dir_019_810()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=811) as make_dir_020_811:
                make_dir_020_811()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=812) as make_dir_021_812:
                make_dir_021_812()
            with MakeDir(r"/Library/Application Support/Native Instruments/Service Center", prog_num=813) as make_dir_022_813:
                make_dir_022_813()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=814) as make_dir_023_814:
                make_dir_023_814()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=815) as make_dir_024_815:
                make_dir_024_815()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=816) as make_dir_025_816:
                make_dir_025_816()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=817) as make_dir_026_817:
                make_dir_026_817()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=818) as make_dir_027_818:
                make_dir_027_818()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=819) as make_dir_028_819:
                make_dir_028_819()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=820) as make_dir_029_820:
                make_dir_029_820()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=821) as make_dir_030_821:
                make_dir_030_821()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=822) as make_dir_031_822:
                make_dir_031_822()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=823) as make_dir_032_823:
                make_dir_032_823()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=824) as make_dir_033_824:
                make_dir_033_824()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=825) as make_dir_034_825:
                make_dir_034_825()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=826) as rm_file_or_dir_035_826:
            rm_file_or_dir_035_826()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=827) as shell_command_036_827:
            shell_command_036_827()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=828) as shell_command_037_828:
            shell_command_037_828()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=829) as shell_command_038_829:
            shell_command_038_829()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=830) as shell_command_039_830:
            shell_command_039_830()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=831) as shell_command_040_831:
            shell_command_040_831()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=832) as shell_command_041_832:
            shell_command_041_832()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=833) as shell_command_042_833:
            shell_command_042_833()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=834) as shell_command_043_834:
            shell_command_043_834()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=835) as shell_command_044_835:
            shell_command_044_835()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=836) as cd_stage_045_836:
            cd_stage_045_836()
            with SetExecPermissionsInSyncFolder(prog_num=837) as set_exec_permissions_in_sync_folder_046_837:
                set_exec_permissions_in_sync_folder_046_837()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=838) as cd_stage_047_838:
            cd_stage_047_838()
            with Stage(r"copy", r"IDX Intelligent Dynamics v16.0.23.24", prog_num=839):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/IDX Intelligent Dynamics.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=840) as should_copy_source_048_840:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/IDX Intelligent Dynamics.bundle", prog_num=841):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/IDX Intelligent Dynamics.bundle", where_to_unwtar=r".", prog_num=843) as unwtar_050_843:
                            unwtar_050_843()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/IDX Intelligent Dynamics.bundle", user_id=-1, group_id=-1, prog_num=844, recursive=True) as chown_051_844:
                            chown_051_844()
            with Stage(r"copy", r"IMPusher v16.0.23.24", prog_num=845):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/IMPusher.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=846) as should_copy_source_052_846:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/IMPusher.bundle", prog_num=847):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/IMPusher.bundle", where_to_unwtar=r".", prog_num=849) as unwtar_054_849:
                            unwtar_054_849()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/IMPusher.bundle", user_id=-1, group_id=-1, prog_num=850, recursive=True) as chown_055_850:
                            chown_055_850()
            with Stage(r"copy", r"WavesLib1_16_0_23_24 v16.0.23.24", prog_num=851):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=852) as should_copy_source_056_852:
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.23.framework", prog_num=853):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", where_to_unwtar=r".", prog_num=855) as unwtar_058_855:
                            unwtar_058_855()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.23.framework", user_id=-1, group_id=-1, prog_num=856, recursive=True) as chown_059_856:
                            chown_059_856()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=858) as resolve_symlink_files_in_folder_060_858:
                resolve_symlink_files_in_folder_060_858()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=859) as shell_command_061_859:
                shell_command_061_859()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=860) as script_command_062_860:
                script_command_062_860()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=861) as shell_command_063_861:
                shell_command_063_861()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=862) as create_symlink_064_862:
                create_symlink_064_862()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=863) as create_symlink_065_863:
                create_symlink_065_863()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=864) as copy_glob_to_dir_066_864:
                copy_glob_to_dir_066_864()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=865) as cd_stage_067_865:
            cd_stage_067_865()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=866):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=867) as should_copy_source_068_867:
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=868):
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=870) as chmod_and_chown_070_870:
                            chmod_and_chown_070_870()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=871) as cd_stage_071_871:
            cd_stage_071_871()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.78.79", prog_num=872):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=873) as should_copy_source_072_873:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=874):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=877, recursive=True) as chown_075_877:
                            chown_075_877()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=878) as shell_command_076_878:
                            shell_command_076_878()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=879):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=880) as should_copy_source_077_880:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=881):
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=887, recursive=True) as chown_083_887:
                            chown_083_887()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=888, recursive=True) as chmod_084_888:
                            chmod_084_888()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.91.92", prog_num=889):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=890) as should_copy_source_085_890:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=891):
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=894, recursive=True) as chown_088_894:
                            chown_088_894()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=895) as shell_command_089_895:
                            shell_command_089_895()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=896):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Applications/Waves/WaveShells V16", skip_progress_count=7, prog_num=897) as should_copy_source_090_897:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=898):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=904) as shell_command_096_904:
                            shell_command_096_904()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=905):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=906) as should_copy_source_097_906:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=907):
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=909) as unwtar_099_909:
                            unwtar_099_909()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=910, recursive=True) as chown_100_910:
                            chown_100_910()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=911) as shell_command_101_911:
                shell_command_101_911()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=912) as cd_stage_102_912:
            cd_stage_102_912()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.78.79", prog_num=913):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=914) as should_copy_source_103_914:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=915):
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=918, recursive=True) as chown_106_918:
                            chown_106_918()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=919) as shell_command_107_919:
                            shell_command_107_919()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Native Instruments/Service Center", prog_num=920) as cd_stage_108_920:
            cd_stage_108_920()
            with Stage(r"copy", r"IMPusher XML and Registry for Native Instruments", prog_num=921):
        ...
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=969) as cd_stage_141_969:
            cd_stage_141_969()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=970):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=971) as should_copy_source_142_971:
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=972):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=974, recursive=True) as chown_144_974:
                            chown_144_974()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=975) as cd_stage_145_975:
            cd_stage_145_975()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=976):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=977) as should_copy_source_146_977:
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=978):
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=982, recursive=True) as chown_150_982:
                            chown_150_982()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250907134049-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=983) as if_151_983:
                            if_151_983()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=984) as cd_stage_152_984:
            cd_stage_152_984()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=985):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=986) as should_copy_source_153_986:
                    should_copy_source_153_986()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=987):
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=988) as copy_dir_to_dir_154_988:
                            copy_dir_to_dir_154_988()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=989) as unwtar_155_989:
                            unwtar_155_989()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=990, recursive=True) as chown_156_990:
                            chown_156_990()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=991) as break_hard_link_157_991:
                            break_hard_link_157_991()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=992) as shell_command_158_992:
                            shell_command_158_992()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=993, recursive=True) as chown_159_993:
                            chown_159_993()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=994, recursive=True) as chmod_160_994:
                            chmod_160_994()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=995) as cd_stage_161_995:
            cd_stage_161_995()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.91.92", prog_num=996):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=997) as should_copy_source_162_997:
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=998):
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1001, recursive=True) as chown_165_1001:
                            chown_165_1001()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1002) as shell_command_166_1002:
                            shell_command_166_1002()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1003) as cd_stage_167_1003:
            cd_stage_167_1003()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1004):
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=1005) as should_copy_source_168_1005:
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1006):
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1012) as shell_command_174_1012:
                            shell_command_174_1012()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1013) as create_symlink_175_1013:
                create_symlink_175_1013()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1014) as create_symlink_176_1014:
                create_symlink_176_1014()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=1015) as rm_file_or_dir_177_1015:
            rm_file_or_dir_177_1015()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=1016) as shell_command_178_1016:
            shell_command_178_1016()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=1017) as script_command_179_1017:
            script_command_179_1017()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=1018) as rm_file_or_dir_180_1018:
            rm_file_or_dir_180_1018()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=1019) as glober_181_1019:
            glober_181_1019()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=1020) as glober_182_1020:
            glober_182_1020()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=1021) as glober_183_1021:
            glober_183_1021()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1022) as shell_command_184_1022:
            shell_command_184_1022()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1023) as shell_command_185_1023:
            shell_command_185_1023()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1024) as shell_command_186_1024:
            shell_command_186_1024()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1025) as shell_command_187_1025:
            shell_command_187_1025()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=1026) as shell_command_188_1026:
            shell_command_188_1026()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=1027) as script_command_189_1027:
            script_command_189_1027()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=1028) as if_190_1028:
            if_190_1028()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=1029) as if_191_1029:
            if_191_1029()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=1030) as shell_command_192_1030:
            shell_command_192_1030()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=1031) as script_command_193_1031:
            script_command_193_1031()
    with Stage(r"post-copy", prog_num=1032):
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1033) as make_dir_194_1033:
            make_dir_194_1033()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1034) as copy_file_to_file_195_1034:
            copy_file_to_file_195_1034()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1035) as chmod_196_1035:
            chmod_196_1035()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1036) as chmod_197_1036:
            chmod_197_1036()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=1037) as copy_file_to_file_198_1037:
            copy_file_to_file_198_1037()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1038) as chmod_199_1038:
            chmod_199_1038()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=1039) as copy_file_to_file_200_1039:
            copy_file_to_file_200_1039()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1040) as chmod_201_1040:
            chmod_201_1040()
        Progress(r"Done copy", prog_num=1041)()
        Progress(r"Done synccopy", prog_num=1042)()
    with Stage(r"post", prog_num=1043):
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1044) as make_dir_202_1044:
            make_dir_202_1044()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=1045) as copy_file_to_file_203_1045:
            copy_file_to_file_203_1045()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1046) as make_dir_204_1046:
            make_dir_204_1046()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/19/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=1047) as copy_file_to_file_205_1047:
            copy_file_to_file_205_1047()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1048) as make_dir_206_1048:
            make_dir_206_1048()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/19/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=1049) as copy_file_to_file_207_1049:
