...
from pybatch import *
PythonBatchCommandBase.total_progress = 23
...
with Stage(r"assign", prog_num=7):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"16-20250906114443"
    ...
    config_vars['MAIN_DOIT_ITEMS'] = (r"STOP_WAVES_PLUGINS_SERVER", r"STOP_WAVES_LOCAL_SERVER")
    config_vars['MAIN_INSTALL_TARGETS'] = (r"STOP_WAVES_PLUGINS_SERVER", r"STOP_WAVES_LOCAL_SERVER")
    ...
    config_vars['TOTAL_ITEMS_FOR_PROGRESS_REPORT'] = 13
    config_vars['WAVESLOCALCLIENT_PATH'] = r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient"
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"doit", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906114443.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906114443.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/doit-output-16-20250906114443.log", r"--run")
    ...
    config_vars['__FULL_LIST_OF_DOIT_TARGETS__'] = (r"STOP_WAVES_PLUGINS_SERVER", r"STOP_WAVES_LOCAL_SERVER")
    ...
    config_vars['__INVOCATION_RANDOM_ID__'] = r"mkcyhetkxwndvnxq"
    config_vars['__JUST_WITH_NUMBER__'] = 0
    config_vars['__MAIN_COMMAND__'] = r"doit"
    config_vars['__MAIN_DB_FILE__'] = r":memory:"
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906114443.yaml"
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906114443.py"
    config_vars['__NOW__'] = r"2025-09-06 11:44:44.740843"
...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:38.870s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:38.869s
        with Stage(r"Shutting down WavesPluginaServer(s)...", prog_num=12):  # 0m:30.854s
            # --- Begin STOP_WAVES_PLUGINS_SERVER Shutting down WavesPluginaServer(s)
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=13) as shell_command_001_13:  # 0m:0.005s
                shell_command_001_13()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=14) as shell_command_002_14:  # 0m:0.004s
                shell_command_002_14()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=15) as shell_command_003_15:  # 0m:14.061s
                shell_command_003_15()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.1", ignore_all_errors=True, prog_num=16) as shell_command_004_16:  # 0m:0.006s
                shell_command_004_16()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=17) as shell_command_005_17:  # 0m:3.489s
                shell_command_005_17()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=18) as shell_command_006_18:  # 0m:13.288s
                shell_command_006_18()
            # --- End STOP_WAVES_PLUGINS_SERVER Shutting down WavesPluginaServer(s)
        with Stage(r"Shutting down WavesPluginaServer(s)...", prog_num=19):  # 0m:8.015s
            # --- Begin STOP_WAVES_LOCAL_SERVER Shutting down WavesPluginaServer(s)
            with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wls.shutdown', message=r"Stop Waves Local Client", ignore_all_errors=True, prog_num=20, suspend=5) as shell_command_007_20:  # 0m:2.940s
                shell_command_007_20()
            # --- End STOP_WAVES_LOCAL_SERVER Shutting down WavesPluginaServer(s)
    with Stage(r"post_doit", prog_num=21):  # 0m:0.001s
        print("Done Doing it")

with Stage(r"epilog", prog_num=22):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250906114443.py", prog_num=23) as patch_py_batch_with_timings_008_23:  # ?
        patch_py_batch_with_timings_008_23()

log.info("Shakespeare says: All's Well That Ends Well")
# eof


# doit time 0m:38.869s
