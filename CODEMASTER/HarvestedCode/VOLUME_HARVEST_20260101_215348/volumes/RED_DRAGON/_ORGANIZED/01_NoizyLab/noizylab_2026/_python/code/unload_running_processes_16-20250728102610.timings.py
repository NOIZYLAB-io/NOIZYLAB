...
with Stage(r"assign", prog_num=7):  # 0m:0.000s
    ...
    config_vars['ACTION_ID'] = r"16-20250728102610"
    ...
    config_vars['__ARGV__'] = (r"/Applications/Waves Central.app/Contents/Resources/res/external/bin/instl.bundle/Contents/MacOS/instl", r"doit", r"--in", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250728102610.yaml", r"--out", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250728102610.py", r"--log", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/doit-output-16-20250728102610.log", r"--run")
    ...
    config_vars['__INVOCATION_RANDOM_ID__'] = r"vgrwemwvookccpjm"
    config_vars['__JUST_WITH_NUMBER__'] = 0
    config_vars['__MAIN_COMMAND__'] = r"doit"
    config_vars['__MAIN_DB_FILE__'] = r":memory:"
    config_vars['__MAIN_INPUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250728102610.yaml"
    config_vars['__MAIN_OUT_FILE__'] = r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250728102610.py"
    config_vars['__NOW__'] = r"2025-07-28 10:26:11.908829"
...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:23.823s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:23.821s
        with Stage(r"Shutting down servers...", prog_num=12):  # 0m:23.821s
            # --- Begin STOP_SERVERS Shutting down servers
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=13) as shell_command_001_13:  # 0m:0.004s
            ...
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=15) as shell_command_003_15:  # 0m:7.749s
            ...
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=17) as shell_command_005_17:  # 0m:3.229s
                shell_command_005_17()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=18) as shell_command_006_18:  # 0m:7.601s
                shell_command_006_18()
            with If(IsFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient"), if_true=ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop Waves Local Client", suspend=5), ignore_all_errors=True, prog_num=19) as if_007_19:  # 0m:5.228s
                if_007_19()
...
with Stage(r"epilog", prog_num=21):  # ?
    with PatchPyBatchWithTimings(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/unloadRunningProcesses/unload_running_processes_16-20250728102610.py", prog_num=22) as patch_py_batch_with_timings_008_22:  # ?
