...
with PythonBatchRuntime(r"doit", prog_num=8):  # 0m:50.814s
    ...
    with Stage(r"pre_doit", prog_num=10):  # 0m:0.000s
        pass
    with Stage(r"doit", prog_num=11):  # 0m:50.813s
        with Stage(r"Shutting down servers...", prog_num=12):  # 0m:45.916s
            # --- Begin STOP_SERVERS Shutting down servers
            with ShellCommand(r'launchctl unload "/Users/rsp_ms/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=13) as shell_command_001_13:  # 0m:0.012s
                shell_command_001_13()
            with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=14) as shell_command_002_14:  # 0m:0.014s
                shell_command_002_14()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=15) as shell_command_003_15:  # 0m:0.006s
                shell_command_003_15()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=16) as shell_command_004_16:  # 0m:0.005s
                shell_command_004_16()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=17) as shell_command_005_17:  # 0m:6.404s
                shell_command_005_17()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.1", ignore_all_errors=True, prog_num=18) as shell_command_006_18:  # 0m:0.008s
                shell_command_006_18()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.1", ignore_all_errors=True, prog_num=19) as shell_command_007_19:  # 0m:34.199s
                shell_command_007_19()
            with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=20) as shell_command_008_20:  # 0m:0.008s
                shell_command_008_20()
            with If(IsFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient"), if_true=ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop Waves Local Server", suspend=5), ignore_all_errors=True, prog_num=21) as if_009_21:  # 0m:5.261s
                if_009_21()
            # --- End STOP_SERVERS Shutting down servers
        with Stage(r"Clean main waves dir...", prog_num=22):  # 0m:0.384s
            # --- Begin CLEAN_WAVES_PROGRAMDATA_DIR Clean main waves dir
            with Glober(r"/Library/Application Support/Waves/*", RmFileOrDir, r"path", excludes=[r"Redis*"], prog_num=23) as glober_010_23:  # 0m:0.383s
                glober_010_23()
            # --- End CLEAN_WAVES_PROGRAMDATA_DIR Clean main waves dir
        with Stage(r"Clean /Users/rsp_ms/Library/Caches/Waves Audio...", prog_num=24):  # 0m:0.995s
            # --- Begin CLEAN_USER_CACHE_DIR Clean /Users/rsp_ms/Library/Caches/Waves Audio
            with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves Audio", prog_num=25) as rm_file_or_dir_011_25:  # 0m:0.995s
                rm_file_or_dir_011_25()
            # --- End CLEAN_USER_CACHE_DIR Clean /Users/rsp_ms/Library/Caches/Waves Audio
        with Stage(r"Clean waves cache dir...", prog_num=26):  # 0m:0.001s
            # --- Begin CLEAN_WAVES_CACHE_DIR Clean waves cache dir
            with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=27) as rm_file_or_dir_012_27:  # 0m:0.001s
        ...
        with Stage(r"Clean /Applications/Waves/WaveShells...", prog_num=32):  # 0m:0.056s
            # --- Begin CLEAN_SHELLS_DIR Clean /Applications/Waves/WaveShells
            with Glober(r"/Applications/Waves/WaveShells V*", RmFileOrDir, r"path", prog_num=33) as glober_015_33:  # 0m:0.055s
                glober_015_33()
            # --- End CLEAN_SHELLS_DIR Clean /Applications/Waves/WaveShells
        with Stage(r"Clean /Applications/Waves/Plug-Ins...", prog_num=34):  # 0m:1.620s
            # --- Begin CLEAN_PLUGINS_DIR Clean /Applications/Waves/Plug-Ins
            with Glober(r"/Applications/Waves/Plug-Ins V*", RmFileOrDir, r"path", prog_num=35) as glober_016_35:  # 0m:1.619s
                glober_016_35()
        ...
        with Stage(r"Clean session files originated from /Users/Shared/Waves...", prog_num=37):  # 0m:0.004s
        ...
        with Stage(r"Clean /Applications/Waves/Applications...", prog_num=45):  # 0m:0.007s
            # --- Begin CLEAN_WAVES_APPLICATIONS_DIR Clean /Applications/Waves/Applications
            with Glober(r"/Applications/Waves/Applications V*", RmFileOrDir, r"path", prog_num=46) as glober_025_46:  # 0m:0.007s
                glober_025_46()
        ...
        with Stage(r"Clean /Applications/Waves/COSMOS...", prog_num=60):  # 0m:0.035s
            # --- Begin CLEAN_WAVES_COSMOS_DIR Clean /Applications/Waves/COSMOS
            with RmFileOrDir(r"/Applications/Waves/COSMOS", prog_num=61) as rm_file_or_dir_033_61:  # 0m:0.035s
                rm_file_or_dir_033_61()
            # --- End CLEAN_WAVES_COSMOS_DIR Clean /Applications/Waves/COSMOS
        with Stage(r"Clean /Applications/Waves/Data with a few exceptions...", prog_num=62):  # 0m:0.498s
            # --- Begin CLEAN_WAVES_DATA_DIR Clean /Applications/Waves/Data with a few exceptions
            with Glober(r"/Applications/Waves/Data/*", RmFileOrDir, r"path", excludes=[r"Instrument Data*",r"IR1Impulses*",r"Presets*",r"Setup Libraries*",r"Waves Gems*"], prog_num=63) as glober_034_63:  # 0m:0.498s
                glober_034_63()
        ...
        with Stage(r"Clean /Users/rsp_ms/Library/Preferences/Waves Preferences...", prog_num=64):  # 0m:0.005s
            ...
            with Glober(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins*", RmSymlink, r"path", prog_num=65) as glober_035_65:  # 0m:0.001s
                glober_035_65()
            ...
            with RmSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves EMotion LV1 Modules", prog_num=67) as rm_symlink_037_67:  # 0m:0.000s
                rm_symlink_037_67()
            with Glober(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/*", RmFileOrDir, r"path", excludes=[r"wls.config*",r"FeatureFlags.yaml*",r"ForceUseGUIScanner*",r"Waves Central.json*"], prog_num=68) as glober_038_68:  # 0m:0.003s
                glober_038_68()
            # --- End CLEAN_WAVES_PREFERENCES_DIR Clean /Users/rsp_ms/Library/Preferences/Waves Preferences
        with Stage(r"Clean /Users/rsp_ms/Library/Application Support/Waves Audio\Waves Local Server and database...", prog_num=69):  # 0m:0.002s
            ...
            with RmFileOrDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Local Server", prog_num=70) as rm_file_or_dir_039_70:  # 0m:0.002s
        ...
        with Stage(r"Clean user Waves Audio directory...", prog_num=71):  # 0m:0.002s
        ...
        with Stage(r"Clean /Library/Audio/Plug-Ins/WPAPI...", prog_num=75):  # 0m:0.003s
            # --- Begin CLEAN_WAVES_WPAPI_DIR Clean /Library/Audio/Plug-Ins/WPAPI
            with Glober(r"/Library/Audio/Plug-Ins/WPAPI/WaveShell*", RmFileOrDir, r"path", prog_num=76) as glober_043_76:  # 0m:0.002s
                glober_043_76()
            # --- End CLEAN_WAVES_WPAPI_DIR Clean /Library/Audio/Plug-Ins/WPAPI
        with Stage(r"Clean /Library/Application Support/Avid/Audio/Plug-Ins...", prog_num=77):  # 0m:0.028s
            # --- Begin CLEAN_WAVESHELL_AAX_DIR Clean /Library/Application Support/Avid/Audio/Plug-Ins
            with Glober(r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell*", RmFileOrDir, r"path", prog_num=78) as glober_044_78:  # 0m:0.028s
                glober_044_78()
            # --- End CLEAN_WAVESHELL_AAX_DIR Clean /Library/Application Support/Avid/Audio/Plug-Ins
        with Stage(r"Clean /Library/Audio/Plug-Ins/Components...", prog_num=79):  # 0m:0.039s
            # --- Begin CLEAN_MACOS_WAVESHELL_AU_DIR Clean /Library/Audio/Plug-Ins/Components
            with Glober(r"/Library/Audio/Plug-Ins/Components/WaveShell*", RmFileOrDir, r"path", prog_num=80) as glober_045_80:  # 0m:0.039s
                glober_045_80()
            # --- End CLEAN_MACOS_WAVESHELL_AU_DIR Clean /Library/Audio/Plug-Ins/Components
        with Stage(r"Clean vst dir...", prog_num=81):  # 0m:0.006s
            # --- Begin CLEAN_WAVESHELL_VST_DIR Clean vst dir
            with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*", RmFileOrDir, r"path", prog_num=82) as glober_046_82:  # 0m:0.004s
                glober_046_82()
        ...
        with Stage(r"Clean vst3 dir...", prog_num=84):  # 0m:0.007s
            # --- Begin CLEAN_WAVESHELL_VST3_DIR Clean vst3 dir
            with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*", RmFileOrDir, r"path", prog_num=85) as glober_048_85:  # 0m:0.007s
                glober_048_85()
            # --- End CLEAN_WAVESHELL_VST3_DIR Clean vst3 dir
        with Stage(r"Clean /Library/Application Support/Native Instruments/Service Center...", prog_num=86):  # 0m:0.013s
            # --- Begin CLEAN_NATIVE_INSTRUMENTS_DIR Clean /Library/Application Support/Native Instruments/Service Center
            with Glober(r"/Library/Application Support/Native Instruments/Service Center/Waves-*.xml", RmFileOrDir, r"path", prog_num=87) as glober_049_87:  # 0m:0.013s
                glober_049_87()
            # --- End CLEAN_NATIVE_INSTRUMENTS_DIR Clean /Library/Application Support/Native Instruments/Service Center
        with Stage(r"Clean /Applications/Waves/SoundGrid...", prog_num=88):  # 0m:0.991s
            ...
            with If(IsFile(r"/Applications/Waves/SoundGrid/Utilities/SoundGrid Driver Uninstaller.app/Contents/MacOS//SoundGridDriverUninstaller.py"), if_true=ShellCommand(r'"/Applications/Waves/SoundGrid/Utilities/SoundGrid Driver Uninstaller.app/Contents/MacOS//SoundGridDriverUninstaller.py"', message=r"Uninstalling SoundGrid Driver", ignore_all_errors=True), prog_num=89) as if_050_89:  # 0m:0.000s
                if_050_89()
            with RmFileOrDir(r"/Applications/Waves/SoundGrid", prog_num=90) as rm_file_or_dir_051_90:  # 0m:0.990s
                rm_file_or_dir_051_90()
            # --- End CLEAN_WAVES_SOUNDGRID_DIR Clean /Applications/Waves/SoundGrid
        with Stage(r"Clean /Library/Preferences/com.native-instruments.Waves...", prog_num=91):  # 0m:0.196s
            # --- Begin CLEAN_NI_PLIST_FILES Clean /Library/Preferences/com.native-instruments.Waves
            with Glober(r"/Library/Preferences/com.native-instruments.Waves-*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=92) as glober_052_92:  # 0m:0.182s
                glober_052_92()
            with Glober(r"/tmp/com.native-instruments.Waves-*", RmFileOrDir, r"path", ignore_all_errors=True, prog_num=93) as glober_053_93:  # 0m:0.013s
                glober_053_93()
            # --- End CLEAN_NI_PLIST_FILES Clean /Library/Preferences/com.native-instruments.Waves
        with Stage(r"clean waves plist files in /Library/LaunchAgents directory...", prog_num=94):  # 0m:0.001s
            # --- Begin CLEAN_LAUNCH_AGENTS_DIR clean waves plist files in /Library/LaunchAgents directory
            with Glober(r"/Library/LaunchAgents/com.waves.*.agent.plist", RmFileOrDir, r"path", prog_num=95) as glober_054_95:  # 0m:0.001s
                glober_054_95()
            # --- End CLEAN_LAUNCH_AGENTS_DIR clean waves plist files in /Library/LaunchAgents directory
        with Stage(r"clean COSMOS related files...", prog_num=96):  # 0m:0.001s
        ...
        with Stage(r"Clean SoundGrid-related .plist files...", prog_num=99):  # 0m:0.001s
