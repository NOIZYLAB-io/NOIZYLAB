...
with Stage(r"assign", prog_num=568):  # 0m:0.000s
...
with PythonBatchRuntime(r"synccopy", prog_num=569):  # 0m:32.380s
    with Stage(r"begin", prog_num=570):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=571):  # 0m:0.007s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=572) as copy_file_to_file_001_572:  # 0m:0.004s
            copy_file_to_file_001_572()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=573) as copy_file_to_file_002_573:  # 0m:0.003s
            copy_file_to_file_002_573()
    with Stage(r"sync", prog_num=574):  # 0m:5.405s
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=575) as shell_command_003_575:  # 0m:0.007s
            shell_command_003_575()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=576) as shell_command_004_576:  # 0m:0.008s
            shell_command_004_576()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=577) as shell_command_005_577:  # 0m:0.948s
            shell_command_005_577()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=578) as shell_command_006_578:  # 0m:0.949s
            shell_command_006_578()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=579) as shell_command_007_579:  # 0m:0.005s
            shell_command_007_579()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=580) as shell_command_008_580:  # 0m:0.946s
            shell_command_008_580()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=581) as shell_command_009_581:  # 0m:0.005s
            shell_command_009_581()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=582) as shell_command_010_582:  # 0m:0.004s
            shell_command_010_582()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=583) as shell_command_011_583:  # 0m:0.138s
            shell_command_011_583()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=584):  # 0m:2.395s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=585) as make_dir_012_585:  # 0m:0.003s
                make_dir_012_585()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=586) as cd_013_586:  # 0m:2.391s
                cd_013_586()
                Progress(r"3704 files already in cache", own_progress_count=3704, prog_num=4290)()  # 0m:0.000s
                with CreateSyncFolders(own_progress_count=38, prog_num=4328) as create_sync_folders_014_4328:  # 0m:0.101s
                    create_sync_folders_014_4328()
                Progress(r"Downloading with 50 processes in parallel", prog_num=4329)()  # 0m:0.000s
                Progress(r"Downloading with curl parallel", prog_num=4330)()  # 0m:0.000s
                with CurlWithInternalParallel(curl_path=r"curl", config_file_path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401.py_curl/dl-00", total_files_to_download=107, previously_downloaded_files=0, total_bytes_to_download=184899485, own_progress_count=104, prog_num=4434, report_own_progress=False) as curl_with_internal_parallel_015_4434:  # 0m:1.880s
                    curl_with_internal_parallel_015_4434()
                with CurlWithInternalParallel(curl_path=r"curl", config_file_path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401.py_curl/dl-01", total_files_to_download=107, previously_downloaded_files=104, total_bytes_to_download=184899485, own_progress_count=3, prog_num=4437, report_own_progress=False) as curl_with_internal_parallel_016_4437:  # 0m:0.087s
                    curl_with_internal_parallel_016_4437()
                Progress(r"Downloading 107 files done", prog_num=4438)()  # 0m:0.000s
                with RunInThread(Ls(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", out_file=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/after-sync-sync-folder-manifest.txt"), thread_name=r"list_sync_folder", daemon=True, ignore_all_errors=True, prog_num=4439) as run_in_thread_017_4439:  # 0m:0.000s
                    run_in_thread_017_4439()
                Progress(r"Check checksum ...", prog_num=4440)()  # 0m:0.000s
                with CheckDownloadFolderChecksum(print_report=True, raise_on_bad_checksum=True, max_bad_files_to_redownload=32, own_progress_count=107, prog_num=4547) as check_download_folder_checksum_018_4547:  # 0m:0.134s
                    check_download_folder_checksum_018_4547()
                with Stage(r"post_sync", prog_num=4548):  # 0m:0.188s
                    Progress(r"Adjust ownership and permissions /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16...", prog_num=4549)()  # 0m:0.000s
                    with ChmodAndChown(path=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", mode="a+rwX", user_id=-1, group_id=-1, ignore_all_errors=True, prog_num=4550, recursive=True) as chmod_and_chown_019_4550:  # 0m:0.181s
                        chmod_and_chown_019_4550()
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=4551) as copy_file_to_file_020_4551:  # 0m:0.007s
                        copy_file_to_file_020_4551()
            Progress(r"Done sync", prog_num=4552)()  # 0m:0.000s
    with Stage(r"copy", prog_num=4553):  # 0m:26.915s
        Progress(r"Start copy from /Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=4554)()  # 0m:0.000s
        with Stage(r"create folders", prog_num=4555):  # 0m:0.082s
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=4556) as make_dir_021_4556:  # 0m:0.003s
                make_dir_021_4556()
            with MakeDir(r"/Applications/Waves/COSMOS", chowner=True, prog_num=4557) as make_dir_022_4557:  # 0m:0.003s
                make_dir_022_4557()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=4558) as make_dir_023_4558:  # 0m:0.003s
                make_dir_023_4558()
            with MakeDir(r"/Applications/Waves/Data/Presets", chowner=True, prog_num=4559) as make_dir_024_4559:  # 0m:0.003s
                make_dir_024_4559()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=4560) as make_dir_025_4560:  # 0m:0.003s
                make_dir_025_4560()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=4561) as make_dir_026_4561:  # 0m:0.003s
                make_dir_026_4561()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=4562) as make_dir_027_4562:  # 0m:0.003s
                make_dir_027_4562()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=4563) as make_dir_028_4563:  # 0m:0.003s
                make_dir_028_4563()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=4564) as make_dir_029_4564:  # 0m:0.003s
                make_dir_029_4564()
            with MakeDir(r"/Library/Application Support/Waves/COSMOS", chowner=True, prog_num=4565) as make_dir_030_4565:  # 0m:0.004s
                make_dir_030_4565()
            with MakeDir(r"/Library/Application Support/Waves/COSMOS/AnalyzeAudio", chowner=True, prog_num=4566) as make_dir_031_4566:  # 0m:0.003s
                make_dir_031_4566()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=4567) as make_dir_032_4567:  # 0m:0.004s
                make_dir_032_4567()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=4568) as make_dir_033_4568:  # 0m:0.003s
                make_dir_033_4568()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=4569) as make_dir_034_4569:  # 0m:0.004s
                make_dir_034_4569()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=4570) as make_dir_035_4570:  # 0m:0.003s
                make_dir_035_4570()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=4571) as make_dir_036_4571:  # 0m:0.005s
                make_dir_036_4571()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=4572) as make_dir_037_4572:  # 0m:0.003s
                make_dir_037_4572()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=4573) as make_dir_038_4573:  # 0m:0.003s
                make_dir_038_4573()
            with MakeDir(r"/Library/Application Support/Waves/WavesPluginServer", chowner=True, prog_num=4574) as make_dir_039_4574:  # 0m:0.003s
                make_dir_039_4574()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=4575) as make_dir_040_4575:  # 0m:0.004s
                make_dir_040_4575()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=4576) as make_dir_041_4576:  # 0m:0.003s
                make_dir_041_4576()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=4577) as make_dir_042_4577:  # 0m:0.004s
                make_dir_042_4577()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=4578) as make_dir_043_4578:  # 0m:0.003s
                make_dir_043_4578()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=4579) as make_dir_044_4579:  # 0m:0.004s
                make_dir_044_4579()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=4580) as rm_file_or_dir_045_4580:  # 0m:0.000s
            rm_file_or_dir_045_4580()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=4581) as shell_command_046_4581:  # 0m:0.006s
            shell_command_046_4581()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=4582) as shell_command_047_4582:  # 0m:0.008s
            shell_command_047_4582()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=4583) as shell_command_048_4583:  # 0m:1.037s
            shell_command_048_4583()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=4584) as shell_command_049_4584:  # 0m:1.030s
            shell_command_049_4584()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=4585) as shell_command_050_4585:  # 0m:0.006s
            shell_command_050_4585()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=4586) as shell_command_051_4586:  # 0m:1.034s
            shell_command_051_4586()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=4587) as shell_command_052_4587:  # 0m:0.004s
            shell_command_052_4587()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=4588) as shell_command_053_4588:  # 0m:0.004s
            shell_command_053_4588()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=4589) as shell_command_054_4589:  # 0m:0.152s
            shell_command_054_4589()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=4590) as cd_stage_055_4590:  # 0m:0.010s
            cd_stage_055_4590()
            with SetExecPermissionsInSyncFolder(prog_num=4591) as set_exec_permissions_in_sync_folder_056_4591:  # 0m:0.009s
                set_exec_permissions_in_sync_folder_056_4591()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/COSMOS", prog_num=4592) as cd_stage_057_4592:  # 0m:10.524s
            cd_stage_057_4592()
            with Stage(r"copy", r"COSMOS__Application v16.0.50.51", prog_num=4593):  # 0m:10.516s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Apps/COSMOS.app", r"/Applications/Waves/COSMOS", skip_progress_count=4, prog_num=4594) as should_copy_source_058_4594:  # 0m:10.515s
                    should_copy_source_058_4594()
                    with Stage(r"copy source", r"Mac/Apps/COSMOS.app", prog_num=4595):  # 0m:10.515s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Apps/COSMOS.app", r".", hard_links=False, delete_extraneous_files=True, prog_num=4596) as copy_dir_to_dir_059_4596:  # 0m:0.123s
                            copy_dir_to_dir_059_4596()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Apps/COSMOS.app", where_to_unwtar=r".", prog_num=4597) as unwtar_060_4597:  # 0m:10.392s
                            unwtar_060_4597()
                        with Chown(path=r"/Applications/Waves/COSMOS/COSMOS.app", user_id=-1, group_id=-1, prog_num=4598, recursive=True) as chown_061_4598:  # 0m:0.000s
                            chown_061_4598()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/COSMOS", own_progress_count=10, prog_num=4608) as resolve_symlink_files_in_folder_062_4608:  # 0m:0.008s
                resolve_symlink_files_in_folder_062_4608()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data", prog_num=4609) as cd_stage_063_4609:  # 0m:0.022s
            cd_stage_063_4609()
            with Stage(r"copy", r"COSMOS__Data_Folders v2.0.2.2", prog_num=4610):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/COSMOS", r"/Applications/Waves/Data", skip_progress_count=3, prog_num=4611) as should_copy_source_064_4611:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/COSMOS", prog_num=4612):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/Data/COSMOS", user_id=-1, group_id=-1, prog_num=4614, recursive=True) as chown_066_4614:  # 0m:0.001s
                            chown_066_4614()
            with Stage(r"copy", r"COSMOS__Models_Data_Folders v2.0.0.4", prog_num=4615):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Models", r"/Applications/Waves/Data", skip_progress_count=4, prog_num=4616) as should_copy_source_067_4616:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/Models", prog_num=4617):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Models", where_to_unwtar=r".", prog_num=4619) as unwtar_069_4619:  # ?
                            unwtar_069_4619()
                        with Chown(path=r"/Applications/Waves/Data/Models", user_id=-1, group_id=-1, prog_num=4620, recursive=True) as chown_070_4620:  # 0m:0.000s
                            chown_070_4620()
            with Stage(r"copy", r"ORS Modulators Data v1.0.0.4", prog_num=4621):  # 0m:0.021s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/ORS Modulators", r"/Applications/Waves/Data", skip_progress_count=3, prog_num=4622) as should_copy_source_071_4622:  # 0m:0.021s
                    should_copy_source_071_4622()
                    with Stage(r"copy source", r"Common/Data/ORS Modulators", prog_num=4623):  # 0m:0.020s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/ORS Modulators", r".", delete_extraneous_files=True, prog_num=4624) as copy_dir_to_dir_072_4624:  # 0m:0.020s
                            copy_dir_to_dir_072_4624()
                        with Chown(path=r"/Applications/Waves/Data/ORS Modulators", user_id=-1, group_id=-1, prog_num=4625, recursive=True) as chown_073_4625:  # 0m:0.000s
                            chown_073_4625()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/Presets", prog_num=4626) as cd_stage_074_4626:  # 0m:0.001s
            cd_stage_074_4626()
            with Stage(r"copy", r"CR8 Sampler_Presets v1.0.6.10", prog_num=4627):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/CR8 Sampler", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=4628) as should_copy_source_075_4628:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/CR8 Sampler", prog_num=4629):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/CR8 Sampler", user_id=-1, group_id=-1, prog_num=4631, recursive=True) as chown_077_4631:  # 0m:0.001s
                            chown_077_4631()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=4632) as cd_stage_078_4632:  # 0m:1.175s
            cd_stage_078_4632()
            with Stage(r"copy", r"COSMOS_Plugin v16.0.23.24", prog_num=4633):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/COSMOS.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=4634) as should_copy_source_079_4634:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/COSMOS.bundle", prog_num=4635):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/COSMOS.bundle", where_to_unwtar=r".", prog_num=4637) as unwtar_081_4637:  # ?
                            unwtar_081_4637()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/COSMOS.bundle", user_id=-1, group_id=-1, prog_num=4638, recursive=True) as chown_082_4638:  # 0m:0.000s
                            chown_082_4638()
            with Stage(r"copy", r"WavesLib1_16_0_23_24 v16.0.23.24", prog_num=4639):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=4640) as should_copy_source_083_4640:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.23.framework", prog_num=4641):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", where_to_unwtar=r".", prog_num=4643) as unwtar_085_4643:  # ?
                            unwtar_085_4643()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.23.framework", user_id=-1, group_id=-1, prog_num=4644, recursive=True) as chown_086_4644:  # 0m:0.000s
                            chown_086_4644()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=4646) as resolve_symlink_files_in_folder_087_4646:  # 0m:0.952s
                resolve_symlink_files_in_folder_087_4646()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=4647) as shell_command_088_4647:  # 0m:0.097s
                shell_command_088_4647()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=4648) as script_command_089_4648:  # 0m:0.006s
                script_command_089_4648()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=4649) as shell_command_090_4649:  # 0m:0.021s
                shell_command_090_4649()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=4650) as create_symlink_091_4650:  # 0m:0.001s
                create_symlink_091_4650()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=4651) as create_symlink_092_4651:  # 0m:0.000s
                create_symlink_092_4651()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=4652) as copy_glob_to_dir_093_4652:  # 0m:0.097s
                copy_glob_to_dir_093_4652()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=4653) as cd_stage_094_4653:  # 0m:0.000s
            cd_stage_094_4653()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=4654):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=4655) as should_copy_source_095_4655:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=4656):  # ?
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=4658) as chmod_and_chown_097_4658:  # 0m:0.000s
                            chmod_and_chown_097_4658()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=4659) as cd_stage_098_4659:  # 0m:0.009s
            cd_stage_098_4659()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=4660):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=4661) as should_copy_source_099_4661:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=4662):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=4665, recursive=True) as chown_102_4665:  # ?
                            chown_102_4665()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=4666) as shell_command_103_4666:  # 0m:0.000s
                            shell_command_103_4666()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=4667):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=4668) as should_copy_source_104_4668:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=4669):  # ?
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=4675, recursive=True) as chown_110_4675:  # ?
                            chown_110_4675()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=4676, recursive=True) as chmod_111_4676:  # 0m:0.000s
                            chmod_111_4676()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=4677):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=4678) as should_copy_source_112_4678:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=4679):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=4682, recursive=True) as chown_115_4682:  # ?
                            chown_115_4682()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=4683) as shell_command_116_4683:  # 0m:0.000s
                            shell_command_116_4683()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=4684):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=4685) as should_copy_source_117_4685:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=4686):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=4688) as unwtar_119_4688:  # ?
                            unwtar_119_4688()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=4689, recursive=True) as chown_120_4689:  # 0m:0.000s
                            chown_120_4689()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=4690) as shell_command_121_4690:  # 0m:0.008s
                shell_command_121_4690()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=4691) as cd_stage_122_4691:  # 0m:0.001s
            cd_stage_122_4691()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=4692):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=4693) as should_copy_source_123_4693:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=4694):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=4697, recursive=True) as chown_126_4697:  # ?
                            chown_126_4697()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=4698) as shell_command_127_4698:  # 0m:0.001s
                            shell_command_127_4698()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/COSMOS", prog_num=4699) as cd_stage_128_4699:  # 0m:0.120s
            cd_stage_128_4699()
            with Stage(r"copy", r"COSMOS_HTML v2.6.6", prog_num=4700):  # 0m:0.013s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/COSMOS/HTML", r"/Library/Application Support/Waves/COSMOS", skip_progress_count=3, prog_num=4701) as should_copy_source_129_4701:  # 0m:0.013s
                    should_copy_source_129_4701()
                    with Stage(r"copy source", r"Mac/COSMOS/HTML", prog_num=4702):  # 0m:0.013s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/COSMOS/HTML", r".", delete_extraneous_files=True, prog_num=4703) as copy_dir_to_dir_130_4703:  # 0m:0.012s
                            copy_dir_to_dir_130_4703()
                        with Chown(path=r"/Library/Application Support/Waves/COSMOS/HTML", user_id=-1, group_id=-1, prog_num=4704, recursive=True) as chown_131_4704:  # 0m:0.000s
                            chown_131_4704()
            with Stage(r"copy", r"COSMOS_python v2.7.7", prog_num=4705):  # 0m:0.107s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/COSMOS/python", r"/Library/Application Support/Waves/COSMOS", skip_progress_count=4, prog_num=4706) as should_copy_source_132_4706:  # 0m:0.106s
                    should_copy_source_132_4706()
                    with Stage(r"copy source", r"Mac/COSMOS/python", prog_num=4707):  # 0m:0.106s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/COSMOS/python", r".", delete_extraneous_files=True, prog_num=4708) as copy_dir_to_dir_133_4708:  # 0m:0.067s
                            copy_dir_to_dir_133_4708()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/COSMOS/python", where_to_unwtar=r".", prog_num=4709) as unwtar_134_4709:  # 0m:0.038s
                            unwtar_134_4709()
                        with Chown(path=r"/Library/Application Support/Waves/COSMOS/python", user_id=-1, group_id=-1, prog_num=4710, recursive=True) as chown_135_4710:  # 0m:0.000s
                            chown_135_4710()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/COSMOS/AnalyzeAudio", prog_num=4711) as cd_stage_136_4711:  # 0m:0.003s
            cd_stage_136_4711()
            with Stage(r"copy", r"AnalyzeAudio v16.0.23.24", prog_num=4712):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Tools/AnalyzeAudio.bundle", r"/Library/Application Support/Waves/COSMOS/AnalyzeAudio", skip_progress_count=4, prog_num=4713) as should_copy_source_137_4713:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Tools/AnalyzeAudio.bundle", prog_num=4714):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Tools/AnalyzeAudio.bundle", where_to_unwtar=r".", prog_num=4716) as unwtar_139_4716:  # ?
                            unwtar_139_4716()
                        with Chown(path=r"/Library/Application Support/Waves/COSMOS/AnalyzeAudio/AnalyzeAudio.bundle", user_id=-1, group_id=-1, prog_num=4717, recursive=True) as chown_140_4717:  # 0m:0.001s
                            chown_140_4717()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=4718) as cd_stage_141_4718:  # 0m:0.001s
            cd_stage_141_4718()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=4719):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=4720) as should_copy_source_142_4720:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=4721):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=4723, recursive=True) as chown_144_4723:  # 0m:0.000s
                            chown_144_4723()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V16", prog_num=4724) as cd_stage_145_4724:  # 0m:0.001s
            cd_stage_145_4724()
            with Stage(r"copy", r"Demo Mode V16 1.1 v1.1", prog_num=4725):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V16/1", r"/Library/Application Support/Waves/Demo Mode/V16", skip_progress_count=3, prog_num=4726) as should_copy_source_146_4726:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V16/1", prog_num=4727):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V16/1", user_id=-1, group_id=-1, prog_num=4729, recursive=True) as chown_148_4729:  # 0m:0.000s
                            chown_148_4729()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/License Notifications/V16", prog_num=4730) as cd_stage_149_4730:  # 0m:0.001s
            cd_stage_149_4730()
            with Stage(r"copy", r"License Notifications V16 1.1 v1.1", prog_num=4731):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/License Notifications/V16/1", r"/Library/Application Support/Waves/License Notifications/V16", skip_progress_count=3, prog_num=4732) as should_copy_source_150_4732:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V16/1", prog_num=4733):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V16/1", user_id=-1, group_id=-1, prog_num=4735, recursive=True) as chown_152_4735:  # 0m:0.000s
                            chown_152_4735()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=4736) as cd_stage_153_4736:  # 0m:4.167s
            cd_stage_153_4736()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=4737) as rm_file_or_dir_154_4737:  # 0m:0.000s
                rm_file_or_dir_154_4737()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=4738):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=4739) as should_copy_source_155_4739:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=4740):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=4742) as unwtar_157_4742:  # ?
                            unwtar_157_4742()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=4743, recursive=True) as chown_158_4743:  # 0m:0.000s
                            chown_158_4743()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=4744):  # 0m:0.004s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=4745) as should_copy_source_159_4745:  # 0m:0.004s
                    should_copy_source_159_4745()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=4746):  # 0m:0.004s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=4747) as unwtar_160_4747:  # 0m:0.004s
                            unwtar_160_4747()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=4748):  # 0m:4.151s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=4749) as should_copy_source_161_4749:  # 0m:4.150s
                    should_copy_source_161_4749()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=4750):  # 0m:4.150s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=4751) as copy_dir_to_dir_162_4751:  # 0m:0.009s
                            copy_dir_to_dir_162_4751()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=4752) as unwtar_163_4752:  # 0m:4.141s
                            unwtar_163_4752()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=4753, recursive=True) as chown_164_4753:  # 0m:0.000s
                            chown_164_4753()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=4754):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=4755) as should_copy_source_165_4755:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=4756):  # ?
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=4759) as chmod_168_4759:  # ?
                            chmod_168_4759()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=4760, recursive=True) as chown_169_4760:  # 0m:0.000s
                            chown_169_4760()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=4763) as resolve_symlink_files_in_folder_170_4763:  # 0m:0.002s
                resolve_symlink_files_in_folder_170_4763()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=4764) as shell_command_171_4764:  # 0m:0.009s
                shell_command_171_4764()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=4765) as cd_stage_172_4765:  # 0m:0.003s
            cd_stage_172_4765()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=4766):  # 0m:0.003s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=4767) as should_copy_source_173_4767:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=4768):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=4770, recursive=True) as chown_175_4770:  # 0m:0.003s
                            chown_175_4770()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=4771) as cd_stage_176_4771:  # 0m:0.001s
            cd_stage_176_4771()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=4772):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=4773) as should_copy_source_177_4773:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=4774):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=4776, recursive=True) as chown_179_4776:  # 0m:0.000s
                            chown_179_4776()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=4777) as cd_stage_180_4777:  # 0m:1.633s
            cd_stage_180_4777()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=4778):  # 0m:1.633s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=4779) as should_copy_source_181_4779:  # 0m:1.633s
                    should_copy_source_181_4779()
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=4780):  # 0m:1.632s
                        with Chmod(path=r"${HOME}/Library/Caches/numba", mode="a+rwX", ignore_if_not_exist=True, ignore_all_errors=True, prog_num=4781, recursive=True) as chmod_182_4781:  # 0m:0.004s
                            chmod_182_4781()
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r".", hard_links=False, delete_extraneous_files=True, prog_num=4782) as copy_dir_to_dir_183_4782:  # 0m:0.036s
                            copy_dir_to_dir_183_4782()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", where_to_unwtar=r".", prog_num=4783) as unwtar_184_4783:  # 0m:1.590s
                            unwtar_184_4783()
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=4784, recursive=True) as chown_185_4784:  # 0m:0.000s
                            chown_185_4784()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=4785) as if_186_4785:  # 0m:0.001s
                            if_186_4785()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesPluginServer", prog_num=4786) as cd_stage_187_4786:  # 0m:0.002s
            cd_stage_187_4786()
            with Stage(r"copy", r"WavesPluginServer_V16_1 v16.1.1.2", prog_num=4787):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesPluginServer/WavesPluginServerV16.1.bundle", r"/Library/Application Support/Waves/WavesPluginServer", skip_progress_count=6, prog_num=4788) as should_copy_source_188_4788:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WavesPluginServer/WavesPluginServerV16.1.bundle", prog_num=4789):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle", user_id=-1, group_id=-1, prog_num=4793, recursive=True) as chown_192_4793:  # ?
                            chown_192_4793()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/com.waves.wps.V16.1.agent.plist", r"/Library/LaunchAgents/com.waves.wps.V16.1.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250712163401-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/com.waves.wps.V16.1.agent.plist", r"/Library/LaunchAgents/com.waves.wps.V16.1.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=4794) as if_193_4794:  # 0m:0.002s
                            if_193_4794()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=4795) as cd_stage_194_4795:  # 0m:0.923s
            cd_stage_194_4795()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=4796):  # 0m:0.922s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=4797) as should_copy_source_195_4797:  # 0m:0.922s
                    should_copy_source_195_4797()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=4798):  # 0m:0.922s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=4799) as copy_dir_to_dir_196_4799:  # 0m:0.037s
                            copy_dir_to_dir_196_4799()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=4800) as unwtar_197_4800:  # 0m:0.827s
                            unwtar_197_4800()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=4801, recursive=True) as chown_198_4801:  # 0m:0.000s
                            chown_198_4801()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=4802) as break_hard_link_199_4802:  # 0m:0.010s
                            break_hard_link_199_4802()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=4803) as shell_command_200_4803:  # 0m:0.043s
                            shell_command_200_4803()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=4804, recursive=True) as chown_201_4804:  # 0m:0.000s
                            chown_201_4804()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=4805, recursive=True) as chmod_202_4805:  # 0m:0.004s
                            chmod_202_4805()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=4806) as cd_stage_203_4806:  # 0m:0.001s
            cd_stage_203_4806()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=4807):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=4808) as should_copy_source_204_4808:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=4809):  # ?
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=4812, recursive=True) as chown_207_4812:  # ?
                            chown_207_4812()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=4813) as shell_command_208_4813:  # 0m:0.001s
                            shell_command_208_4813()
        with ShellCommand(r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginServer", message=r"Start WavesPluginServer", detach=True, prog_num=4814) as shell_command_209_4814:  # 0m:0.006s
            shell_command_209_4814()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/COSMOS" -c', ignore_all_errors=True, prog_num=4815) as shell_command_210_4815:  # 0m:0.090s
            shell_command_210_4815()
        with ScriptCommand(r'if [ -f "/Applications/Waves/COSMOS"/Icon? ]; then chmod a+rw "/Applications/Waves/COSMOS"/Icon?; fi', prog_num=4816) as script_command_211_4816:  # 0m:0.007s
            script_command_211_4816()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=4817) as rm_file_or_dir_212_4817:  # 0m:0.282s
            rm_file_or_dir_212_4817()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=4818) as shell_command_213_4818:  # 0m:0.110s
            shell_command_213_4818()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=4819) as script_command_214_4819:  # 0m:0.009s
            script_command_214_4819()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=4820) as rm_file_or_dir_215_4820:  # 0m:0.001s
            rm_file_or_dir_215_4820()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=4821) as glober_216_4821:  # 0m:0.004s
            glober_216_4821()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=4822) as glober_217_4822:  # 0m:0.005s
            glober_217_4822()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=4823) as glober_218_4823:  # 0m:0.003s
            glober_218_4823()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=4824) as shell_command_219_4824:  # 0m:0.008s
            shell_command_219_4824()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=4825) as shell_command_220_4825:  # 0m:3.516s
            shell_command_220_4825()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=4826) as shell_command_221_4826:  # 0m:0.436s
            shell_command_221_4826()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=4827) as shell_command_222_4827:  # 0m:0.270s
            shell_command_222_4827()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=4828) as shell_command_223_4828:  # 0m:0.092s
            shell_command_223_4828()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=4829) as script_command_224_4829:  # 0m:0.007s
            script_command_224_4829()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=4830) as if_225_4830:  # 0m:0.000s
            if_225_4830()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=4831) as if_226_4831:  # 0m:0.000s
            if_226_4831()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesPluginServer.log"), prog_num=4832) as if_227_4832:  # 0m:0.000s
            if_227_4832()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesPluginServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=4833) as if_228_4833:  # 0m:0.000s
            if_228_4833()
        with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server", prog_num=4834) as make_dir_229_4834:  # 0m:0.004s
            make_dir_229_4834()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server", mode="a+rwx", ignore_if_not_exist=True, prog_num=4835) as chmod_230_4835:  # 0m:0.002s
            chmod_230_4835()
        with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/V16.1", prog_num=4836) as make_dir_231_4836:  # 0m:0.004s
            make_dir_231_4836()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/V16.1", mode="a+rwx", ignore_if_not_exist=True, prog_num=4837) as chmod_232_4837:  # 0m:0.000s
            chmod_232_4837()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/V16.1/.settings.txt", mode="a+rw", ignore_if_not_exist=True, prog_num=4838) as chmod_233_4838:  # 0m:0.000s
            chmod_233_4838()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/V16.1/settings.txt", mode="a+rw", ignore_if_not_exist=True, prog_num=4839) as chmod_234_4839:  # 0m:0.000s
            chmod_234_4839()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/wps.sqlite", mode="a+rw", ignore_if_not_exist=True, prog_num=4840) as chmod_235_4840:  # 0m:0.000s
            chmod_235_4840()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=4841) as shell_command_236_4841:  # 0m:0.091s
            shell_command_236_4841()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=4842) as script_command_237_4842:  # 0m:0.006s
            script_command_237_4842()
    with Stage(r"post-copy", prog_num=4843):  # 0m:0.024s
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=4844) as make_dir_238_4844:  # 0m:0.004s
            make_dir_238_4844()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=4845) as copy_file_to_file_239_4845:  # 0m:0.006s
            copy_file_to_file_239_4845()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=4846) as chmod_240_4846:  # 0m:0.000s
            chmod_240_4846()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=4847) as chmod_241_4847:  # 0m:0.000s
            chmod_241_4847()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=4848) as copy_file_to_file_242_4848:  # 0m:0.006s
            copy_file_to_file_242_4848()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=4849) as chmod_243_4849:  # 0m:0.000s
            chmod_243_4849()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=4850) as copy_file_to_file_244_4850:  # 0m:0.006s
            copy_file_to_file_244_4850()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=4851) as chmod_245_4851:  # 0m:0.000s
            chmod_245_4851()
        Progress(r"Done copy", prog_num=4852)()  # 0m:0.000s
        Progress(r"Done synccopy", prog_num=4853)()  # 0m:0.000s
    with Stage(r"post", prog_num=4854):  # 0m:0.030s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=4855) as make_dir_246_4855:  # 0m:0.003s
            make_dir_246_4855()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=4856) as copy_file_to_file_247_4856:  # 0m:0.005s
            copy_file_to_file_247_4856()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=4857) as make_dir_248_4857:  # 0m:0.006s
            make_dir_248_4857()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/8/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=4858) as copy_file_to_file_249_4858:  # 0m:0.006s
            copy_file_to_file_249_4858()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=4859) as make_dir_250_4859:  # 0m:0.004s
            make_dir_250_4859()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/8/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=4860) as copy_file_to_file_251_4860:  # 0m:0.006s
...
# downloaded 184899485 bytes in 0m:5.405s, 34208920 bytes per second
# copy time 0m:26.915s
