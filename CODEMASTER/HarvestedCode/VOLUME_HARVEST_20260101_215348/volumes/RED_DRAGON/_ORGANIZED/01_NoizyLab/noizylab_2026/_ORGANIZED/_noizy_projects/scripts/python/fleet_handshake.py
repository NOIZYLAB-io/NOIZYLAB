...
if __name__ == "__main__":
    ...
    launchctl unload ~/Library/LaunchAgents/com.noizy.autosave.plist 2>/dev/null
    launchctl unload ~/Library/LaunchAgents/com.noizy.autorun.plist 2>/dev/null
    launchctl load ~/Library/LaunchAgents/com.noizy.autosave.plist
    launchctl load ~/Library/LaunchAgents/com.noizy.autorun.plist

# In the running Windows VM, do this:
# From the Parallels Desktop menu bar:
# Actions > Install Parallels Tools

# Or, if the CD mounts automatically, run:
# D:\setup.exe
# Follow the installation prompts and reboot when finished../noizywin_restore_start_stopped.sh