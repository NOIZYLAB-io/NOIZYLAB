...
with Stage(r"assign", prog_num=550):  # 0m:0.000s
...
with PythonBatchRuntime(r"synccopy", prog_num=551):  # 0m:21.793s
    with Stage(r"begin", prog_num=552):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=553):  # 0m:0.009s
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250823221532_require_before.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=554) as copy_file_to_file_001_554:  # 0m:0.005s
            copy_file_to_file_001_554()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250823221532_require_after.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=555) as copy_file_to_file_002_555:  # 0m:0.004s
            copy_file_to_file_002_555()
    with Stage(r"sync", prog_num=556):  # 0m:3.266s
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=557) as shell_command_003_557:  # 0m:0.010s
            shell_command_003_557()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=558) as shell_command_004_558:  # 0m:0.013s
            shell_command_004_558()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=559) as shell_command_005_559:  # 0m:1.007s
            shell_command_005_559()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=560) as shell_command_006_560:  # 0m:0.992s
            shell_command_006_560()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=561) as shell_command_007_561:  # 0m:0.007s
            shell_command_007_561()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=562) as shell_command_008_562:  # 0m:1.050s
            shell_command_008_562()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=563) as shell_command_009_563:  # 0m:0.007s
            shell_command_009_563()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=564) as shell_command_010_564:  # 0m:0.005s
            shell_command_010_564()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=565) as shell_command_011_565:  # 0m:0.160s
            shell_command_011_565()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V16", prog_num=566):  # 0m:0.014s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", chowner=True, prog_num=567) as make_dir_012_567:  # 0m:0.006s
                make_dir_012_567()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=568) as cd_013_568:  # 0m:0.007s
                cd_013_568()
                Progress(r"231 files already in cache", own_progress_count=231, prog_num=799)()  # 0m:0.000s
    ...
    with Stage(r"copy", prog_num=803):  # 0m:18.432s
        ...
        with Stage(r"create folders", prog_num=806):  # 0m:0.090s
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=807) as make_dir_016_807:  # 0m:0.004s
                make_dir_016_807()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=808) as make_dir_017_808:  # 0m:0.004s
                make_dir_017_808()
            with MakeDir(r"/Applications/Waves/Data/Presets", chowner=True, prog_num=809) as make_dir_018_809:  # 0m:0.004s
                make_dir_018_809()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16", chowner=True, prog_num=810) as make_dir_019_810:  # 0m:0.004s
                make_dir_019_810()
            with MakeDir(r"/Applications/Waves/Plug-Ins V16/Documents", chowner=True, prog_num=811) as make_dir_020_811:  # 0m:0.003s
                make_dir_020_811()
            with MakeDir(r"/Applications/Waves/WaveShells V16", chowner=True, prog_num=812) as make_dir_021_812:  # 0m:0.004s
                make_dir_021_812()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=813) as make_dir_022_813:  # 0m:0.005s
                make_dir_022_813()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=814) as make_dir_023_814:  # 0m:0.004s
                make_dir_023_814()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V15", chowner=True, prog_num=815) as make_dir_024_815:  # 0m:0.005s
                make_dir_024_815()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V16", chowner=True, prog_num=816) as make_dir_025_816:  # 0m:0.004s
                make_dir_025_816()
            with MakeDir(r"/Library/Application Support/Waves/License Notifications/V16", chowner=True, prog_num=817) as make_dir_026_817:  # 0m:0.004s
                make_dir_026_817()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=818) as make_dir_027_818:  # 0m:0.004s
                make_dir_027_818()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V15", chowner=True, prog_num=819) as make_dir_028_819:  # 0m:0.004s
                make_dir_028_819()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser/V16", chowner=True, prog_num=820) as make_dir_029_820:  # 0m:0.005s
                make_dir_029_820()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=821) as make_dir_030_821:  # 0m:0.004s
                make_dir_030_821()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=822) as make_dir_031_822:  # 0m:0.004s
                make_dir_031_822()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=823) as make_dir_032_823:  # 0m:0.005s
                make_dir_032_823()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=824) as make_dir_033_824:  # 0m:0.005s
                make_dir_033_824()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=825) as make_dir_034_825:  # 0m:0.004s
                make_dir_034_825()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=826) as make_dir_035_826:  # 0m:0.005s
                make_dir_035_826()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=827) as make_dir_036_827:  # 0m:0.004s
                make_dir_036_827()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=828) as rm_file_or_dir_037_828:  # 0m:0.000s
            rm_file_or_dir_037_828()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=829) as shell_command_038_829:  # 0m:0.008s
            shell_command_038_829()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=830) as shell_command_039_830:  # 0m:0.013s
            shell_command_039_830()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV16.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V16.1", ignore_all_errors=True, prog_num=831) as shell_command_040_831:  # 0m:1.090s
            shell_command_040_831()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V15.2", ignore_all_errors=True, prog_num=832) as shell_command_041_832:  # 0m:1.151s
            shell_command_041_832()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV15.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=833) as shell_command_042_833:  # 0m:0.011s
            shell_command_042_833()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=834) as shell_command_043_834:  # 0m:1.096s
            shell_command_043_834()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=835) as shell_command_044_835:  # 0m:0.007s
            shell_command_044_835()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=836) as shell_command_045_836:  # 0m:0.007s
            shell_command_045_836()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=837) as shell_command_046_837:  # 0m:0.167s
            shell_command_046_837()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16", prog_num=838) as cd_stage_047_838:  # 0m:0.012s
            cd_stage_047_838()
            with SetExecPermissionsInSyncFolder(prog_num=839) as set_exec_permissions_in_sync_folder_048_839:  # 0m:0.011s
                set_exec_permissions_in_sync_folder_048_839()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/Presets", prog_num=840) as cd_stage_049_840:  # 0m:0.003s
            cd_stage_049_840()
            with Stage(r"copy", r"Silk_Vocal__Presets v1.0.0.4", prog_num=841):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Data/Presets/Silk Vocal", r"/Applications/Waves/Data/Presets", skip_progress_count=3, prog_num=842) as should_copy_source_050_842:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/Presets/Silk Vocal", prog_num=843):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/Data/Presets/Silk Vocal", user_id=-1, group_id=-1, prog_num=845, recursive=True) as chown_052_845:  # 0m:0.002s
                            chown_052_845()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16", prog_num=846) as cd_stage_053_846:  # 0m:4.125s
            cd_stage_053_846()
            with Stage(r"copy", r"Silk Vocal v16.0.23.24", prog_num=847):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Silk Vocal.bundle", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=848) as should_copy_source_054_848:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/Silk Vocal.bundle", prog_num=849):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/Silk Vocal.bundle", where_to_unwtar=r".", prog_num=851) as unwtar_056_851:  # ?
                            unwtar_056_851()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/Silk Vocal.bundle", user_id=-1, group_id=-1, prog_num=852, recursive=True) as chown_057_852:  # 0m:0.001s
                            chown_057_852()
            with Stage(r"copy", r"WavesLib1_16_0_23_24 v16.0.23.24", prog_num=853):  # 0m:0.006s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", r"/Applications/Waves/Plug-Ins V16", skip_progress_count=4, prog_num=854) as should_copy_source_058_854:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_16.0.23.framework", prog_num=855):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Plugins/WavesLib1_16.0.23.framework", where_to_unwtar=r".", prog_num=857) as unwtar_060_857:  # ?
                            unwtar_060_857()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V16/WavesLib1_16.0.23.framework", user_id=-1, group_id=-1, prog_num=858, recursive=True) as chown_061_858:  # 0m:0.006s
                            chown_061_858()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V16", own_progress_count=2, prog_num=860) as resolve_symlink_files_in_folder_062_860:  # 0m:3.604s
                resolve_symlink_files_in_folder_062_860()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V16" -c', ignore_all_errors=True, prog_num=861) as shell_command_063_861:  # 0m:0.109s
                shell_command_063_861()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V16"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V16"/Icon?; fi', prog_num=862) as script_command_064_862:  # 0m:0.010s
                script_command_064_862()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=863) as shell_command_065_863:  # 0m:0.027s
                shell_command_065_863()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=864) as create_symlink_066_864:  # 0m:0.001s
                create_symlink_066_864()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V16", r"/Applications/Waves/Plug-Ins V16", prog_num=865) as create_symlink_067_865:  # 0m:0.000s
                create_symlink_067_865()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=866) as copy_glob_to_dir_068_866:  # 0m:0.366s
                copy_glob_to_dir_068_866()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V16/Documents", prog_num=867) as cd_stage_069_867:  # 0m:0.001s
            cd_stage_069_867()
            with Stage(r"copy", r"Plugins Documents Folder", prog_num=868):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Common/Plugins/Documents/Waves System Guide.pdf", r"/Applications/Waves/Plug-Ins V16/Documents", skip_progress_count=3, prog_num=869) as should_copy_source_070_869:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Plugins/Documents/Waves System Guide.pdf", prog_num=870):  # ?
                        ...
                        with ChmodAndChown(path=r"Waves System Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=872) as chmod_and_chown_072_872:  # 0m:0.000s
                            chmod_and_chown_072_872()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V16", prog_num=873) as cd_stage_073_873:  # 0m:0.019s
            cd_stage_073_873()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=874):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=875) as should_copy_source_074_875:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=876):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=879, recursive=True) as chown_077_879:  # ?
                            chown_077_879()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=880) as shell_command_078_880:  # 0m:0.002s
                            shell_command_078_880()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=881):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Applications/Waves/WaveShells V16", skip_progress_count=8, prog_num=882) as should_copy_source_079_882:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=883):  # ?
                        ...
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=889, recursive=True) as chown_085_889:  # ?
                            chown_085_889()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=890, recursive=True) as chmod_086_890:  # 0m:0.001s
                            chmod_086_890()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=891):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Applications/Waves/WaveShells V16", skip_progress_count=5, prog_num=892) as should_copy_source_087_892:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=893):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V16/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=896, recursive=True) as chown_090_896:  # ?
                            chown_090_896()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=897) as shell_command_091_897:  # 0m:0.001s
                            shell_command_091_897()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=898):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Applications/Waves/WaveShells V16", skip_progress_count=7, prog_num=899) as should_copy_source_092_899:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=900):  # ?
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=906) as shell_command_098_906:  # 0m:0.001s
                            shell_command_098_906()
            with Stage(r"copy", r"WaveShell-AU registration utility v16.0.23.24", prog_num=907):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", r"/Applications/Waves/WaveShells V16", skip_progress_count=4, prog_num=908) as should_copy_source_099_908:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 16.app", prog_num=909):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/Waves AU Reg Utility 16.app", where_to_unwtar=r".", prog_num=911) as unwtar_101_911:  # ?
                            unwtar_101_911()
                        with Chown(path=r"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app", user_id=-1, group_id=-1, prog_num=912, recursive=True) as chown_102_912:  # 0m:0.001s
                            chown_102_912()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 16.app"', ignore_all_errors=True, prog_num=913) as shell_command_103_913:  # 0m:0.011s
                shell_command_103_913()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=914) as cd_stage_104_914:  # 0m:0.002s
            cd_stage_104_914()
            with Stage(r"copy", r"WaveShell1-AAX 16.0 v16.0.23.24", prog_num=915):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=916) as should_copy_source_105_916:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 16.0.aaxplugin", prog_num=917):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 16.0.aaxplugin", user_id=-1, group_id=-1, prog_num=920, recursive=True) as chown_108_920:  # ?
                            chown_108_920()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 16.0.aaxplugin"', ignore_all_errors=True, prog_num=921) as shell_command_109_921:  # 0m:0.001s
                            shell_command_109_921()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V15", prog_num=922) as cd_stage_110_922:  # 0m:0.001s
            cd_stage_110_922()
            with Stage(r"copy", r"Demo Mode 1.1 v1.1", prog_num=923):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V15/1", r"/Library/Application Support/Waves/Demo Mode/V15", skip_progress_count=3, prog_num=924) as should_copy_source_111_924:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V15/1", prog_num=925):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V15/1", user_id=-1, group_id=-1, prog_num=927, recursive=True) as chown_113_927:  # 0m:0.001s
                            chown_113_927()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V16", prog_num=928) as cd_stage_114_928:  # 0m:0.001s
            cd_stage_114_928()
            with Stage(r"copy", r"Demo Mode V16 1.1 v1.1", prog_num=929):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Demo Mode/V16/1", r"/Library/Application Support/Waves/Demo Mode/V16", skip_progress_count=3, prog_num=930) as should_copy_source_115_930:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V16/1", prog_num=931):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V16/1", user_id=-1, group_id=-1, prog_num=933, recursive=True) as chown_117_933:  # 0m:0.001s
                            chown_117_933()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/License Notifications/V16/1", r"/Library/Application Support/Waves/License Notifications/V16", skip_progress_count=3, prog_num=936) as should_copy_source_119_936:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/License Notifications/V16/1", prog_num=937):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/License Notifications/V16/1", user_id=-1, group_id=-1, prog_num=939, recursive=True) as chown_121_939:  # 0m:0.001s
                            chown_121_939()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=940) as cd_stage_122_940:  # 0m:4.659s
            cd_stage_122_940()
            with RmFileOrDir(r"/Library/Application Support/Waves/Modules/libmkl_waves.dylib", prog_num=941) as rm_file_or_dir_123_941:  # 0m:0.001s
                rm_file_or_dir_123_941()
            with Stage(r"copy", r"InnerProcessDictionary2 v2.4.0.1", prog_num=942):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=943) as should_copy_source_124_943:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=944):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=946) as unwtar_126_946:  # ?
                            unwtar_126_946()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=947, recursive=True) as chown_127_947:  # 0m:0.001s
                            chown_127_947()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=948):  # 0m:0.005s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=949) as should_copy_source_128_949:  # 0m:0.005s
                    should_copy_source_128_949()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=950):  # 0m:0.005s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=951) as unwtar_129_951:  # 0m:0.005s
                            unwtar_129_951()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=952):  # 0m:4.618s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=953) as should_copy_source_130_953:  # 0m:4.618s
                    should_copy_source_130_953()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=954):  # 0m:4.614s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=955) as copy_dir_to_dir_131_955:  # 0m:0.016s
                            copy_dir_to_dir_131_955()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=956) as unwtar_132_956:  # 0m:4.597s
                            unwtar_132_956()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/MklWaves.framework", user_id=-1, group_id=-1, prog_num=957, recursive=True) as chown_133_957:  # 0m:0.000s
                            chown_133_957()
            with Stage(r"copy", r"WavesLicenseEngine v3.0.0.3", prog_num=958):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=959) as should_copy_source_134_959:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=960):  # ?
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=963) as chmod_137_963:  # ?
                            chmod_137_963()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=964, recursive=True) as chown_138_964:  # 0m:0.001s
                            chown_138_964()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves/Modules", own_progress_count=3, prog_num=967) as resolve_symlink_files_in_folder_139_967:  # 0m:0.018s
                resolve_symlink_files_in_folder_139_967()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=968) as shell_command_140_968:  # 0m:0.011s
                shell_command_140_968()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V15", prog_num=969) as cd_stage_141_969:  # 0m:0.001s
            cd_stage_141_969()
            with Stage(r"copy", r"Preset Browser V15 1.2 v1.2", prog_num=970):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V15/1", r"/Library/Application Support/Waves/Preset Browser/V15", skip_progress_count=3, prog_num=971) as should_copy_source_142_971:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V15/1", prog_num=972):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V15/1", user_id=-1, group_id=-1, prog_num=974, recursive=True) as chown_144_974:  # 0m:0.001s
                            chown_144_974()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser/V16", prog_num=975) as cd_stage_145_975:  # 0m:0.001s
            cd_stage_145_975()
            with Stage(r"copy", r"Preset Browser V16 1.1 v1.1", prog_num=976):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Preset Browser/V16/1", r"/Library/Application Support/Waves/Preset Browser/V16", skip_progress_count=3, prog_num=977) as should_copy_source_146_977:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Preset Browser/V16/1", prog_num=978):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V16/1", user_id=-1, group_id=-1, prog_num=980, recursive=True) as chown_148_980:  # 0m:0.000s
                            chown_148_980()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=981) as cd_stage_149_981:  # 0m:0.005s
            cd_stage_149_981()
            with Stage(r"copy", r"Waves Local Server v12.16.44.45", prog_num=982):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=6, prog_num=983) as should_copy_source_150_983:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=984):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle", user_id=-1, group_id=-1, prog_num=988, recursive=True) as chown_154_988:  # ?
                            chown_154_988()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_16-20250823221532-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=989) as if_155_989:  # 0m:0.001s
                            if_155_989()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=990) as cd_stage_156_990:  # 0m:1.606s
            cd_stage_156_990()
            with Stage(r"copy", r"WaveShell1-AU 16.0 v16.0.23.24", prog_num=991):  # 0m:1.605s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=992) as should_copy_source_157_992:  # 0m:1.605s
                    should_copy_source_157_992()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 16.0.component", prog_num=993):  # 0m:1.604s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", r".", delete_extraneous_files=True, prog_num=994) as copy_dir_to_dir_158_994:  # 0m:0.172s
                            copy_dir_to_dir_158_994()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-AU 16.0.component", where_to_unwtar=r".", prog_num=995) as unwtar_159_995:  # 0m:1.002s
                            unwtar_159_995()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=996, recursive=True) as chown_160_996:  # 0m:0.000s
                            chown_160_996()
                        with BreakHardLink(r"WaveShell1-AU 16.0.component/Contents/Info.plist", prog_num=997) as break_hard_link_161_997:  # 0m:0.022s
                            break_hard_link_161_997()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 16.0.component"', ignore_all_errors=True, prog_num=998) as shell_command_162_998:  # 0m:0.399s
                            shell_command_162_998()
                        with Chown(path=r"WaveShell1-AU 16.0.component", user_id=-1, group_id=-1, prog_num=999, recursive=True) as chown_163_999:  # 0m:0.000s
                            chown_163_999()
                        with Chmod(path=r"WaveShell1-AU 16.0.component", mode="a+rwX", prog_num=1000, recursive=True) as chmod_164_1000:  # 0m:0.008s
                            chmod_164_1000()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=1001) as cd_stage_165_1001:  # 0m:0.004s
            cd_stage_165_1001()
            with Stage(r"copy", r"WaveShell1-VST3 16.0 v16.0.23.24", prog_num=1002):  # 0m:0.004s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Shells/WaveShell1-VST3 16.0.vst3", r"/Library/Audio/Plug-Ins/VST3", skip_progress_count=5, prog_num=1003) as should_copy_source_166_1003:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 16.0.vst3", prog_num=1004):  # ?
                        ...
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST3/WaveShell1-VST3 16.0.vst3", user_id=-1, group_id=-1, prog_num=1007, recursive=True) as chown_169_1007:  # ?
                            chown_169_1007()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 16.0.vst3"', ignore_all_errors=True, prog_num=1008) as shell_command_170_1008:  # 0m:0.003s
                            shell_command_170_1008()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1009) as cd_stage_171_1009:  # 0m:0.006s
            cd_stage_171_1009()
            with Stage(r"copy", r"WaveShell1-WPAPI_2 16.0 v16.0.23.24", prog_num=1010):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", r"/Library/Audio/Plug-Ins/WPAPI", skip_progress_count=7, prog_num=1011) as should_copy_source_172_1011:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WPAPI/WaveShell1-WPAPI_2 16.0.bundle", prog_num=1012):  # ?
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=1018) as shell_command_178_1018:  # 0m:0.001s
                            shell_command_178_1018()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1019) as create_symlink_179_1019:  # 0m:0.004s
                create_symlink_179_1019()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins WPAPI", r"/Library/Audio/Plug-Ins/WPAPI", prog_num=1020) as create_symlink_180_1020:  # 0m:0.001s
                create_symlink_180_1020()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=1021) as rm_file_or_dir_181_1021:  # 0m:0.040s
            rm_file_or_dir_181_1021()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=1022) as shell_command_182_1022:  # 0m:0.101s
            shell_command_182_1022()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=1023) as script_command_183_1023:  # 0m:0.009s
            script_command_183_1023()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=1024) as rm_file_or_dir_184_1024:  # 0m:0.001s
            rm_file_or_dir_184_1024()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=1025) as glober_185_1025:  # 0m:0.002s
            glober_185_1025()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=1026) as glober_186_1026:  # 0m:0.001s
            glober_186_1026()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=1027) as glober_187_1027:  # 0m:0.007s
            glober_187_1027()
        with ShellCommand(r'"/Applications/Waves/WaveShells V13/Waves AU Reg Utility 13.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1028) as shell_command_188_1028:  # 0m:0.006s
            shell_command_188_1028()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1029) as shell_command_189_1029:  # 0m:3.106s
            shell_command_189_1029()
        with ShellCommand(r'"/Applications/Waves/WaveShells V15/Waves AU Reg Utility 15.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1030) as shell_command_190_1030:  # 0m:0.265s
            shell_command_190_1030()
        with ShellCommand(r'"/Applications/Waves/WaveShells V16/Waves AU Reg Utility 16.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=1031) as shell_command_191_1031:  # 0m:0.571s
            shell_command_191_1031()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V16" -c', ignore_all_errors=True, prog_num=1032) as shell_command_192_1032:  # 0m:0.115s
            shell_command_192_1032()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V16"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V16"/Icon?; fi', prog_num=1033) as script_command_193_1033:  # 0m:0.009s
            script_command_193_1033()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Touch(r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log"), prog_num=1034) as if_194_1034:  # 0m:0.000s
            if_194_1034()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesLocalServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=1035) as if_195_1035:  # 0m:0.000s
            if_195_1035()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=1036) as shell_command_196_1036:  # 0m:0.100s
            shell_command_196_1036()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=1037) as script_command_197_1037:  # 0m:0.009s
            script_command_197_1037()
    with Stage(r"post-copy", prog_num=1038):  # 0m:0.043s
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1039) as make_dir_198_1039:  # 0m:0.011s
            make_dir_198_1039()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V16/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=1040) as copy_file_to_file_199_1040:  # 0m:0.011s
            copy_file_to_file_199_1040()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/old_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1041) as chmod_200_1041:  # 0m:0.000s
            chmod_200_1041()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1042) as chmod_201_1042:  # 0m:0.000s
            chmod_201_1042()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/require.yaml", r"/Library/Application Support/Waves/Central/V16/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=1043) as copy_file_to_file_202_1043:  # 0m:0.009s
            copy_file_to_file_202_1043()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1044) as chmod_203_1044:  # 0m:0.000s
            chmod_203_1044()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V16/new_require.yaml", r"/Library/Application Support/Waves/Central/V16/require.yaml", hard_links=False, copy_owner=True, prog_num=1045) as copy_file_to_file_204_1045:  # 0m:0.009s
            copy_file_to_file_204_1045()
        with Chmod(path=r"/Library/Application Support/Waves/Central/V16/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=1046) as chmod_205_1046:  # 0m:0.000s
            chmod_205_1046()
        Progress(r"Done copy", prog_num=1047)()  # 0m:0.000s
        Progress(r"Done synccopy", prog_num=1048)()  # 0m:0.000s
    with Stage(r"post", prog_num=1049):  # 0m:0.043s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1050) as make_dir_206_1050:  # 0m:0.005s
            make_dir_206_1050()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V16_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/V16_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=1051) as copy_file_to_file_207_1051:  # 0m:0.008s
            copy_file_to_file_207_1051()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping", chowner=True, prog_num=1052) as make_dir_208_1052:  # 0m:0.007s
            make_dir_208_1052()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/15/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=1053) as copy_file_to_file_209_1053:  # 0m:0.009s
            copy_file_to_file_209_1053()
        with MakeDir(r"/Library/Application Support/Waves/Central/V16", chowner=True, prog_num=1054) as make_dir_210_1054:  # 0m:0.006s
            make_dir_210_1054()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V16/bookkeeping/15/index.yaml", r"/Library/Application Support/Waves/Central/V16/index.yaml", hard_links=False, copy_owner=True, prog_num=1055) as copy_file_to_file_211_1055:  # 0m:0.007s
