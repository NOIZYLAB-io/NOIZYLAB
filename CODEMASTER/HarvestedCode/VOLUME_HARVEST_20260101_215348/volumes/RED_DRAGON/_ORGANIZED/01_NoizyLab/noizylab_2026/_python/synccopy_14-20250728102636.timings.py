...
with PythonBatchRuntime(r"synccopy", prog_num=875):  # 0m:23.468s
    with Stage(r"begin", prog_num=876):  # 0m:0.000s
        ...
        log.setLevel(20)
    with Stage(r"pre", prog_num=877):  # 0m:0.008s
    ...
    with Stage(r"sync", prog_num=880):  # 0m:1.127s
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=881) as shell_command_003_881:  # 0m:0.007s
            shell_command_003_881()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=882) as shell_command_004_882:  # 0m:0.008s
            shell_command_004_882()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=883) as shell_command_005_883:  # 0m:0.954s
            shell_command_005_883()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=884) as shell_command_006_884:  # 0m:0.005s
            shell_command_006_884()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=885) as shell_command_007_885:  # 0m:0.004s
            shell_command_007_885()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=886) as shell_command_008_886:  # 0m:0.140s
            shell_command_008_886()
        with Stage(r"download", r"https://d36wza55md4dee.cloudfront.net/V14", prog_num=887):  # 0m:0.009s
            with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14", chowner=True, prog_num=888) as make_dir_009_888:  # 0m:0.003s
                make_dir_009_888()
            with Cd(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14", prog_num=889) as cd_010_889:  # 0m:0.005s
                cd_010_889()
                Progress(r"2287 files already in cache", own_progress_count=2287, prog_num=3176)()  # 0m:0.000s
                with Stage(r"post_sync", prog_num=3177):  # 0m:0.005s
                    with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/new_have_info_map.txt", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=3178) as copy_file_to_file_011_3178:  # 0m:0.005s
                        copy_file_to_file_011_3178()
            Progress(r"Done sync", prog_num=3179)()  # 0m:0.000s
    with Stage(r"copy", prog_num=3180):  # 0m:22.298s
        ...
        with Stage(r"create folders", prog_num=3183):  # 0m:0.118s
            with MakeDir(r"/Applications/Waves", chowner=True, prog_num=3184) as make_dir_013_3184:  # 0m:0.003s
                make_dir_013_3184()
            with MakeDir(r"/Applications/Waves/Data", chowner=True, prog_num=3185) as make_dir_014_3185:  # 0m:0.003s
                make_dir_014_3185()
            with MakeDir(r"/Applications/Waves/Data/IR1Impulses V2", chowner=True, prog_num=3186) as make_dir_015_3186:  # 0m:0.003s
                make_dir_015_3186()
            with MakeDir(r"/Applications/Waves/Data/linux/lib/mkl", chowner=True, prog_num=3187) as make_dir_016_3187:  # 0m:0.004s
                make_dir_016_3187()
            with MakeDir(r"/Applications/Waves/Plug-Ins V14", chowner=True, prog_num=3188) as make_dir_017_3188:  # 0m:0.003s
                make_dir_017_3188()
            with MakeDir(r"/Applications/Waves/Plug-Ins V14/Documents", chowner=True, prog_num=3189) as make_dir_018_3189:  # 0m:0.004s
                make_dir_018_3189()
            with MakeDir(r"/Applications/Waves/SoundGrid", chowner=True, prog_num=3190) as make_dir_019_3190:  # 0m:0.003s
                make_dir_019_3190()
            with MakeDir(r"/Applications/Waves/SoundGrid Studio", chowner=True, prog_num=3191) as make_dir_020_3191:  # 0m:0.004s
                make_dir_020_3191()
            with MakeDir(r"/Applications/Waves/SoundGrid Studio/Documents", chowner=True, prog_num=3192) as make_dir_021_3192:  # 0m:0.003s
                make_dir_021_3192()
            with MakeDir(r"/Applications/Waves/SoundGrid Studio/Modules", chowner=True, prog_num=3193) as make_dir_022_3193:  # 0m:0.003s
                make_dir_022_3193()
            with MakeDir(r"/Applications/Waves/SoundGrid/Documents", chowner=True, prog_num=3194) as make_dir_023_3194:  # 0m:0.003s
                make_dir_023_3194()
            with MakeDir(r"/Applications/Waves/SoundGrid/Utilities", chowner=True, prog_num=3195) as make_dir_024_3195:  # 0m:0.003s
                make_dir_024_3195()
            with MakeDir(r"/Applications/Waves/WaveShells V14", chowner=True, prog_num=3196) as make_dir_025_3196:  # 0m:0.003s
                make_dir_025_3196()
            with MakeDir(r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=3197) as make_dir_026_3197:  # 0m:0.003s
                make_dir_026_3197()
            with MakeDir(r"/Library/Application Support/Waves", chowner=True, prog_num=3198) as make_dir_027_3198:  # 0m:0.003s
                make_dir_027_3198()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode", chowner=True, prog_num=3199) as make_dir_028_3199:  # 0m:0.003s
                make_dir_028_3199()
            with MakeDir(r"/Library/Application Support/Waves/Demo Mode/V14", chowner=True, prog_num=3200) as make_dir_029_3200:  # 0m:0.003s
                make_dir_029_3200()
            with MakeDir(r"/Library/Application Support/Waves/Modules", chowner=True, prog_num=3201) as make_dir_030_3201:  # 0m:0.003s
                make_dir_030_3201()
            with MakeDir(r"/Library/Application Support/Waves/MyMon", chowner=True, prog_num=3202) as make_dir_031_3202:  # 0m:0.003s
                make_dir_031_3202()
            with MakeDir(r"/Library/Application Support/Waves/Preset Browser", chowner=True, prog_num=3203) as make_dir_032_3203:  # 0m:0.003s
                make_dir_032_3203()
            with MakeDir(r"/Library/Application Support/Waves/RemoteServices", chowner=True, prog_num=3204) as make_dir_033_3204:  # 0m:0.003s
                make_dir_033_3204()
            with MakeDir(r"/Library/Application Support/Waves/Session Converters", chowner=True, prog_num=3205) as make_dir_034_3205:  # 0m:0.003s
                make_dir_034_3205()
            with MakeDir(r"/Library/Application Support/Waves/SoundGrid Firmware/IO", chowner=True, prog_num=3206) as make_dir_035_3206:  # 0m:0.003s
                make_dir_035_3206()
            with MakeDir(r"/Library/Application Support/Waves/SoundGrid Firmware/SGS", chowner=True, prog_num=3207) as make_dir_036_3207:  # 0m:0.003s
                make_dir_036_3207()
            with MakeDir(r"/Library/Application Support/Waves/SoundGrid IO Modules", chowner=True, prog_num=3208) as make_dir_037_3208:  # 0m:0.004s
                make_dir_037_3208()
            with MakeDir(r"/Library/Application Support/Waves/WavesLocalServer", chowner=True, prog_num=3209) as make_dir_038_3209:  # 0m:0.003s
                make_dir_038_3209()
            with MakeDir(r"/Library/Application Support/Waves/WavesPluginServer", chowner=True, prog_num=3210) as make_dir_039_3210:  # 0m:0.003s
                make_dir_039_3210()
            with MakeDir(r"/Library/Audio/Plug-Ins/Components", prog_num=3211) as make_dir_040_3211:  # 0m:0.003s
                make_dir_040_3211()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST", prog_num=3212) as make_dir_041_3212:  # 0m:0.003s
                make_dir_041_3212()
            with MakeDir(r"/Library/Audio/Plug-Ins/VST3", prog_num=3213) as make_dir_042_3213:  # 0m:0.003s
                make_dir_042_3213()
            with MakeDir(r"/Library/Audio/Plug-Ins/WPAPI", chowner=True, prog_num=3214) as make_dir_043_3214:  # 0m:0.004s
                make_dir_043_3214()
            with MakeDir(r"/Users/Shared/Waves", chowner=True, prog_num=3215) as make_dir_044_3215:  # 0m:0.003s
                make_dir_044_3215()
            with MakeDir(r"/Users/Shared/Waves/Plug-In Settings", chowner=True, prog_num=3216) as make_dir_045_3216:  # 0m:0.003s
                make_dir_045_3216()
            with MakeDir(r"/Users/Shared/Waves/SoundGrid Studio/History", chowner=True, prog_num=3217) as make_dir_046_3217:  # 0m:0.003s
                make_dir_046_3217()
            with MakeDir(r"/Users/Shared/Waves/SoundGrid Studio/Sessions", chowner=True, prog_num=3218) as make_dir_047_3218:  # 0m:0.003s
                make_dir_047_3218()
            with MakeDir(r"/Users/Shared/Waves/SoundGrid Studio/Templates", chowner=True, prog_num=3219) as make_dir_048_3219:  # 0m:0.003s
                make_dir_048_3219()
            with MakeDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences", chowner=True, prog_num=3220) as make_dir_049_3220:  # 0m:0.003s
                make_dir_049_3220()
        with RmFileOrDir(r"/Applications/Waves/.IKB", prog_num=3221) as rm_file_or_dir_050_3221:  # 0m:0.000s
            rm_file_or_dir_050_3221()
        with ShellCommand(r'launchctl unload "${HOME}/Library/LaunchAgents/com.WavesAudio.Cosmos.plist"', ignore_all_errors=True, prog_num=3222) as shell_command_051_3222:  # 0m:0.006s
            shell_command_051_3222()
        with ShellCommand(r"killall COSMOS", message=r"Closing COSMOS", ignore_all_errors=True, prog_num=3223) as shell_command_052_3223:  # 0m:0.008s
            shell_command_052_3223()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.2", ignore_all_errors=True, prog_num=3224) as shell_command_053_3224:  # 0m:1.024s
            shell_command_053_3224()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V14.1", ignore_all_errors=True, prog_num=3225) as shell_command_054_3225:  # 0m:0.004s
            shell_command_054_3225()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV13.1.bundle/Contents/MacOS/WavesPluginClient" wps.shutdown', message=r"Stop WavesPluginServer V13.1", ignore_all_errors=True, prog_num=3226) as shell_command_055_3226:  # 0m:0.004s
            shell_command_055_3226()
        with ShellCommand(r'"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/MacOS/WavesLocalClient" wpivot.shutdown', message=r"Stop WavesLocalServer", ignore_all_errors=True, prog_num=3227) as shell_command_056_3227:  # 0m:0.151s
            shell_command_056_3227()
        with ShellCommand(r"""osascript -e 'tell application "SoundGrid Studio" to quit' """, ignore_all_errors=True, prog_num=3228) as shell_command_057_3228:  # 0m:0.135s
            shell_command_057_3228()
        with CdStage(r"SetExecPermissionsInSyncFolder", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14", prog_num=3229) as cd_stage_058_3229:  # 0m:0.008s
            cd_stage_058_3229()
            with SetExecPermissionsInSyncFolder(prog_num=3230) as set_exec_permissions_in_sync_folder_059_3230:  # 0m:0.008s
                set_exec_permissions_in_sync_folder_059_3230()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data", prog_num=3231) as cd_stage_060_3231:  # 0m:4.042s
            cd_stage_060_3231()
            with Stage(r"copy", r"StudioRack Data v1.0.0.5", prog_num=3232):  # 0m:3.939s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/StudioRack", r"/Applications/Waves/Data", skip_progress_count=4, prog_num=3233) as should_copy_source_061_3233:  # 0m:3.939s
                    should_copy_source_061_3233()
                    with Stage(r"copy source", r"Common/Data/StudioRack", prog_num=3234):  # 0m:3.936s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/StudioRack", r".", delete_extraneous_files=True, prog_num=3235) as copy_dir_to_dir_062_3235:  # 0m:0.020s
                            copy_dir_to_dir_062_3235()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/StudioRack", where_to_unwtar=r".", prog_num=3236) as unwtar_063_3236:  # 0m:3.916s
                            unwtar_063_3236()
                        with Chown(path=r"/Applications/Waves/Data/StudioRack", user_id=-1, group_id=-1, prog_num=3237, recursive=True) as chown_064_3237:  # 0m:0.000s
                            chown_064_3237()
            with Stage(r"copy", r"StudioRack Presets Compatibility v1.0.1.0", prog_num=3238):  # 0m:0.102s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/Automation ID Mappings", r"/Applications/Waves/Data", skip_progress_count=3, prog_num=3239) as should_copy_source_065_3239:  # 0m:0.102s
                    should_copy_source_065_3239()
                    with Stage(r"copy source", r"Common/Data/Automation ID Mappings", prog_num=3240):  # 0m:0.102s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/Automation ID Mappings", r".", delete_extraneous_files=True, prog_num=3241) as copy_dir_to_dir_066_3241:  # 0m:0.101s
                            copy_dir_to_dir_066_3241()
                        with Chown(path=r"/Applications/Waves/Data/Automation ID Mappings", user_id=-1, group_id=-1, prog_num=3242, recursive=True) as chown_067_3242:  # 0m:0.000s
                            chown_067_3242()
            with RmGlobs(r'"/Applications/Waves/Data/Automation ID Mappings"', r"B3XX.json", r"C360.json", r"DXMT.json", r"L360.json", r"MV36.json", r"R360.json", r"S360.json", r"UMPT.json", r"UPMX.json", ignore_all_errors=True, prog_num=3243) as rm_globs_068_3243:  # 0m:0.000s
                rm_globs_068_3243()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/IR1Impulses V2", prog_num=3244) as cd_stage_069_3244:  # 0m:0.016s
            cd_stage_069_3244()
            with Stage(r"copy", r"StudioRack Impulses", prog_num=3245):  # 0m:0.016s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/IR1Impulses V2/Stairwells", r"/Applications/Waves/Data/IR1Impulses V2", skip_progress_count=3, prog_num=3246) as should_copy_source_070_3246:  # 0m:0.008s
                    should_copy_source_070_3246()
                    with Stage(r"copy source", r"Common/Data/IR1Impulses V2/Stairwells", prog_num=3247):  # 0m:0.008s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/IR1Impulses V2/Stairwells", r".", delete_extraneous_files=True, prog_num=3248) as copy_dir_to_dir_071_3248:  # 0m:0.007s
                        ...
                        with Chown(path=r"/Applications/Waves/Data/IR1Impulses V2/Stairwells", user_id=-1, group_id=-1, prog_num=3249, recursive=True) as chown_072_3249:  # 0m:0.000s
                            chown_072_3249()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/IR1Impulses V2/Synagogues", r"/Applications/Waves/Data/IR1Impulses V2", skip_progress_count=3, prog_num=3250) as should_copy_source_073_3250:  # 0m:0.008s
                    should_copy_source_073_3250()
                    with Stage(r"copy source", r"Common/Data/IR1Impulses V2/Synagogues", prog_num=3251):  # 0m:0.008s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/IR1Impulses V2/Synagogues", r".", delete_extraneous_files=True, prog_num=3252) as copy_dir_to_dir_074_3252:  # 0m:0.008s
                        ...
                        with Chown(path=r"/Applications/Waves/Data/IR1Impulses V2/Synagogues", user_id=-1, group_id=-1, prog_num=3253, recursive=True) as chown_075_3253:  # 0m:0.000s
                            chown_075_3253()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Data/linux/lib/mkl", prog_num=3254) as cd_stage_076_3254:  # 0m:0.001s
            cd_stage_076_3254()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/linux/lib/mkl/ia32", r"/Applications/Waves/Data/linux/lib/mkl", skip_progress_count=4, prog_num=3256) as should_copy_source_077_3256:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/linux/lib/mkl/ia32", prog_num=3257):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/linux/lib/mkl/ia32", where_to_unwtar=r".", prog_num=3259) as unwtar_079_3259:  # ?
                            unwtar_079_3259()
                        with Chown(path=r"/Applications/Waves/Data/linux/lib/mkl/ia32", user_id=-1, group_id=-1, prog_num=3260, recursive=True) as chown_080_3260:  # 0m:0.001s
                            chown_080_3260()
            with Stage(r"copy", r"MKL_x64_IID v1.0.0.1", prog_num=3261):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/linux/lib/mkl/intel64", r"/Applications/Waves/Data/linux/lib/mkl", skip_progress_count=4, prog_num=3262) as should_copy_source_081_3262:  # ?
                    ...
                    with Stage(r"copy source", r"Common/Data/linux/lib/mkl/intel64", prog_num=3263):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/Data/linux/lib/mkl/intel64", where_to_unwtar=r".", prog_num=3265) as unwtar_083_3265:  # ?
                            unwtar_083_3265()
                        with Chown(path=r"/Applications/Waves/Data/linux/lib/mkl/intel64", user_id=-1, group_id=-1, prog_num=3266, recursive=True) as chown_084_3266:  # 0m:0.001s
                            chown_084_3266()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V14", prog_num=3267) as cd_stage_085_3267:  # 0m:0.132s
            cd_stage_085_3267()
            with Stage(r"copy", r"Insert v14.12.90.381", prog_num=3268):  # 0m:0.002s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Plugins/StudioRack.bundle", r"/Applications/Waves/Plug-Ins V14", skip_progress_count=4, prog_num=3275) as should_copy_source_090_3275:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/StudioRack.bundle", prog_num=3276):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Plugins/StudioRack.bundle", where_to_unwtar=r".", prog_num=3278) as unwtar_092_3278:  # ?
                            unwtar_092_3278()
                        with Chown(path=r"/Applications/Waves/Plug-Ins V14/StudioRack.bundle", user_id=-1, group_id=-1, prog_num=3279, recursive=True) as chown_093_3279:  # 0m:0.000s
                            chown_093_3279()
            with Stage(r"copy", r"WavesLib1_14_12_90_381 v14.12.90.381", prog_num=3280):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Plugins/WavesLib1_14.21.96.framework", r"/Applications/Waves/Plug-Ins V14", skip_progress_count=4, prog_num=3287) as should_copy_source_098_3287:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Plugins/WavesLib1_14.21.96.framework", prog_num=3288):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/Plug-Ins V14/WavesLib1_14.21.96.framework", user_id=-1, group_id=-1, prog_num=3291, recursive=True) as chown_101_3291:  # 0m:0.000s
                            chown_101_3291()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/Plug-Ins V14", own_progress_count=4, prog_num=3295) as resolve_symlink_files_in_folder_102_3295:  # 0m:0.012s
                resolve_symlink_files_in_folder_102_3295()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Plug-Ins V14" -c', ignore_all_errors=True, prog_num=3296) as shell_command_103_3296:  # 0m:0.094s
                shell_command_103_3296()
            with ScriptCommand(r'if [ -f "/Applications/Waves/Plug-Ins V14"/Icon? ]; then chmod a+rw "/Applications/Waves/Plug-Ins V14"/Icon?; fi', prog_num=3297) as script_command_104_3297:  # 0m:0.006s
                script_command_104_3297()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3298) as shell_command_105_3298:  # 0m:0.008s
                shell_command_105_3298()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves Plugins V14", r"/Applications/Waves/Plug-Ins V14", prog_num=3299) as create_symlink_106_3299:  # 0m:0.002s
                create_symlink_106_3299()
            with CreateSymlink(r"/Users/Shared/Waves/Waves Plugins V14", r"/Applications/Waves/Plug-Ins V14", prog_num=3300) as create_symlink_107_3300:  # 0m:0.001s
                create_symlink_107_3300()
            with CopyGlobToDir(r"*/*/*/*.pdf", r".", r"./Documents", prog_num=3301) as copy_glob_to_dir_108_3301:  # 0m:0.006s
                copy_glob_to_dir_108_3301()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/Plug-Ins V14/Documents", prog_num=3302) as cd_stage_109_3302:  # 0m:0.001s
            cd_stage_109_3302()
        ...
        with CdStage(r"copy_to_folder", r"/Applications/Waves/SoundGrid Studio", prog_num=3308) as cd_stage_113_3308:  # 0m:0.121s
            cd_stage_113_3308()
            with Stage(r"copy", r"SoundGrid Studio V11", prog_num=3309):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/SoundGrid Studio.app", r"/Applications/Waves/SoundGrid Studio", skip_progress_count=4, prog_num=3310) as should_copy_source_114_3310:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/SoundGrid Studio.app", prog_num=3311):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/SoundGrid Studio.app", where_to_unwtar=r".", prog_num=3313) as unwtar_116_3313:  # ?
                            unwtar_116_3313()
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/SoundGrid Studio.app", user_id=-1, group_id=-1, prog_num=3314, recursive=True) as chown_117_3314:  # 0m:0.000s
                            chown_117_3314()
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/SoundGrid Studio", own_progress_count=4, prog_num=3318) as resolve_symlink_files_in_folder_118_3318:  # 0m:0.008s
                resolve_symlink_files_in_folder_118_3318()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension framework --folder . -c', ignore_all_errors=True, prog_num=3319) as shell_command_119_3319:  # 0m:0.008s
                shell_command_119_3319()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves/SoundGrid Studio" -c', ignore_all_errors=True, prog_num=3320) as shell_command_120_3320:  # 0m:0.092s
                shell_command_120_3320()
            with ScriptCommand(r'if [ -f "/Applications/Waves/SoundGrid Studio"/Icon? ]; then chmod a+rw "/Applications/Waves/SoundGrid Studio"/Icon?; fi', prog_num=3321) as script_command_121_3321:  # 0m:0.005s
                script_command_121_3321()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3322) as shell_command_122_3322:  # 0m:0.008s
                shell_command_122_3322()
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Applications/Waves/SoundGrid Studio/Documents", prog_num=3323):  # 0m:0.001s
            with Cd(r"/Applications/Waves/SoundGrid Studio/Documents", prog_num=3324) as cd_123_3324:  # 0m:0.000s
                cd_123_3324()
                Progress(r"remove previous versions /Applications/Waves/SoundGrid Studio/Documents", prog_num=3325)()  # 0m:0.000s
                with RmFile(r"/Applications/Waves/SoundGrid Studio/Documents/eMotionST.pdf", prog_num=3326) as rm_file_124_3326:  # 0m:0.000s
                    rm_file_124_3326()
                with RmFile(r"/Applications/Waves/SoundGrid Studio/Documents/StudioRack.pdf", prog_num=3327) as rm_file_125_3327:  # 0m:0.000s
                    rm_file_125_3327()
                with RmFile(r"/Applications/Waves/SoundGrid Studio/Documents/SGST_QUICKSTART.mp4", prog_num=3328) as rm_file_126_3328:  # 0m:0.000s
                    rm_file_126_3328()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/SoundGrid Studio/Documents", prog_num=3329) as cd_stage_127_3329:  # 0m:0.186s
            cd_stage_127_3329()
            with Stage(r"copy", r"SoundGrid Studio Documents", prog_num=3330):  # 0m:0.186s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Studio/Documents/DiGiGrid S User Guide.pdf", r"/Applications/Waves/SoundGrid Studio/Documents", skip_progress_count=3, prog_num=3331) as should_copy_source_128_3331:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Studio/Documents/DiGiGrid S User Guide.pdf", prog_num=3332):  # ?
                        ...
                        with ChmodAndChown(path=r"DiGiGrid S User Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=3334) as chmod_and_chown_130_3334:  # 0m:0.002s
                            chmod_and_chown_130_3334()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Studio/Documents/SGS_QUICKSTART.mp4", r"/Applications/Waves/SoundGrid Studio/Documents", skip_progress_count=2, prog_num=3335) as should_copy_source_131_3335:  # 0m:0.170s
                    should_copy_source_131_3335()
                    with Stage(r"copy source", r"Common/SoundGrid/Studio/Documents/SGS_QUICKSTART.mp4", prog_num=3336):  # 0m:0.170s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Studio/Documents/SGS_QUICKSTART.mp4.wtar.aa", where_to_unwtar=r".", prog_num=3337) as unwtar_132_3337:  # 0m:0.170s
                            unwtar_132_3337()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Studio/Documents/SGStudio.pdf", r"/Applications/Waves/SoundGrid Studio/Documents", skip_progress_count=2, prog_num=3338) as should_copy_source_133_3338:  # 0m:0.014s
                    should_copy_source_133_3338()
                    with Stage(r"copy source", r"Common/SoundGrid/Studio/Documents/SGStudio.pdf", prog_num=3339):  # 0m:0.013s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Studio/Documents/SGStudio.pdf.wtar.aa", where_to_unwtar=r".", prog_num=3340) as unwtar_134_3340:  # 0m:0.013s
                            unwtar_134_3340()
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Applications/Waves/SoundGrid Studio/Modules", prog_num=3341):  # 0m:0.002s
            with Cd(r"/Applications/Waves/SoundGrid Studio/Modules", prog_num=3342) as cd_135_3342:  # 0m:0.002s
                ...
                with RmDir(r"/Applications/Waves/SoundGrid Studio/Modules/OverviewSGSTLib_13.3.framework", prog_num=3362) as rm_dir_154_3362:  # 0m:0.000s
                    rm_dir_154_3362()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/SoundGrid Studio/Modules", prog_num=3363) as cd_stage_155_3363:  # 0m:0.058s
            cd_stage_155_3363()
            with Stage(r"copy", r"SoundGrid Studio Modules", prog_num=3364):  # 0m:0.037s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/ControlRoom.bundle", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=4, prog_num=3365) as should_copy_source_156_3365:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/ControlRoom.bundle", prog_num=3366):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/ControlRoom.bundle", where_to_unwtar=r".", prog_num=3368) as unwtar_158_3368:  # ?
                            unwtar_158_3368()
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/Modules/ControlRoom.bundle", user_id=-1, group_id=-1, prog_num=3369, recursive=True) as chown_159_3369:  # 0m:0.001s
                            chown_159_3369()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/EMO-TrackSGST.bundle", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=4, prog_num=3375) as should_copy_source_164_3375:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/EMO-TrackSGST.bundle", prog_num=3376):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/EMO-TrackSGST.bundle", where_to_unwtar=r".", prog_num=3378) as unwtar_166_3378:  # ?
                            unwtar_166_3378()
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/Modules/EMO-TrackSGST.bundle", user_id=-1, group_id=-1, prog_num=3379, recursive=True) as chown_167_3379:  # 0m:0.002s
                            chown_167_3379()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/EMO-TrackSGSTLib_14.9.framework", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=4, prog_num=3380) as should_copy_source_168_3380:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/EMO-TrackSGSTLib_14.9.framework", prog_num=3381):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/Modules/EMO-TrackSGSTLib_14.9.framework", user_id=-1, group_id=-1, prog_num=3384, recursive=True) as chown_171_3384:  # 0m:0.000s
                            chown_171_3384()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/MIDICommunication.framework", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=4, prog_num=3385) as should_copy_source_172_3385:  # 0m:0.029s
                    should_copy_source_172_3385()
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/MIDICommunication.framework", prog_num=3386):  # 0m:0.029s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/MIDICommunication.framework", r".", delete_extraneous_files=True, prog_num=3387) as copy_dir_to_dir_173_3387:  # 0m:0.012s
                            copy_dir_to_dir_173_3387()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/MIDICommunication.framework", where_to_unwtar=r".", prog_num=3388) as unwtar_174_3388:  # 0m:0.016s
                            unwtar_174_3388()
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/Modules/MIDICommunication.framework", user_id=-1, group_id=-1, prog_num=3389, recursive=True) as chown_175_3389:  # 0m:0.001s
                            chown_175_3389()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/Mackie_Control.bundle", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=4, prog_num=3390) as should_copy_source_176_3390:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/Mackie_Control.bundle", prog_num=3391):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/Mackie_Control.bundle", where_to_unwtar=r".", prog_num=3393) as unwtar_178_3393:  # ?
                            unwtar_178_3393()
                        with Chown(path=r"/Applications/Waves/SoundGrid Studio/Modules/Mackie_Control.bundle", user_id=-1, group_id=-1, prog_num=3394, recursive=True) as chown_179_3394:  # 0m:0.001s
                            chown_179_3394()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/com.WavesAudio.SoundGridStudioSilent.plist", r"/Applications/Waves/SoundGrid Studio/Modules", skip_progress_count=3, prog_num=3425) as should_copy_source_204_3425:  # 0m:0.001s
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/SoundGrid Studio/Modules/com.WavesAudio.SoundGridStudioSilent.plist", prog_num=3426):  # 0m:0.001s
                        with CopyFileToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/SoundGrid Studio/Modules/com.WavesAudio.SoundGridStudioSilent.plist", r".", prog_num=3427) as copy_file_to_dir_205_3427:  # 0m:0.000s
            ...
            with ResolveSymlinkFilesInFolder(r"/Applications/Waves/SoundGrid Studio/Modules", own_progress_count=8, prog_num=3436) as resolve_symlink_files_in_folder_207_3436:  # 0m:0.004s
                resolve_symlink_files_in_folder_207_3436()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3437) as shell_command_208_3437:  # 0m:0.009s
                shell_command_208_3437()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension framework --folder . -c', ignore_all_errors=True, prog_num=3438) as shell_command_209_3438:  # 0m:0.008s
                shell_command_209_3438()
            with CreateSymlink(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/Waves SG Studio Modules", r"/Applications/Waves/SoundGrid Studio/Modules", prog_num=3439) as create_symlink_210_3439:  # 0m:0.001s
                create_symlink_210_3439()
            with CreateSymlink(r"/Users/Shared/Waves/Waves SG Studio Modules", r"/Applications/Waves/SoundGrid Studio/Modules", prog_num=3440) as create_symlink_211_3440:  # 0m:0.000s
                create_symlink_211_3440()
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Applications/Waves/SoundGrid/Documents", prog_num=3441):  # 0m:0.000s
            with Cd(r"/Applications/Waves/SoundGrid/Documents", prog_num=3442) as cd_212_3442:  # 0m:0.000s
                ...
                with RmFile(r"/Common/SoundGrid/Documents/Digico SD Waves Card User Guide.pdf", prog_num=3445) as rm_file_214_3445:  # 0m:0.000s
                    rm_file_214_3445()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/SoundGrid/Documents", prog_num=3446) as cd_stage_215_3446:  # 0m:0.023s
            cd_stage_215_3446()
            ...
            with Stage(r"copy", r"DLI DLS pdf", prog_num=3490):  # 0m:0.013s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Documents/DLI DLS User Guide.pdf", r"/Applications/Waves/SoundGrid/Documents", skip_progress_count=2, prog_num=3491) as should_copy_source_243_3491:  # 0m:0.013s
                    should_copy_source_243_3491()
                    with Stage(r"copy source", r"Common/SoundGrid/Documents/DLI DLS User Guide.pdf", prog_num=3492):  # 0m:0.012s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Documents/DLI DLS User Guide.pdf.wtar.aa", where_to_unwtar=r".", prog_num=3493) as unwtar_244_3493:  # 0m:0.012s
                            unwtar_244_3493()
            with Stage(r"copy", r"DMI Waves pdf", prog_num=3494):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Documents/DMI Waves User Guide.pdf", r"/Applications/Waves/SoundGrid/Documents", skip_progress_count=3, prog_num=3495) as should_copy_source_245_3495:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Documents/DMI Waves User Guide.pdf", prog_num=3496):  # ?
                        ...
                        with ChmodAndChown(path=r"DMI Waves User Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=3498) as chmod_and_chown_247_3498:  # 0m:0.000s
            ...
            with Stage(r"copy", r"DSPro SG4000 pdf", prog_num=3504):  # 0m:0.000s
            ...
            with Stage(r"copy", r"JoeCo BBSG24MP pdf", prog_num=3588):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Documents/JoeCo BBSG24MP User Guide.pdf", r"/Applications/Waves/SoundGrid/Documents", skip_progress_count=3, prog_num=3589) as should_copy_source_302_3589:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Documents/JoeCo BBSG24MP User Guide.pdf", prog_num=3590):  # ?
                        ...
                        with ChmodAndChown(path=r"JoeCo BBSG24MP User Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=3592) as chmod_and_chown_304_3592:  # 0m:0.000s
                            chmod_and_chown_304_3592()
            with Stage(r"copy", r"MGB MGO pdf", prog_num=3593):  # 0m:0.000s
            ...
            with Stage(r"copy", r"SoundStudio STG-2412 pdf", prog_num=3607):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Documents/STG-1608 User Guide.pdf", r"/Applications/Waves/SoundGrid/Documents", skip_progress_count=3, prog_num=3608) as should_copy_source_314_3608:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Documents/STG-1608 User Guide.pdf", prog_num=3609):  # ?
                        ...
                        with ChmodAndChown(path=r"STG-1608 User Guide.pdf", mode="a+rw", user_id=-1, group_id=-1, prog_num=3611) as chmod_and_chown_316_3611:  # 0m:0.002s
        ...
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Applications/Waves/SoundGrid/Utilities", prog_num=3635):  # 0m:0.001s
            with Cd(r"/Applications/Waves/SoundGrid/Utilities", prog_num=3636) as cd_333_3636:  # 0m:0.001s
                ...
                with RmFile(r"/Applications/Waves/SoundGrid/Utilities/SoundGridDriverV14.9.pkg", prog_num=3647) as rm_file_343_3647:  # 0m:0.000s
                    rm_file_343_3647()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/SoundGrid/Utilities", prog_num=3648) as cd_stage_344_3648:  # 0m:0.040s
            cd_stage_344_3648()
            with Stage(r"copy", r"JoeCo BBSG24MP utilities", prog_num=3649):  # 0m:0.004s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/JoeCo", r"/Applications/Waves/SoundGrid/Utilities", skip_progress_count=3, prog_num=3650) as should_copy_source_345_3650:  # 0m:0.004s
                    should_copy_source_345_3650()
                    with Stage(r"copy source", r"Common/SoundGrid/JoeCo", prog_num=3651):  # 0m:0.004s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/JoeCo", r".", delete_extraneous_files=True, prog_num=3652) as copy_dir_to_dir_346_3652:  # 0m:0.003s
                        ...
                        with Chown(path=r"/Applications/Waves/SoundGrid/Utilities/JoeCo", user_id=-1, group_id=-1, prog_num=3653, recursive=True) as chown_347_3653:  # 0m:0.000s
                            chown_347_3653()
            with Stage(r"copy", r"SoundGrid Control Panel Uninstaller v14.26.48.665", prog_num=3654):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/Drivers/SoundGrid Driver Uninstaller.app", r"/Applications/Waves/SoundGrid/Utilities", skip_progress_count=4, prog_num=3655) as should_copy_source_348_3655:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/Drivers/SoundGrid Driver Uninstaller.app", prog_num=3656):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/Drivers/SoundGrid Driver Uninstaller.app", where_to_unwtar=r".", prog_num=3658) as unwtar_350_3658:  # ?
                            unwtar_350_3658()
                        with Chown(path=r"/Applications/Waves/SoundGrid/Utilities/SoundGrid Driver Uninstaller.app", user_id=-1, group_id=-1, prog_num=3659, recursive=True) as chown_351_3659:  # 0m:0.001s
                            chown_351_3659()
            with Stage(r"copy", r"SoundGrid V14 ASIO / Core Audio Rec/PB Control Panel v14.26.48.665", prog_num=3660):  # 0m:0.035s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/Drivers/SoundGridDriverV14.12.pkg", r"/Applications/Waves/SoundGrid/Utilities", skip_progress_count=2, prog_num=3661) as should_copy_source_352_3661:  # 0m:0.035s
                    should_copy_source_352_3661()
                    with Stage(r"copy source", r"Mac/SoundGrid/Drivers/SoundGridDriverV14.12.pkg", prog_num=3662):  # 0m:0.035s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/Drivers/SoundGridDriverV14.12.pkg.wtar.aa", where_to_unwtar=r".", prog_num=3663) as unwtar_353_3663:  # 0m:0.035s
                            unwtar_353_3663()
        with CdStage(r"copy_to_folder", r"/Applications/Waves/WaveShells V14", prog_num=3664) as cd_stage_354_3664:  # 0m:0.016s
            cd_stage_354_3664()
            with Stage(r"copy", r"WaveShell OBS v14.21.96.553", prog_num=3665):  # 0m:0.003s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves StudioRack for OBS.vst", r"/Applications/Waves/WaveShells V14", skip_progress_count=5, prog_num=3666) as should_copy_source_355_3666:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves StudioRack for OBS.vst", prog_num=3667):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V14/Waves StudioRack for OBS.vst", user_id=-1, group_id=-1, prog_num=3670, recursive=True) as chown_358_3670:  # ?
                            chown_358_3670()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves StudioRack for OBS.vst"', ignore_all_errors=True, prog_num=3671) as shell_command_359_3671:  # 0m:0.001s
                            shell_command_359_3671()
            with Stage(r"copy", r"WaveShell1-AAX 14.12 v14.12.122.413", prog_num=3672):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AAX 14.12.aaxplugin", r"/Applications/Waves/WaveShells V14", skip_progress_count=5, prog_num=3673) as should_copy_source_360_3673:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 14.12.aaxplugin", prog_num=3674):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V14/WaveShell1-AAX 14.12.aaxplugin", user_id=-1, group_id=-1, prog_num=3677, recursive=True) as chown_363_3677:  # ?
                            chown_363_3677()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 14.12.aaxplugin"', ignore_all_errors=True, prog_num=3678) as shell_command_364_3678:  # 0m:0.001s
            ...
            with Stage(r"copy", r"WaveShell1-AU 14.12 v14.12.90.381", prog_num=3686):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.12.component", r"/Applications/Waves/WaveShells V14", skip_progress_count=8, prog_num=3687) as should_copy_source_370_3687:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 14.12.component", prog_num=3688):  # ?
                        ...
                        with Chown(path=r"WaveShell1-AU 14.12.component", user_id=-1, group_id=-1, prog_num=3694, recursive=True) as chown_376_3694:  # ?
                            chown_376_3694()
                        with Chmod(path=r"WaveShell1-AU 14.12.component", mode="a+rwX", prog_num=3695, recursive=True) as chmod_377_3695:  # 0m:0.000s
                            chmod_377_3695()
            ...
            with Stage(r"copy", r"WaveShell1-VST3 14.12 v14.12.90.381", prog_num=3720):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-VST3 14.12.vst3", r"/Applications/Waves/WaveShells V14", skip_progress_count=5, prog_num=3721) as should_copy_source_396_3721:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-VST3 14.12.vst3", prog_num=3722):  # ?
                        ...
                        with Chown(path=r"/Applications/Waves/WaveShells V14/WaveShell1-VST3 14.12.vst3", user_id=-1, group_id=-1, prog_num=3725, recursive=True) as chown_399_3725:  # ?
                            chown_399_3725()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-VST3 14.12.vst3"', ignore_all_errors=True, prog_num=3726) as shell_command_400_3726:  # 0m:0.001s
                            shell_command_400_3726()
            with Stage(r"copy", r"WaveShell1-VST3 14.21 v14.21.96.553", prog_num=3727):  # 0m:0.001s
            ...
            with Stage(r"copy", r"WaveShell1-WPAPI_2 14.12 v14.12.90.381", prog_num=3734):  # 0m:0.002s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-WPAPI_2 14.12.bundle", r"/Applications/Waves/WaveShells V14", skip_progress_count=7, prog_num=3735) as should_copy_source_406_3735:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-WPAPI_2 14.12.bundle", prog_num=3736):  # ?
                        ...
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3742) as shell_command_412_3742:  # 0m:0.002s
                            shell_command_412_3742()
            with Stage(r"copy", r"WaveShell-AU registration utility v14.12.90.381", prog_num=3743):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves AU Reg Utility 14.app", r"/Applications/Waves/WaveShells V14", skip_progress_count=4, prog_num=3744) as should_copy_source_413_3744:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/Waves AU Reg Utility 14.app", prog_num=3745):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves AU Reg Utility 14.app", where_to_unwtar=r".", prog_num=3747) as unwtar_415_3747:  # ?
                            unwtar_415_3747()
                        with Chown(path=r"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app", user_id=-1, group_id=-1, prog_num=3748, recursive=True) as chown_416_3748:  # 0m:0.000s
                            chown_416_3748()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves AU Reg Utility 14.app"', ignore_all_errors=True, prog_num=3749) as shell_command_417_3749:  # 0m:0.006s
                shell_command_417_3749()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Avid/Audio/Plug-Ins", prog_num=3750) as cd_stage_418_3750:  # 0m:0.001s
            cd_stage_418_3750()
            with Stage(r"copy", r"WaveShell1-AAX 14.12 v14.12.122.413", prog_num=3751):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AAX 14.12.aaxplugin", r"/Library/Application Support/Avid/Audio/Plug-Ins", skip_progress_count=5, prog_num=3752) as should_copy_source_419_3752:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AAX 14.12.aaxplugin", prog_num=3753):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Avid/Audio/Plug-Ins/WaveShell1-AAX 14.12.aaxplugin", user_id=-1, group_id=-1, prog_num=3756, recursive=True) as chown_422_3756:  # ?
                            chown_422_3756()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AAX 14.12.aaxplugin"', ignore_all_errors=True, prog_num=3757) as shell_command_423_3757:  # 0m:0.000s
                            shell_command_423_3757()
            with Stage(r"copy", r"WaveShell1-AAX 14.21 v14.21.96.553", prog_num=3758):  # 0m:0.000s
        ...
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves", prog_num=3765) as cd_stage_429_3765:  # 0m:7.939s
            cd_stage_429_3765()
            with Stage(r"copy", r"Qt libraries 5.12.8", prog_num=3766):  # 0m:3.427s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.12.8", r"/Library/Application Support/Waves", skip_progress_count=4, prog_num=3767) as should_copy_source_430_3767:  # 0m:3.427s
                    should_copy_source_430_3767()
                    with Stage(r"copy source", r"Mac/Apps/WavesQtLibs_5.12.8", prog_num=3768):  # 0m:3.427s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.12.8", r".", delete_extraneous_files=True, prog_num=3769) as copy_dir_to_dir_431_3769:  # 0m:0.321s
                            copy_dir_to_dir_431_3769()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.12.8", where_to_unwtar=r".", prog_num=3770) as unwtar_432_3770:  # 0m:3.106s
                            unwtar_432_3770()
                        with Chown(path=r"/Library/Application Support/Waves/WavesQtLibs_5.12.8", user_id=-1, group_id=-1, prog_num=3771, recursive=True) as chown_433_3771:  # 0m:0.000s
                            chown_433_3771()
            with Stage(r"copy", r"QT_5_5_1_FOR_IO_MODULES", prog_num=3772):  # 0m:2.805s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.5.1", r"/Library/Application Support/Waves", skip_progress_count=4, prog_num=3773) as should_copy_source_434_3773:  # 0m:2.805s
                    should_copy_source_434_3773()
                    with Stage(r"copy source", r"Mac/Apps/WavesQtLibs_5.5.1", prog_num=3774):  # 0m:2.805s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.5.1", r".", delete_extraneous_files=True, prog_num=3775) as copy_dir_to_dir_435_3775:  # 0m:0.071s
                            copy_dir_to_dir_435_3775()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_5.5.1", where_to_unwtar=r".", prog_num=3776) as unwtar_436_3776:  # 0m:2.734s
                            unwtar_436_3776()
                        with Chown(path=r"/Library/Application Support/Waves/WavesQtLibs_5.5.1", user_id=-1, group_id=-1, prog_num=3777, recursive=True) as chown_437_3777:  # 0m:0.000s
                            chown_437_3777()
            with Stage(r"copy", r"Qt libraries 6.2.4", prog_num=3778):  # 0m:1.589s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_6.2.4", r"/Library/Application Support/Waves", skip_progress_count=4, prog_num=3779) as should_copy_source_438_3779:  # 0m:1.589s
                    should_copy_source_438_3779()
                    with Stage(r"copy source", r"Mac/Apps/WavesQtLibs_6.2.4", prog_num=3780):  # 0m:1.589s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_6.2.4", r".", delete_extraneous_files=True, prog_num=3781) as copy_dir_to_dir_439_3781:  # 0m:0.058s
                            copy_dir_to_dir_439_3781()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Apps/WavesQtLibs_6.2.4", where_to_unwtar=r".", prog_num=3782) as unwtar_440_3782:  # 0m:1.530s
                            unwtar_440_3782()
                        with Chown(path=r"/Library/Application Support/Waves/WavesQtLibs_6.2.4", user_id=-1, group_id=-1, prog_num=3783, recursive=True) as chown_441_3783:  # 0m:0.000s
                            chown_441_3783()
            with ResolveSymlinkFilesInFolder(r"/Library/Application Support/Waves", own_progress_count=42, prog_num=3825) as resolve_symlink_files_in_folder_442_3825:  # 0m:0.117s
                resolve_symlink_files_in_folder_442_3825()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode", prog_num=3826) as cd_stage_443_3826:  # 0m:0.007s
            cd_stage_443_3826()
            with Stage(r"copy", r"Demo Mode v1.0", prog_num=3827):  # 0m:0.006s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Demo Mode/V14", r"/Library/Application Support/Waves/Demo Mode", skip_progress_count=3, prog_num=3828) as should_copy_source_444_3828:  # 0m:0.006s
                    should_copy_source_444_3828()
                    with Stage(r"copy source", r"Mac/Demo Mode/V14", prog_num=3829):  # 0m:0.006s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Demo Mode/V14", r".", delete_extraneous_files=True, prog_num=3830) as copy_dir_to_dir_445_3830:  # 0m:0.006s
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V14", user_id=-1, group_id=-1, prog_num=3831, recursive=True) as chown_446_3831:  # 0m:0.000s
                            chown_446_3831()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Demo Mode/V14", prog_num=3832) as cd_stage_447_3832:  # 0m:0.002s
            cd_stage_447_3832()
            with Stage(r"copy", r"Demo Mode 2.2 v2.2", prog_num=3833):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Demo Mode/V14/2", r"/Library/Application Support/Waves/Demo Mode/V14", skip_progress_count=3, prog_num=3834) as should_copy_source_448_3834:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Demo Mode/V14/2", prog_num=3835):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Demo Mode/V14/2", user_id=-1, group_id=-1, prog_num=3837, recursive=True) as chown_450_3837:  # 0m:0.000s
                            chown_450_3837()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Modules", prog_num=3838) as cd_stage_451_3838:  # 0m:3.264s
            cd_stage_451_3838()
            ...
            with Stage(r"copy", r"InnerProcessDictionary2 v2.2.1.3", prog_num=3840):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/InnerProcessDictionary2.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=4, prog_num=3841) as should_copy_source_453_3841:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary2.bundle", prog_num=3842):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/InnerProcessDictionary2.bundle", where_to_unwtar=r".", prog_num=3844) as unwtar_455_3844:  # ?
                            unwtar_455_3844()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/InnerProcessDictionary2.bundle", user_id=-1, group_id=-1, prog_num=3845, recursive=True) as chown_456_3845:  # 0m:0.001s
                            chown_456_3845()
            with Stage(r"copy", r"InnerProcessDictionary v1.4.1", prog_num=3846):  # 0m:0.005s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/InnerProcessDictionary.dylib", r"/Library/Application Support/Waves/Modules", skip_progress_count=2, prog_num=3847) as should_copy_source_457_3847:  # 0m:0.005s
                    should_copy_source_457_3847()
                    with Stage(r"copy source", r"Mac/Modules/InnerProcessDictionary.dylib", prog_num=3848):  # 0m:0.005s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/InnerProcessDictionary.dylib.wtar.aa", where_to_unwtar=r".", prog_num=3849) as unwtar_458_3849:  # 0m:0.005s
                            unwtar_458_3849()
            with Stage(r"copy", r"mkl_waves library v1.0.1.1", prog_num=3850):  # 0m:3.248s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/MklWaves.framework", r"/Library/Application Support/Waves/Modules", skip_progress_count=4, prog_num=3851) as should_copy_source_459_3851:  # 0m:3.248s
                    should_copy_source_459_3851()
                    with Stage(r"copy source", r"Mac/Modules/MklWaves.framework", prog_num=3852):  # 0m:3.248s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/MklWaves.framework", r".", delete_extraneous_files=True, prog_num=3853) as copy_dir_to_dir_460_3853:  # 0m:0.007s
                            copy_dir_to_dir_460_3853()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/MklWaves.framework", where_to_unwtar=r".", prog_num=3854) as unwtar_461_3854:  # 0m:3.240s
                            unwtar_461_3854()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Modules/WavesLicenseEngine.bundle", r"/Library/Application Support/Waves/Modules", dont_downgrade=True, skip_progress_count=5, prog_num=3857) as should_copy_source_463_3857:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Modules/WavesLicenseEngine.bundle", prog_num=3858):  # ?
                        ...
                        with Chmod(path=r"WavesLicenseEngine.bundle/Contents/MacOS/exec/wle", mode="a+rwx", prog_num=3861) as chmod_466_3861:  # ?
                            chmod_466_3861()
                        with Chown(path=r"/Library/Application Support/Waves/Modules/WavesLicenseEngine.bundle", user_id=-1, group_id=-1, prog_num=3862, recursive=True) as chown_467_3862:  # 0m:0.000s
                            chown_467_3862()
            ...
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3866) as shell_command_469_3866:  # 0m:0.008s
                shell_command_469_3866()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/MyMon", prog_num=3867) as cd_stage_470_3867:  # 0m:0.008s
            cd_stage_470_3867()
            with Stage(r"copy", r"MyRemote v14.2.0.112", prog_num=3868):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/MyMon/MyMonService.bundle", r"/Library/Application Support/Waves/MyMon", skip_progress_count=4, prog_num=3869) as should_copy_source_471_3869:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/MyMon/MyMonService.bundle", prog_num=3870):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/MyMon/MyMonService.bundle", where_to_unwtar=r".", prog_num=3872) as unwtar_473_3872:  # ?
                            unwtar_473_3872()
                        with Chown(path=r"/Library/Application Support/Waves/MyMon/MyMonService.bundle", user_id=-1, group_id=-1, prog_num=3873, recursive=True) as chown_474_3873:  # 0m:0.000s
                            chown_474_3873()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3874) as shell_command_475_3874:  # 0m:0.007s
                shell_command_475_3874()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Preset Browser", prog_num=3875) as cd_stage_476_3875:  # 0m:0.008s
            cd_stage_476_3875()
            with Stage(r"copy", r"Preset Browser 2.1 v2.1", prog_num=3876):  # 0m:0.004s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Preset Browser/V14", r"/Library/Application Support/Waves/Preset Browser", skip_progress_count=3, prog_num=3877) as should_copy_source_477_3877:  # 0m:0.004s
                    should_copy_source_477_3877()
                    with Stage(r"copy source", r"Mac/Preset Browser/V14", prog_num=3878):  # 0m:0.004s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Preset Browser/V14", r".", delete_extraneous_files=True, prog_num=3879) as copy_dir_to_dir_478_3879:  # 0m:0.004s
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V14", user_id=-1, group_id=-1, prog_num=3880, recursive=True) as chown_479_3880:  # 0m:0.000s
                            chown_479_3880()
            with Stage(r"copy", r"Preset Browser V14 v1.9", prog_num=3881):  # 0m:0.004s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Preset Browser/V14", r"/Library/Application Support/Waves/Preset Browser", skip_progress_count=3, prog_num=3882) as should_copy_source_480_3882:  # 0m:0.004s
                    should_copy_source_480_3882()
                    with Stage(r"copy source", r"Mac/Preset Browser/V14", prog_num=3883):  # 0m:0.003s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Preset Browser/V14", r".", delete_extraneous_files=True, prog_num=3884) as copy_dir_to_dir_481_3884:  # 0m:0.003s
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Preset Browser/V14", user_id=-1, group_id=-1, prog_num=3885, recursive=True) as chown_482_3885:  # 0m:0.000s
                            chown_482_3885()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/RemoteServices", prog_num=3886) as cd_stage_483_3886:  # 0m:0.008s
            cd_stage_483_3886()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/MyMon/MyMonService.bundle", r"/Library/Application Support/Waves/RemoteServices", skip_progress_count=4, prog_num=3888) as should_copy_source_484_3888:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/MyMon/MyMonService.bundle", prog_num=3889):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/RemoteServices/MyMonService.bundle", user_id=-1, group_id=-1, prog_num=3892, recursive=True) as chown_487_3892:  # 0m:0.000s
                            chown_487_3892()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=3893) as shell_command_488_3893:  # 0m:0.007s
                shell_command_488_3893()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/Session Converters", prog_num=3894) as cd_stage_489_3894:  # 0m:0.002s
            cd_stage_489_3894()
            ...
            with Stage(r"copy", r"Converter", prog_num=3897):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/Session Converters/MixerSessionConverter_3x.bundle", r"/Library/Application Support/Waves/Session Converters", skip_progress_count=4, prog_num=3903) as should_copy_source_496_3903:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/Session Converters/MixerSessionConverter_3x.bundle", prog_num=3904):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/Session Converters/MixerSessionConverter_3x.bundle", where_to_unwtar=r".", prog_num=3906) as unwtar_498_3906:  # ?
                            unwtar_498_3906()
                        with Chown(path=r"/Library/Application Support/Waves/Session Converters/MixerSessionConverter_3x.bundle", user_id=-1, group_id=-1, prog_num=3907, recursive=True) as chown_499_3907:  # 0m:0.000s
                            chown_499_3907()
            with Stage(r"copy", r"MixerSessionConverter", prog_num=3908):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Mixer/Session Converters/MixerSessionConverter.bundle", r"/Library/Application Support/Waves/Session Converters", skip_progress_count=4, prog_num=3909) as should_copy_source_500_3909:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/Mixer/Session Converters/MixerSessionConverter.bundle", prog_num=3910):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/Session Converters/MixerSessionConverter.bundle", user_id=-1, group_id=-1, prog_num=3913, recursive=True) as chown_503_3913:  # 0m:0.000s
                            chown_503_3913()
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", prog_num=3914):  # 0m:0.010s
            with Cd(r"/Library/Application Support/Waves/SoundGrid Firmware/IO", prog_num=3915) as cd_504_3915:  # 0m:0.010s
                cd_504_3915()
                ...
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_12.1_DiGiGrid_IOS_XL.wfi", prog_num=3982) as rm_file_570_3982:  # 0m:0.000s
                    rm_file_570_3982()
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_10.0_DiGiGrid_IOS_XL_micro.wfi", prog_num=3983) as rm_file_571_3983:  # 0m:0.000s
                    rm_file_571_3983()
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_10.3_DiGiGrid_IOS_XL_micro.wfi", prog_num=3984) as rm_file_572_3984:  # 0m:0.000s
                    rm_file_572_3984()
                ...
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_10.3_BurlAudio_Bmb4.wfi", prog_num=4065) as rm_file_653_4065:  # 0m:0.000s
                    rm_file_653_4065()
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_13.4_BurlAudio_Bmb4.wfi", prog_num=4066) as rm_file_654_4066:  # 0m:0.000s
                    rm_file_654_4066()
                ...
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_13.5_Dspro_sg1k_micro.wfi", prog_num=4078) as rm_file_666_4078:  # 0m:0.000s
                    rm_file_666_4078()
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_13.7_Dspro_sg1k_micro.wfi", prog_num=4079) as rm_file_667_4079:  # 0m:0.000s
                    rm_file_667_4079()
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_10.0_Dspro_micro.wfi", prog_num=4080) as rm_file_668_4080:  # 0m:0.000s
                    rm_file_668_4080()
                ...
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/IO/IO_12.1_X_WSG_DN32.wfi", prog_num=4094) as rm_file_682_4094:  # 0m:0.000s
                    rm_file_682_4094()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", prog_num=4095) as cd_stage_683_4095:  # 0m:0.069s
            cd_stage_683_4095()
            ...
            with Stage(r"copy", r"Apogee_Symphony_Firmware_13_4 v13.4.0.205", prog_num=4116):  # 0m:0.011s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_Symphony.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=2, prog_num=4117) as should_copy_source_696_4117:  # 0m:0.011s
                    should_copy_source_696_4117()
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_13.4_Symphony.wfi", prog_num=4118):  # 0m:0.011s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_Symphony.wfi.wtar.aa", where_to_unwtar=r".", prog_num=4119) as unwtar_697_4119:  # 0m:0.011s
                            unwtar_697_4119()
            with Stage(r"copy", r"Apogee_Symphony_micro_Firmware_13_4 v13.4.0.205", prog_num=4120):  # 0m:0.026s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_Symphony_micro.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=2, prog_num=4121) as should_copy_source_698_4121:  # 0m:0.026s
                    should_copy_source_698_4121()
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_13.4_Symphony_micro.wfi", prog_num=4122):  # 0m:0.026s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_Symphony_micro.wfi.wtar.aa", where_to_unwtar=r".", prog_num=4123) as unwtar_699_4123:  # 0m:0.026s
                            unwtar_699_4123()
            with Stage(r"copy", r"SoundGrid BR-1 Firmware v13.7.87.375", prog_num=4124):  # 0m:0.018s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.7_BR1_AVB.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=2, prog_num=4125) as should_copy_source_700_4125:  # 0m:0.018s
                    should_copy_source_700_4125()
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_13.7_BR1_AVB.wfi", prog_num=4126):  # 0m:0.018s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.7_BR1_AVB.wfi.wtar.aa", where_to_unwtar=r".", prog_num=4127) as unwtar_701_4127:  # 0m:0.018s
                            unwtar_701_4127()
            ...
            with Stage(r"copy", r"Burl Audio BMB4 Firmware v13.4.0.205", prog_num=4133):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_BurlAudio_Bmb4.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=3, prog_num=4134) as should_copy_source_705_4134:  # 0m:0.001s
                    should_copy_source_705_4134()
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_13.4_BurlAudio_Bmb4.wfi", prog_num=4135):  # 0m:0.001s
                        with CopyFileToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_BurlAudio_Bmb4.wfi", r".", prog_num=4136) as copy_file_to_dir_706_4136:  # 0m:0.000s
                            copy_file_to_dir_706_4136()
                        with ChmodAndChown(path=r"IO_13.4_BurlAudio_Bmb4.wfi", mode="a+rw", user_id=-1, group_id=-1, prog_num=4137) as chmod_and_chown_707_4137:  # 0m:0.000s
            ...
            with Stage(r"copy", r"DirectOut Exbox Micro SoundGrid I/O Driver Firmware v14.22.9.506", prog_num=4256):  # 0m:0.000s
            ...
            with Stage(r"copy", r"DirectOut Exbox v2 Micro SoundGrid I/O Driver Firmware v14.25.3.564", prog_num=4266):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_14.25_DirectOut_Ex_v2_micro.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=3, prog_num=4267) as should_copy_source_786_4267:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_14.25_DirectOut_Ex_v2_micro.wfi", prog_num=4268):  # ?
                        ...
                        with ChmodAndChown(path=r"IO_14.25_DirectOut_Ex_v2_micro.wfi", mode="a+rw", user_id=-1, group_id=-1, prog_num=4270) as chmod_and_chown_788_4270:  # 0m:0.000s
            ...
            with Stage(r"copy", r"SoundStudio STG-2412 Firmware v13.4.0.205", prog_num=4386):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/IO/IO_13.4_SoundStudio_STG_2412.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/IO", skip_progress_count=3, prog_num=4387) as should_copy_source_858_4387:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/IO/IO_13.4_SoundStudio_STG_2412.wfi", prog_num=4388):  # ?
                        ...
                        with ChmodAndChown(path=r"IO_13.4_SoundStudio_STG_2412.wfi", mode="a+rw", user_id=-1, group_id=-1, prog_num=4390) as chmod_and_chown_860_4390:  # 0m:0.000s
        ...
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Library/Application Support/Waves/SoundGrid Firmware/SGS", prog_num=4426):  # 0m:0.001s
            with Cd(r"/Library/Application Support/Waves/SoundGrid Firmware/SGS", prog_num=4427) as cd_882_4427:  # 0m:0.001s
                ...
                with RmFile(r"/Library/Application Support/Waves/SoundGrid Firmware/SGS/SGS_14.9.wfi", prog_num=4439) as rm_file_893_4439:  # 0m:0.000s
                    rm_file_893_4439()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/SoundGrid Firmware/SGS", prog_num=4440) as cd_stage_894_4440:  # 0m:0.012s
            cd_stage_894_4440()
            with Stage(r"copy", r"SoundGrid Server Firmware v14.26.104.721", prog_num=4441):  # 0m:0.012s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/SGS/SGS_14.26.wfi", r"/Library/Application Support/Waves/SoundGrid Firmware/SGS", skip_progress_count=2, prog_num=4442) as should_copy_source_895_4442:  # 0m:0.012s
                    should_copy_source_895_4442()
                    with Stage(r"copy source", r"Common/SoundGrid/Firmware/SGS/SGS_14.26.wfi", prog_num=4443):  # 0m:0.012s
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Firmware/SGS/SGS_14.26.wfi.wtar.aa", where_to_unwtar=r".", prog_num=4444) as unwtar_896_4444:  # 0m:0.011s
                            unwtar_896_4444()
        with Stage(r"remove_previous_sources_instructions_for_target_folder", r"/Library/Application Support/Waves/SoundGrid IO Modules", prog_num=4445):  # 0m:0.014s
            with Cd(r"/Library/Application Support/Waves/SoundGrid IO Modules", prog_num=4446) as cd_897_4446:  # 0m:0.014s
                cd_897_4446()
                ...
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/Cadac Control 10.0.bundle", prog_num=4477) as rm_dir_927_4477:  # 0m:0.000s
                    rm_dir_927_4477()
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/Cadac Control 12.1.bundle", prog_num=4478) as rm_dir_928_4478:  # 0m:0.000s
                    rm_dir_928_4478()
                ...
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOS Control 9.7.bundle", prog_num=4565) as rm_dir_1015_4565:  # 0m:0.000s
                    rm_dir_1015_4565()
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOS Control 10.0.app", prog_num=4566) as rm_dir_1016_4566:  # 0m:0.000s
                    rm_dir_1016_4566()
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOS Control 10.0.bundle", prog_num=4567) as rm_dir_1017_4567:  # 0m:0.000s
                    rm_dir_1017_4567()
                ...
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundGrid X-WSG Control 10.0.bundle", prog_num=4646) as rm_dir_1096_4646:  # 0m:0.000s
                    rm_dir_1096_4646()
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundGrid X-WSG Control 12.1.app", prog_num=4647) as rm_dir_1097_4647:  # 0m:0.000s
                    rm_dir_1097_4647()
                ...
                with RmDir(r"/Library/Application Support/Waves/SoundGrid IO Modules/Yamaha WSG Control 13.1.bundle", prog_num=4660) as rm_dir_1110_4660:  # 0m:0.000s
                    rm_dir_1110_4660()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/SoundGrid IO Modules", prog_num=4661) as cd_stage_1111_4661:  # 0m:0.029s
            cd_stage_1111_4661()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/Symphony MKII.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4672) as should_copy_source_1120_4672:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/Symphony MKII.bundle", prog_num=4673):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/Symphony MKII.bundle", user_id=-1, group_id=-1, prog_num=4676, recursive=True) as chown_1123_4676:  # 0m:0.000s
                            chown_1123_4676()
            with Stage(r"copy", r"SoundGrid BR-1 Control Panel v14.0.342.343", prog_num=4677):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SoundGrid BR1.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4683) as should_copy_source_1128_4683:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/SoundGrid BR1.bundle", prog_num=4684):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundGrid BR1.bundle", user_id=-1, group_id=-1, prog_num=4687, recursive=True) as chown_1131_4687:  # 0m:0.000s
                            chown_1131_4687()
            with Stage(r"copy", r"Behringer Wing SoundGrid I/O Driver Control Panel v14.0.436.437", prog_num=4688):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SoundGrid Wing Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4694) as should_copy_source_1136_4694:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/SoundGrid Wing Control.bundle", prog_num=4695):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundGrid Wing Control.bundle", user_id=-1, group_id=-1, prog_num=4698, recursive=True) as chown_1139_4698:  # 0m:0.000s
                            chown_1139_4698()
            with Stage(r"copy", r"BMB4 SoundGrid MotherBoard Control Panel v14.0.342.343", prog_num=4699):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/Calrec Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4717) as should_copy_source_1152_4717:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/Calrec Control.bundle", prog_num=4718):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/Calrec Control.bundle", user_id=-1, group_id=-1, prog_num=4721, recursive=True) as chown_1155_4721:  # 0m:0.000s
                            chown_1155_4721()
            with Stage(r"copy", r"Crest Audio Tactus Control Panel v14.0.342.343", prog_num=4722):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/Tactus Stage FOH Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4728) as should_copy_source_1160_4728:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/Tactus Stage FOH Control.bundle", prog_num=4729):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/Tactus Stage FOH Control.bundle", user_id=-1, group_id=-1, prog_num=4732, recursive=True) as chown_1163_4732:  # 0m:0.000s
                            chown_1163_4732()
            with Stage(r"copy", r"DigiGrid DLI/DLS Control Panel v14.0.342.343", prog_num=4733):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.app", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4734) as should_copy_source_1164_4734:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.app", prog_num=4735):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.app", where_to_unwtar=r".", prog_num=4737) as unwtar_1166_4737:  # ?
                            unwtar_1166_4737()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid DLI DLS Control.app", user_id=-1, group_id=-1, prog_num=4738, recursive=True) as chown_1167_4738:  # 0m:0.000s
                            chown_1167_4738()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4739) as should_copy_source_1168_4739:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.bundle", prog_num=4740):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid DLI DLS Control.bundle", where_to_unwtar=r".", prog_num=4742) as unwtar_1170_4742:  # ?
                            unwtar_1170_4742()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid DLI DLS Control.bundle", user_id=-1, group_id=-1, prog_num=4743, recursive=True) as chown_1171_4743:  # 0m:0.000s
                            chown_1171_4743()
            with Stage(r"copy", r"DMI Waves Control Panel v14.0.342.343", prog_num=4744):  # 0m:0.000s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DMI Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4750) as should_copy_source_1176_4750:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DMI Control.bundle", prog_num=4751):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DMI Control.bundle", user_id=-1, group_id=-1, prog_num=4754, recursive=True) as chown_1179_4754:  # 0m:0.000s
                            chown_1179_4754()
            with Stage(r"copy", r"DN32-WSG Control Panel v14.0.342.343", prog_num=4755):  # 0m:0.000s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid M Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4794) as should_copy_source_1208_4794:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid M Control.bundle", prog_num=4795):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid M Control.bundle", user_id=-1, group_id=-1, prog_num=4798, recursive=True) as chown_1211_4798:  # 0m:0.000s
                            chown_1211_4798()
            with Stage(r"copy", r"DigiGrid Q Control Panel v14.0.342.343", prog_num=4799):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid Q Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4805) as should_copy_source_1216_4805:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid Q Control.bundle", prog_num=4806):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid Q Control.bundle", user_id=-1, group_id=-1, prog_num=4809, recursive=True) as chown_1219_4809:  # 0m:0.000s
                            chown_1219_4809()
            with Stage(r"copy", r"Digico SD Control Panel v14.0.7.8", prog_num=4810):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiCo SD Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4816) as should_copy_source_1224_4816:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiCo SD Control.bundle", prog_num=4817):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiCo SD Control.bundle", user_id=-1, group_id=-1, prog_num=4820, recursive=True) as chown_1227_4820:  # 0m:0.000s
                            chown_1227_4820()
            with Stage(r"copy", r"DirectOut Exbox SoundGrid I/O Driver Control Panel v14.0.342.343", prog_num=4821):  # 0m:0.001s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.app", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4822) as should_copy_source_1228_4822:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.app", prog_num=4823):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.app", where_to_unwtar=r".", prog_num=4825) as unwtar_1230_4825:  # ?
                            unwtar_1230_4825()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DirectOut SoundGrid Interface.app", user_id=-1, group_id=-1, prog_num=4826, recursive=True) as chown_1231_4826:  # 0m:0.000s
                            chown_1231_4826()
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4827) as should_copy_source_1232_4827:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.bundle", prog_num=4828):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DirectOut SoundGrid Interface.bundle", where_to_unwtar=r".", prog_num=4830) as unwtar_1234_4830:  # ?
                            unwtar_1234_4830()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DirectOut SoundGrid Interface.bundle", user_id=-1, group_id=-1, prog_num=4831, recursive=True) as chown_1235_4831:  # 0m:0.000s
                            chown_1235_4831()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DirectOut SG.MADI Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4838) as should_copy_source_1240_4838:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DirectOut SG.MADI Control.bundle", prog_num=4839):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DirectOut SG.MADI Control.bundle", user_id=-1, group_id=-1, prog_num=4842, recursive=True) as chown_1243_4842:  # 0m:0.000s
                            chown_1243_4842()
            with Stage(r"copy", r"DirectOut SoundGrid I/O Driver Control Panel v13.1.261.180", prog_num=4843):  # 0m:0.000s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid IOC Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4871) as should_copy_source_1264_4871:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid IOC Control.bundle", prog_num=4872):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOC Control.bundle", user_id=-1, group_id=-1, prog_num=4875, recursive=True) as chown_1267_4875:  # 0m:0.000s
                            chown_1267_4875()
            with Stage(r"copy", r"IONIC16 Control Panel v14.0.134.135", prog_num=4876):  # 0m:0.000s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/IONIC Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4882) as should_copy_source_1272_4882:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/IONIC Control.bundle", prog_num=4883):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/IONIC Control.bundle", user_id=-1, group_id=-1, prog_num=4886, recursive=True) as chown_1275_4886:  # 0m:0.000s
                            chown_1275_4886()
            with Stage(r"copy", r"DigiGrid IOS Control Panel v14.0.342.343", prog_num=4887):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid IOS Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4893) as should_copy_source_1280_4893:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid IOS Control.bundle", prog_num=4894):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid IOS Control.bundle", where_to_unwtar=r".", prog_num=4896) as unwtar_1282_4896:  # ?
                            unwtar_1282_4896()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOS Control.bundle", user_id=-1, group_id=-1, prog_num=4897, recursive=True) as chown_1283_4897:  # 0m:0.000s
                            chown_1283_4897()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid IOS-XL Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4904) as should_copy_source_1288_4904:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid IOS-XL Control.bundle", prog_num=4905):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOS-XL Control.bundle", user_id=-1, group_id=-1, prog_num=4908, recursive=True) as chown_1291_4908:  # 0m:0.000s
                            chown_1291_4908()
            with Stage(r"copy", r"DigiGrid IOX Control Panel v14.0.342.343", prog_num=4909):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/DiGiGrid IOX Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4915) as should_copy_source_1296_4915:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/DiGiGrid IOX Control.bundle", prog_num=4916):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/DiGiGrid IOX Control.bundle", user_id=-1, group_id=-1, prog_num=4919, recursive=True) as chown_1299_4919:  # 0m:0.000s
                            chown_1299_4919()
            with Stage(r"copy", r"JoeCo BBSG24MP Control Panel v14.0.342.343", prog_num=4920):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/JoeCo BBSG24MP Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4926) as should_copy_source_1304_4926:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/JoeCo BBSG24MP Control.bundle", prog_num=4927):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/JoeCo BBSG24MP Control.bundle", user_id=-1, group_id=-1, prog_num=4930, recursive=True) as chown_1307_4930:  # 0m:0.000s
                            chown_1307_4930()
            with Stage(r"copy", r"M-DL-WAVES3 Control Panel v14.0.342.343", prog_num=4931):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/M-DL-WAVES3 Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4937) as should_copy_source_1312_4937:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/M-DL-WAVES3 Control.bundle", prog_num=4938):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/M-DL-WAVES3 Control.bundle", user_id=-1, group_id=-1, prog_num=4941, recursive=True) as chown_1315_4941:  # 0m:0.000s
                            chown_1315_4941()
            with Stage(r"copy", r"M-SQ-WAVES3 Control Panel v14.0.342.343", prog_num=4942):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/RIOMGeneral Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4992) as should_copy_source_1352_4992:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/RIOMGeneral Control.bundle", prog_num=4993):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/RIOMGeneral Control.bundle", user_id=-1, group_id=-1, prog_num=4996, recursive=True) as chown_1355_4996:  # 0m:0.000s
                            chown_1355_4996()
            with Stage(r"copy", r"SG Connect v14.0.342.343", prog_num=4997):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SG Connect Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=4998) as should_copy_source_1356_4998:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/SG Connect Control.bundle", prog_num=4999):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SG Connect Control.bundle", where_to_unwtar=r".", prog_num=5001) as unwtar_1358_5001:  # ?
                            unwtar_1358_5001()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/SG Connect Control.bundle", user_id=-1, group_id=-1, prog_num=5002, recursive=True) as chown_1359_5002:  # 0m:0.000s
                            chown_1359_5002()
            with Stage(r"copy", r"SoundStudio STG Control Panel v14.0.342.343", prog_num=5003):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SoundStudio STG Control.app", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=5004) as should_copy_source_1360_5004:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/SoundStudio STG Control.app", prog_num=5005):  # ?
                        ...
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SoundStudio STG Control.app", where_to_unwtar=r".", prog_num=5007) as unwtar_1362_5007:  # ?
                            unwtar_1362_5007()
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundStudio STG Control.app", user_id=-1, group_id=-1, prog_num=5008, recursive=True) as chown_1363_5008:  # 0m:0.000s
                            chown_1363_5008()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/SoundGrid X-WSG Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=5020) as should_copy_source_1372_5020:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/SoundGrid X-WSG Control.bundle", prog_num=5021):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/SoundGrid X-WSG Control.bundle", user_id=-1, group_id=-1, prog_num=5024, recursive=True) as chown_1375_5024:  # 0m:0.000s
                            chown_1375_5024()
            with Stage(r"copy", r"Yamaha SoundGrid IO Control Panel v14.0.342.343", prog_num=5025):  # 0m:0.001s
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/SoundGrid/IO Modules/Yamaha WSG Control.bundle", r"/Library/Application Support/Waves/SoundGrid IO Modules", skip_progress_count=4, prog_num=5031) as should_copy_source_1380_5031:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/SoundGrid/IO Modules/Yamaha WSG Control.bundle", prog_num=5032):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/SoundGrid IO Modules/Yamaha WSG Control.bundle", user_id=-1, group_id=-1, prog_num=5035, recursive=True) as chown_1383_5035:  # 0m:0.000s
                            chown_1383_5035()
            with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" --extension bundle --folder . -c', ignore_all_errors=True, prog_num=5036) as shell_command_1384_5036:  # 0m:0.010s
                shell_command_1384_5036()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesLocalServer", prog_num=5037) as cd_stage_1385_5037:  # 0m:0.001s
            cd_stage_1385_5037()
                ...
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/WavesLocalServer/WavesLocalServer.bundle", r"/Library/Application Support/Waves/WavesLocalServer", dont_downgrade=True, skip_progress_count=5, prog_num=5039) as should_copy_source_1386_5039:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WavesLocalServer/WavesLocalServer.bundle", prog_num=5040):  # ?
                        ...
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_14-20250728102636-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesLocalServer/WavesLocalServer.bundle/Contents/com.waves.wls.agent.plist", r"/Library/LaunchAgents/com.waves.wls.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=5044) as if_1390_5044:  # 0m:0.001s
                            if_1390_5044()
        with CdStage(r"copy_to_folder", r"/Library/Application Support/Waves/WavesPluginServer", prog_num=5045) as cd_stage_1391_5045:  # 0m:0.000s
            cd_stage_1391_5045()
            with Stage(r"copy", r"WavesPluginServer_V14_2 v13.6.444.720", prog_num=5046):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/WavesPluginServer/WavesPluginServerV14.2.bundle", r"/Library/Application Support/Waves/WavesPluginServer", skip_progress_count=5, prog_num=5047) as should_copy_source_1392_5047:  # ?
                    ...
                    with Stage(r"copy source", r"Mac/WavesPluginServer/WavesPluginServerV14.2.bundle", prog_num=5048):  # ?
                        ...
                        with Chown(path=r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle", user_id=-1, group_id=-1, prog_num=5051, recursive=True) as chown_1395_5051:  # ?
                            chown_1395_5051()
                        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=CopyFileToFile(r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/com.waves.wps.agent.plist", r"/Library/LaunchAgents/com.waves.wps.agent.plist", hard_links=False, ignore_all_errors=True, output_script=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_14-20250728102636-post-script.sh"), if_false=CopyFileToFile(r"/Library/Application Support/Waves/WavesPluginServer/WavesPluginServerV14.2.bundle/Contents/com.waves.wps.agent.plist", r"/Library/LaunchAgents/com.waves.wps.agent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=5052) as if_1396_5052:  # 0m:0.000s
                            if_1396_5052()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/Components", prog_num=5053) as cd_stage_1397_5053:  # 0m:1.274s
            cd_stage_1397_5053()
            with Stage(r"copy", r"WaveShell1-AU 14.12 v14.12.90.381", prog_num=5054):  # 0m:0.654s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.12.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=5055) as should_copy_source_1398_5055:  # 0m:0.654s
                    should_copy_source_1398_5055()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 14.12.component", prog_num=5056):  # 0m:0.654s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.12.component", r".", delete_extraneous_files=True, prog_num=5057) as copy_dir_to_dir_1399_5057:  # 0m:0.010s
                            copy_dir_to_dir_1399_5057()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.12.component", where_to_unwtar=r".", prog_num=5058) as unwtar_1400_5058:  # 0m:0.593s
                            unwtar_1400_5058()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 14.12.component", user_id=-1, group_id=-1, prog_num=5059, recursive=True) as chown_1401_5059:  # 0m:0.000s
                            chown_1401_5059()
                        with BreakHardLink(r"WaveShell1-AU 14.12.component/Contents/Info.plist", prog_num=5060) as break_hard_link_1402_5060:  # 0m:0.007s
                            break_hard_link_1402_5060()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 14.12.component"', ignore_all_errors=True, prog_num=5061) as shell_command_1403_5061:  # 0m:0.040s
                        ...
                        with Chown(path=r"WaveShell1-AU 14.12.component", user_id=-1, group_id=-1, prog_num=5062, recursive=True) as chown_1404_5062:  # 0m:0.000s
                            chown_1404_5062()
                        with Chmod(path=r"WaveShell1-AU 14.12.component", mode="a+rwX", prog_num=5063, recursive=True) as chmod_1405_5063:  # 0m:0.003s
                            chmod_1405_5063()
            with Stage(r"copy", r"WaveShell1-AU 14.21 v14.21.96.553", prog_num=5064):  # 0m:0.620s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.21.component", r"/Library/Audio/Plug-Ins/Components", skip_progress_count=8, prog_num=5065) as should_copy_source_1406_5065:  # 0m:0.620s
                    should_copy_source_1406_5065()
                    with Stage(r"copy source", r"Mac/Shells/WaveShell1-AU 14.21.component", prog_num=5066):  # 0m:0.619s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.21.component", r".", delete_extraneous_files=True, prog_num=5067) as copy_dir_to_dir_1407_5067:  # 0m:0.010s
                            copy_dir_to_dir_1407_5067()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/WaveShell1-AU 14.21.component", where_to_unwtar=r".", prog_num=5068) as unwtar_1408_5068:  # 0m:0.558s
                            unwtar_1408_5068()
                        with Chown(path=r"/Library/Audio/Plug-Ins/Components/WaveShell1-AU 14.21.component", user_id=-1, group_id=-1, prog_num=5069, recursive=True) as chown_1409_5069:  # 0m:0.000s
                            chown_1409_5069()
                        with BreakHardLink(r"WaveShell1-AU 14.21.component/Contents/Info.plist", prog_num=5070) as break_hard_link_1410_5070:  # 0m:0.007s
                            break_hard_link_1410_5070()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "WaveShell1-AU 14.21.component"', ignore_all_errors=True, prog_num=5071) as shell_command_1411_5071:  # 0m:0.039s
                        ...
                        with Chown(path=r"WaveShell1-AU 14.21.component", user_id=-1, group_id=-1, prog_num=5072, recursive=True) as chown_1412_5072:  # 0m:0.000s
                            chown_1412_5072()
                        with Chmod(path=r"WaveShell1-AU 14.21.component", mode="a+rwX", prog_num=5073, recursive=True) as chmod_1413_5073:  # 0m:0.003s
                            chmod_1413_5073()
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST", prog_num=5074) as cd_stage_1414_5074:  # 0m:0.345s
            cd_stage_1414_5074()
            with Stage(r"copy", r"WaveShell OBS v14.21.96.553", prog_num=5075):  # 0m:0.343s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves StudioRack for OBS.vst", r"/Library/Audio/Plug-Ins/VST", skip_progress_count=5, prog_num=5076) as should_copy_source_1415_5076:  # 0m:0.343s
                    should_copy_source_1415_5076()
                    with Stage(r"copy source", r"Mac/Shells/Waves StudioRack for OBS.vst", prog_num=5077):  # 0m:0.343s
                        with CopyDirToDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves StudioRack for OBS.vst", r".", delete_extraneous_files=True, prog_num=5078) as copy_dir_to_dir_1416_5078:  # 0m:0.011s
                            copy_dir_to_dir_1416_5078()
                        with Unwtar(what_to_unwtar=r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Shells/Waves StudioRack for OBS.vst", where_to_unwtar=r".", prog_num=5079) as unwtar_1417_5079:  # 0m:0.325s
                            unwtar_1417_5079()
                        with Chown(path=r"/Library/Audio/Plug-Ins/VST/Waves StudioRack for OBS.vst", user_id=-1, group_id=-1, prog_num=5080, recursive=True) as chown_1418_5080:  # 0m:0.000s
                            chown_1418_5080()
                        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" "Waves StudioRack for OBS.vst"', ignore_all_errors=True, prog_num=5081) as shell_command_1419_5081:  # 0m:0.007s
            ...
            with Stage(r"copy", r"WaveShell1-VST 14.21 v14.21.96.553", prog_num=5089):  # 0m:0.000s
        ...
        with CdStage(r"copy_to_folder", r"/Library/Audio/Plug-Ins/VST3", prog_num=5096) as cd_stage_1430_5096:  # 0m:0.001s
            ...
            with Stage(r"copy", r"WaveShell1-VST3 14.21 v14.21.96.553", prog_num=5104):  # 0m:0.001s
        ...
        with CdStage(r"copy_to_folder", r"/Users/Shared/Waves/SoundGrid Studio/Templates", prog_num=5123) as cd_stage_1451_5123:  # 0m:0.000s
            cd_stage_1451_5123()
            with Stage(r"copy", r"SoundGrid Studio Sessions Structure", prog_num=5124):  # 0m:0.000s
                with ShouldCopySource(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Common/SoundGrid/Empty Sessions/SGStudio2/Empty Session.sgst", r"/Users/Shared/Waves/SoundGrid Studio/Templates", skip_progress_count=3, prog_num=5125) as should_copy_source_1452_5125:  # ?
                    ...
                    with Stage(r"copy source", r"Common/SoundGrid/Empty Sessions/SGStudio2/Empty Session.sgst", prog_num=5126):  # ?
                        ...
                        with ChmodAndChown(path=r"Empty Session.sgst", mode="a+rw", user_id=-1, group_id=-1, prog_num=5128) as chmod_and_chown_1454_5128:  # 0m:0.000s
                            chmod_and_chown_1454_5128()
        with CdStage(r"create_copy_instructions_for_no_copy_folder", r"/Applications/Waves/Data/Presets", prog_num=5129) as cd_stage_1455_5129:  # 0m:0.000s
            cd_stage_1455_5129()
            with RmFileOrDir(r"/Applications/Waves/Data/Presets/StudioRack/Artists/Lamps/Vocal/Vocal 2 (Lead).xps", prog_num=5130) as rm_file_or_dir_1456_5130:  # 0m:0.000s
        ...
        with RmFileOrDir(r"/Users/rsp_ms/Library/Caches/Waves", prog_num=5150) as rm_file_or_dir_1476_5150:  # 0m:0.019s
        ...
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves" -c', ignore_all_errors=True, prog_num=5162) as shell_command_1488_5162:  # 0m:0.084s
            shell_command_1488_5162()
        with ScriptCommand(r'if [ -f "/Applications/Waves"/Icon? ]; then chmod a+rw "/Applications/Waves"/Icon?; fi', prog_num=5163) as script_command_1489_5163:  # 0m:0.006s
            script_command_1489_5163()
        with ShellCommand(r"echo This installation requires that you restart your computer.", message=r"Restart_required_IID post-install step 1", prog_num=5164) as shell_command_1490_5164:  # 0m:0.004s
            shell_command_1490_5164()
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_true=ScriptCommand(r'echo "#!/bin/bash" >> "/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_14-20250728102636-post-script.sh"; echo installer -pkg \"/Applications/Waves/SoundGrid/Utilities/SoundGridDriverV14.12.pkg\" -target / >> "/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_14-20250728102636-post-script.sh"; chmod a+rwx "/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Central/Logs/install/synccopy_14-20250728102636-post-script.sh" '), if_false=ShellCommand(r'sudo installer -pkg "/Applications/Waves/SoundGrid/Utilities/SoundGridDriverV14.12.pkg" -target /', message=r"Installing SoundGrid Driver V14.12", ignore_all_errors=True), prog_num=5165) as if_1491_5165:  # 0m:0.005s
            if_1491_5165()
        with RmFileOrDir(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/SGStudioModulesFolder_ScanView.txt", prog_num=5166) as rm_file_or_dir_1492_5166:  # 0m:0.000s
        ...
        with ShellCommand(r"""osascript -e 'tell application "System Events" to delete login item "SoundGrid Studio"' """, ignore_all_errors=True, prog_num=5168) as shell_command_1494_5168:  # 0m:0.280s
        ...
        with ShellCommand(r'chmod a=r,u+w "/Applications/Waves/SoundGrid Studio/SoundGrid Studio.app/Contents/Resources/com.WavesAudio.SoundGridStudioSilent.plist"', ignore_all_errors=True, prog_num=5173) as shell_command_1499_5173:  # 0m:0.006s
        ...
        with If(IsFile(r"/Users/rsp_ms/Library/Preferences/Waves Preferences/SGStudio.Mixer SoundGrid.preferences"), if_false=CopyFileToFile(r"/Applications/Waves/SoundGrid Studio/SoundGrid Studio.app/Contents/Resources/com.WavesAudio.SoundGridStudioSilent.plist", r"${HOME}/Library/LaunchAgents/com.WavesAudio.SoundGridStudioSilent.plist", ignore_if_not_exist=True, hard_links=False), prog_num=5174) as if_1500_5174:  # 0m:0.000s
            if_1500_5174()
        with ShellCommand(r'chmod a=r,u+w "${HOME}/Library/LaunchAgents/com.WavesAudio.SoundGridStudioSilent.plist"', ignore_all_errors=True, prog_num=5175) as shell_command_1501_5175:  # 0m:0.005s
            shell_command_1501_5175()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves/SoundGrid" -c', ignore_all_errors=True, prog_num=5176) as shell_command_1502_5176:  # 0m:0.098s
            shell_command_1502_5176()
        with ScriptCommand(r'if [ -f "/Applications/Waves/SoundGrid"/Icon? ]; then chmod a+rw "/Applications/Waves/SoundGrid"/Icon?; fi', prog_num=5177) as script_command_1503_5177:  # 0m:0.006s
            script_command_1503_5177()
        with RmFileOrDir(r"/Applications/Waves/Utilities", prog_num=5178) as rm_file_or_dir_1504_5178:  # 0m:0.000s
        ...
        with Touch(r"/Library/Audio/Plug-Ins/VST/Waves StudioRack for OBS.vst/Contents/Info.plist", prog_num=5179) as touch_1505_5179:  # 0m:0.000s
            touch_1505_5179()
        with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*.vst/Contents/Info.plist", Touch, r"path", prog_num=5180) as glober_1506_5180:  # 0m:0.001s
            glober_1506_5180()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3", Touch, r"path", prog_num=5181) as glober_1507_5181:  # 0m:0.004s
            glober_1507_5181()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=5182) as glober_1508_5182:  # 0m:0.001s
            glober_1508_5182()
        with Glober(r"/Library/Audio/Plug-Ins/VST3/WaveShell*.vst3/Contents/MacOS/WaveShell*-VST3", Touch, r"path", prog_num=5183) as glober_1509_5183:  # 0m:0.001s
            glober_1509_5183()
        with Glober(r"/Library/Audio/Plug-Ins/VST/WaveShell*.vst3/Contents/Info.plist", Touch, r"path", prog_num=5184) as glober_1510_5184:  # 0m:0.000s
            glober_1510_5184()
        with ShellCommand(r'"/Applications/Waves/WaveShells V14/Waves AU Reg Utility 14.app/Contents/MacOS/Waves AU Reg Utility" -s --log "${HOME}/Library/Application Support/Waves Audio/Waves Central/Logs/AURegUtility.log"', ignore_all_errors=True, prog_num=5185) as shell_command_1511_5185:  # 0m:2.486s
            shell_command_1511_5185()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves/WaveShells V14" -c', ignore_all_errors=True, prog_num=5186) as shell_command_1512_5186:  # 0m:0.087s
            shell_command_1512_5186()
        with ScriptCommand(r'if [ -f "/Applications/Waves/WaveShells V14"/Icon? ]; then chmod a+rw "/Applications/Waves/WaveShells V14"/Icon?; fi', prog_num=5187) as script_command_1513_5187:  # 0m:0.006s
        ...
        with If(IsConfigVarDefined(r"POST_INSTALL_SCRIPT_FILE"), if_false=Chmod(path=r"/Users/rsp_ms/Library/Logs/Waves Audio/WavesPluginServer.log", mode="a+rw", ignore_if_not_exist=True), prog_num=5191) as if_1517_5191:  # 0m:0.000s
            if_1517_5191()
        with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server", prog_num=5192) as make_dir_1518_5192:  # 0m:0.003s
            make_dir_1518_5192()
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server", mode="a+rwx", ignore_if_not_exist=True, prog_num=5193) as chmod_1519_5193:  # 0m:0.000s
            chmod_1519_5193()
        with MakeDir(r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/V14.2", prog_num=5194) as make_dir_1520_5194:  # 0m:0.003s
            make_dir_1520_5194()
        ...
        with Chmod(path=r"/Users/rsp_ms/Library/Application Support/Waves Audio/Waves Plugin Server/wps.sqlite", mode="a+rw", ignore_if_not_exist=True, prog_num=5198) as chmod_1524_5198:  # 0m:0.000s
            chmod_1524_5198()
        with ShellCommand(r'"/Applications/Waves Central.app/Contents/Resources/res/external/bin/setIcon" -f -i "/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/Mac/Icons/Folder.icns" --folder "/Applications/Waves/Data" -c', ignore_all_errors=True, prog_num=5199) as shell_command_1525_5199:  # 0m:0.082s
            shell_command_1525_5199()
        with ScriptCommand(r'if [ -f "/Applications/Waves/Data"/Icon? ]; then chmod a+rw "/Applications/Waves/Data"/Icon?; fi', prog_num=5200) as script_command_1526_5200:  # 0m:0.006s
            script_command_1526_5200()
    with Stage(r"post-copy", prog_num=5201):  # 0m:0.015s
        with MakeDir(r"/Library/Application Support/Waves/Central/V14", chowner=True, prog_num=5202) as make_dir_1527_5202:  # 0m:0.003s
            make_dir_1527_5202()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/have_info_map.txt", r"/Library/Application Support/Waves/Central/V14/have_info_map.txt", hard_links=False, copy_owner=True, prog_num=5203) as copy_file_to_file_1528_5203:  # 0m:0.005s
        ...
        with Chmod(path=r"/Library/Application Support/Waves/Central/V14/require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=5205) as chmod_1530_5205:  # 0m:0.000s
            chmod_1530_5205()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V14/require.yaml", r"/Library/Application Support/Waves/Central/V14/old_require.yaml", ignore_if_not_exist=True, hard_links=False, copy_owner=True, prog_num=5206) as copy_file_to_file_1531_5206:  # 0m:0.003s
        ...
        with Chmod(path=r"/Library/Application Support/Waves/Central/V14/new_require.yaml", mode="a+rw", ignore_all_errors=True, prog_num=5207) as chmod_1532_5207:  # 0m:0.000s
            chmod_1532_5207()
        with CopyFileToFile(r"/Library/Application Support/Waves/Central/V14/new_require.yaml", r"/Library/Application Support/Waves/Central/V14/require.yaml", hard_links=False, copy_owner=True, prog_num=5208) as copy_file_to_file_1533_5208:  # 0m:0.003s
    ...
    with Stage(r"post", prog_num=5212):  # 0m:0.020s
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping", chowner=True, prog_num=5213) as make_dir_1535_5213:  # 0m:0.003s
            make_dir_1535_5213()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/cache/V14_repo_rev.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/V14_repo_rev.yaml", hard_links=False, copy_owner=True, prog_num=5214) as copy_file_to_file_1536_5214:  # 0m:0.004s
            copy_file_to_file_1536_5214()
        with MakeDir(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping", chowner=True, prog_num=5215) as make_dir_1537_5215:  # 0m:0.003s
            make_dir_1537_5215()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/183/index.yaml", r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/index.yaml", hard_links=False, copy_owner=True, prog_num=5216) as copy_file_to_file_1538_5216:  # 0m:0.004s
            copy_file_to_file_1538_5216()
        with MakeDir(r"/Library/Application Support/Waves/Central/V14", chowner=True, prog_num=5217) as make_dir_1539_5217:  # 0m:0.003s
            make_dir_1539_5217()
        with CopyFileToFile(r"/Users/rsp_ms/Library/Caches/Waves Audio/instl/instl/V14/bookkeeping/183/index.yaml", r"/Library/Application Support/Waves/Central/V14/index.yaml", hard_links=False, copy_owner=True, prog_num=5218) as copy_file_to_file_1540_5218:  # 0m:0.004s
