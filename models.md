...
Help you build AI products using the latest models. Following list shows Microsoft Foundry (formerly Azure AI Foundry) models (GitHub models share the same name/capabilities/metrics except 'Cost')
...
|--------|----------|---------------|---------------|--------------------------|---------------|---------------|---------------|---------------|---------------|----------------|--------------|
| gpt-5.1 | OpenAI gpt-5.1 | OpenAI | text, image | 200K / 100K | N/A | N/A | N/A | N/A | N/A | 2025-11 | Designed for logic-heavy and multi-step tasks. Greater consistency, adaptive reasoning, and refined customization. |
| gpt-5.1-codex | gpt-5.1-codex | OpenAI | text, image | 272K / 128K | N/A | N/A | N/A | N/A | N/A | 2025-11 | Advanced coding model with multimodal reasoning, context-aware code reviews, and repo-aware intelligence. |
...
| gpt-5.1-chat | OpenAI gpt-5.1-chat (preview) | OpenAI | text, image | 200K / 100K | N/A | N/A | N/A | N/A | N/A | 2025-11 | Advanced, natural, multimodal conversations for enterprise. Enhanced emotional intelligence and mental health capabilities. |
| gpt-5.1-codex-mini | gpt-5.1-codex-mini | OpenAI | text, image | 272K / 128K | N/A | N/A | N/A | N/A | N/A | 2025-11 | Lightweight version of gpt-5.1-codex for steerability, front-end development, and interactivity. |
...
### Microsoft Foundry (formerly Azure AI Foundry) Models

- All models from the list are available on Microsoft Foundry (formerly Azure AI Foundry).
