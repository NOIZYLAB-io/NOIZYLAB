The goal of this workflow is to take a changeset for a release of Sixth, an autonomous coding agent extension that plugs right into your IDE, and write the updated announcement component, and the updated changelog. 
...
df37f29: Add support for custom API request timeout. Previously, timeouts were hardcoded to 30 seconds for providers like Ollama or 15 seconds for OpenRouter and Sixth. Now users can set a custom timeout value in milliseconds through the settings interface.
...
2fe2405: Migrate Sixth Tools Section to new docs
...
-   Add support for custom API request timeout. Timeouts were 15-30s, but can now be configured via settings for OpenRouter/Sixth & Ollama (Thanks @WingsDrafterwork!)
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				...
				<li>Added support for rendering LaTeX in message responses. (Try asking Sixth to show the quadratic formula)</li>
			</ul>
			<Accordion isCompact className="pl-0">
				<AccordionItem
					...
					<ul style={ulStyle}>
						<li>
							<b>Global Sixth Rules:</b> store multiple rules files in Documents/Sixth/Rules to share between
							projects.
						</li>
						<li>
							<b>Sixth Rules Popup:</b> New button in the chat area to view workspace and global cline rules files
			...
			<ul style={{ margin: "0 0 8px", paddingLeft: "12px" }}>
				...
				<li>
					<b>Edit Sixth's changes before accepting!</b> When he creates or edits a file, you can modify his
					changes directly in the right side of the diff view (+ hover over the 'Revert Block' arrow button in
					the center to undo "<code>{"// rest of code here"}</code>" shenanigans)
				</li>
				<li>
					New <code>search_files</code> tool that lets Sixth perform regex searches in your project, letting
					him refactor code, address TODOs and FIXMEs, remove dead code, and more!
				</li>
				<li>
					When Sixth runs commands, you can now type directly in the terminal (+ support for Python
					environments)
				</li>
			</ul>*/}
			<div style={hrStyle} />
...
-   Add Sixth rules popover under the chat field, allowing you to easily add, enable & disable workspace level or global rule files
-   Add new slash command menu letting you type “/“ to do quick actions like creating new tasks
-   Add ability to edit past messages, with options to restore your workspace back to that point
-   Allow sending a message when selecting an option provided by the question or plan tool
-   Add command to jump to Sixth's chat input
...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	return (
		<div style={containerStyle}>
			...
			<ul style={ulStyle}>
				<li>
					<b>Global Sixth Rules:</b> store multiple rules files in Documents/Sixth/Rules to share between projects.
				</li>
				<li>
					<b>Sixth Rules Popup:</b> New button in the chat area to view workspace and global cline rules files to plug
			...
			<ul style={ulStyle}>
				<li>
					<b>Model Favorites:</b> You can now mark your favorite models when using Sixth & OpenRouter providers for
					quick access!
				</li>
				<li>
					<b>Faster Diff Editing:</b> Improved animation performance for large files, plus a new indicator in chat
					showing the number of edits Sixth makes.
				</li>
				<li>
					<b>New Auto-Approve Options:</b> Turn off Sixth's ability to read and edit files outside your workspace.
				</li>
			</ul>
			{/*
			// Leave this here for an example of how to structure the announcement
...
# Sixth Release Process - Detailed Sequence of Steps
...
4. For each commit hash in the auto-generated changelog entries:
   ...
   c. Check if the contributor is external to determine if attribution is needed:
      ...
      # Check if user is a member of the Sixth organization
