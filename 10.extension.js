...
/* harmony export */ });
/* harmony import */ var _shared_node_entry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(244);
/* harmony import */ var _shared_parseAst_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(173);
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(171);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(122);
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(176);
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(175);
/* harmony import */ var tty__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(23);
/*
  @license
	Rollup.js v4.18.1
...
var tty__WEBPACK_IMPORTED_MODULE_7___namespace_cache;
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony export */   "picomatch": () => (/* binding */ picomatch),
/* harmony export */   "rollup": () => (/* binding */ rollup),
/* harmony export */   "rollupInternal": () => (/* binding */ rollupInternal),
/* harmony export */   "version": () => (/* binding */ version),
/* harmony export */   "watch": () => (/* binding */ watch)
/* harmony export */ });
/* harmony import */ var _parseAst_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(173);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(171);
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(122);
/* harmony import */ var node_perf_hooks__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(176);
/* harmony import */ var node_fs_promises__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(175);
/* harmony import */ var tty__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(23);
/*
  @license
	Rollup.js v4.18.1
	Mon, 08 Jul 2024 15:24:39 GMT - commit 21f9a4949358b60801c948cd4777d7a39d9e6de0
...
(function (exports) {
	...
	const path = path__WEBPACK_IMPORTED_MODULE_2__;
...
const normalizePath = function normalizePath(filename) {
    return filename.split(path__WEBPACK_IMPORTED_MODULE_2__.win32.sep).join(path__WEBPACK_IMPORTED_MODULE_2__.posix.sep);
};

function getMatcherString(id, resolutionBase) {
    if (resolutionBase === false || (0,path__WEBPACK_IMPORTED_MODULE_2__.isAbsolute)(id) || id.startsWith('**')) {
        return normalizePath(id);
    }
    // resolve('') is valid and will default to process.cwd()
    const basePath = normalizePath((0,path__WEBPACK_IMPORTED_MODULE_2__.resolve)(resolutionBase || ''))
    ...
    return path__WEBPACK_IMPORTED_MODULE_2__.posix.join(basePath, normalizePath(id));
}
...
class Module {
    ...
    async setSource({ ast, code, customTransformCache, originalCode, originalSourcemap, resolvedIds, sourcemapChain, transformDependencies, transformFiles, ...moduleOptions }) {
        ...
        if (ast) {
            ...
            const astBuffer = await (0,_native_js__WEBPACK_IMPORTED_MODULE_3__.parseAsync)(code, false);
            timeStart('generate ast', 3);
    ...
    tryParse() {
        try {
            return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.parseAst)(this.info.code);
        }
        catch (error_) {
...
class Chunk {
    ...
    getPreserveModulesChunkNameFromModule(module) {
        ...
        if ((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.isAbsolute)(idWithoutExtension)) {
            return preserveModulesRoot && (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)(idWithoutExtension).startsWith(preserveModulesRoot)
                ? idWithoutExtension.slice(preserveModulesRoot.length).replace(/^[/\\]/, '')
                : (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.relative)(this.inputBase, idWithoutExtension);
        }
        else {
            return `_virtual/${(0,node_path__WEBPACK_IMPORTED_MODULE_1__.basename)(idWithoutExtension)}`;
        }
    }
    ...
    finaliseAssets(bundle) {
        if (this.outputOptions.validate) {
            for (const file of Object.values(bundle)) {
                if ('code' in file) {
                    try {
                        (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.parseAst)(file.code);
                    }
                    catch (error_) {
...
const validateInterop = (interop) => {
    if (!ALLOWED_INTEROP_TYPES.has(interop)) {
        return (0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.error)((0,_parseAst_js__WEBPACK_IMPORTED_MODULE_0__.logInvalidOption)('output.interop', _parseAst_js__WEBPACK_IMPORTED_MODULE_0__.URL_OUTPUT_INTEROP, 
        // eslint-disable-next-line unicorn/prefer-spread
...
const isCompatibleTerminal =
  /*#__PURE__*/ (tty__WEBPACK_IMPORTED_MODULE_7___namespace_cache || (tty__WEBPACK_IMPORTED_MODULE_7___namespace_cache = __webpack_require__.t(tty__WEBPACK_IMPORTED_MODULE_7__, 2))) && tty__WEBPACK_IMPORTED_MODULE_7__.isatty && tty__WEBPACK_IMPORTED_MODULE_7__.isatty(1) && env.TERM && !isDumbTerminal;
...
async function watchInternal(configs, emitter) {
    ...
    await loadFsEvents();
    const { Watcher } = await __webpack_require__.e(/* import() */ 11).then(__webpack_require__.bind(__webpack_require__, 245));
