...
class SqlDatabaseProjectTaskProvider {
    ...
    getTask(definition, runCodeAnalysis = false) {
        ...
        const task = new vscode.Task(definition, definition.workspaceFolder ?? vscode.TaskScope.Workspace, taskName, constants.sqlProjTaskType, shellExec, constants.problemMatcher);
