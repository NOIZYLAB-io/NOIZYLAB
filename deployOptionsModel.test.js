...
const testUtils = require("../../test/testContext");
const deployOptionsModel_1 = require("../../models/options/deployOptionsModel");
describe('Publish Dialog Deploy Options Model', () => {
    it('Should create model and set options successfully', function () {
        const model = new deployOptionsModel_1.DeployOptionsModel(testUtils.getDeploymentOptions());
    ...
    it('Should return empty string for null option ', function () {
        const model = new deployOptionsModel_1.DeployOptionsModel(testUtils.getDeploymentOptions());
        should(model.getOptionDescription('')).equal('');
    });
    it('Should have no default exclude object types', function () {
        const model = new deployOptionsModel_1.DeployOptionsModel(testUtils.getDeploymentOptions());
    ...
    it('Should have atleast one default exclude object types', function () {
        const model = new deployOptionsModel_1.DeployOptionsModel(testUtils.getDeploymentOptions());
...
//# sourceMappingURL=deployOptionsModel.test.js.map