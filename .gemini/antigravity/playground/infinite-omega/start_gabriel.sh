...
# QUARANTINED: python3 Audio_Unitor/Scripts/turbo_mount.py

# 3. Launch The Guardian (Auto-Heal Supervisor)
# Manages: Server, Discord, Sentinel, Bridge, Hand
echo "�️  INVOKING THE GUARDIAN (Supervisor)..."
python3 Audio_Unitor/Scripts/turbo_guardian.py &
GUARDIAN_PID=$!

# 4. Launch Gabriel (The Brain) - Foreground
...
# Trap Ctrl+C to kill background processes
# Trap Ctrl+C to kill background processes
trap "kill $GUARDIAN_PID; exit" INT
