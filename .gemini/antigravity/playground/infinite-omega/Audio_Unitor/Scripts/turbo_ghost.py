...
ROOT_DIR = Path("/Users/m2ultra/.gemini/antigravity/playground/infinite-omega/Audio_Unitor/Scripts")
STATUS_FILE = ROOT_DIR / "ghost.status"
...
class GhostWriter:
    ...
    def scan(self):
        ...
        self.set_status("Ghost: Scanning Codebase...")
        tasks = []
        ...
        self.set_status(f"Ghost: Ingesting {len(tasks)} tasks...")
        self.ingest(tasks)
        self.set_status("Ghost: Dormant (Scan Complete)")
