...
describe('ConfigurationManager - Simple Tests', () => {
    ...
    describe('Singleton Pattern', () => {
        it('should return the same instance on repeated calls to getInstance', () => {
            const instance1 = ConfigurationManager_1.ConfigurationManager.getInstance();
            const instance2 = ConfigurationManager_1.ConfigurationManager.getInstance();
...
//# sourceMappingURL=ConfigurationManager.simple.test.js.map