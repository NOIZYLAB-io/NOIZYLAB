...
exports.Proto3CompletionItemProvider = void 0;
const protobufjs_1 = require("protobufjs");
const vscode = require("vscode");
const proto3SyntacticScopeGuesser_1 = require("./proto3SyntacticScopeGuesser");
...
function findMessageEnum(document) {
    const msgCompletionItems = [];
    const enumCompletionItems = [];
    const tokenizer = protobufjs_1.tokenize(document.getText(), false);
...
class Proto3CompletionItemProvider {
    provideCompletionItems(document, position, token) {
        return new Promise((resolve, reject) => {
            ...
            const suggestions = [];
            const scope = proto3SyntacticScopeGuesser_1.SyntacticGuessScope(document, position);
            if (scope === null) {
...
//# sourceMappingURL=proto3Suggest.js.map