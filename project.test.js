...
describe('Project: sqlproj content operations', function () {
    ...
    it('Should read Project from sqlproj', async function () {
    ...
    it('Should read Project with Project reference from sqlproj', async function () {
    ...
    it('Should throw warning message while reading Project with more than 1 pre-deploy script from sqlproj', async function () {
        const stub = sinon.stub(vscode_1.window, 'showWarningMessage').returns(Promise.resolve(constants.okString));
    ...
    it('Should perform Folder and SQL object script operations', async function () {
    ...
    it('Should bulk-add scripts to sqlproj with pre-existing scripts on disk', async function () {
        const project = await testUtils.createTestSqlProject(this.test);
        // initial setup
    ...
    it('Should throw error while adding folders and SQL object scripts to sqlproj when a file does not exist on disk', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openProjectFileBaseline);
        const project = await testUtils.createTestSqlProject(this.test);
        let list = [];
    ...
    it('Should perform pre-deployment script operations', async function () {
    ...
    it('Should show information messages when adding more than one pre/post deployment scripts to sqlproj', async function () {
    ...
    it.skip('Should not add folders outside of the project folder', async function () {
        // Create new sqlproj
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should handle adding existing items to project', async function () {
        // Create new sqlproj
        const project = await testUtils.createTestSqlProject(this.test);
    ...
    it('Should read project properties', async function () {
...
describe('Project: sdk style project content operations', function () {
    before(async function () {
        await baselines.loadBaselines();
    });
    beforeEach(function () {
    ...
    it('Should exclude pre/post/none deploy scripts correctly', async function () {
    ...
    it('Should handle excluding glob included folders', async function () {
    ...
    it('Should handle excluding folders', async function () {
        const testFolderPath = await testUtils.generateTestFolderPath(this.test);
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openSdkStyleSqlProjectBaseline, testFolderPath);
        await testUtils.createDummyFileStructureWithPrePostDeployScripts(this.test, false, undefined, path.dirname(projFilePath));
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should handle excluding explicitly included folders', async function () {
        const testFolderPath = await testUtils.generateTestFolderPath(this.test);
    ...
    it('Should handle deleting explicitly included folders', async function () {
        const testFolderPath = await testUtils.generateTestFolderPath(this.test);
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openSdkStyleSqlProjectWithFilesSpecifiedBaseline, testFolderPath);
        await testUtils.createDummyFileStructureWithPrePostDeployScripts(this.test, false, undefined, path.dirname(projFilePath));
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should read OutputPath from sqlproj if there is one for SDK-style project', async function () {
    ...
    it('Should use default output path if OutputPath is not specified in sqlproj', async function () {
...
describe('Project: database references', function () {
    before(async function () {
        await baselines.loadBaselines();
    });
    after(async function () {
    ...
    it('Should read database references correctly', async function () {
        ...
        let projRef = project.databaseReferences.find(r => r instanceof projectEntry_1.SqlProjectReferenceProjectEntry && r.referenceName === 'ReferencedProject');
    ...
    it('Should delete database references correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.databaseReferencesReadBaseline);
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should add system database artifact reference correctly', async function () {
        let project = await testUtils.createTestSqlProject(this.test);
    ...
    it('Should add system database package reference correctly', async function () {
        let project = await testUtils.createTestSqlProject(this.test);
        const msdbRefSettings = {
            databaseVariableLiteralValue: (0, utils_1.systemDatabaseToString)(1 /* SystemDatabase.MSDB */),
            systemDb: 1 /* SystemDatabase.MSDB */,
    ...
    it('Should add a dacpac reference to the same database correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        // add database reference in the same database
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
        await project.addDatabaseReference({ dacpacFileLocation: vscode_1.Uri.file('test1.dacpac'), suppressMissingDependenciesErrors: true });
    ...
    it('Should add a dacpac reference to a different database in the same server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should add a dacpac reference to a different database in a different server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should add a project reference to the same database correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should add a project reference to a different database in the same server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
    ...
    it('Should add a project reference to a different database in a different server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        // add database reference to a different database on a different server
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should add a nupkg reference to the same database correctly', async function () {
    ...
    it('Should add a nupkg reference to a different database in the same server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newSdkStyleProjectSdkNodeBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        // add database reference to a different database on the same different server
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should add a nupkg reference to a different database in a different server correctly', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newSdkStyleProjectSdkNodeBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        // add database reference to a different database on a different server
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should throw an error trying to add a nupkg reference to legacy style project', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        // add database reference to the same database
    ...
    it('Should not allow adding duplicate dacpac references', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
        const dacpacReference = { dacpacFileLocation: vscode_1.Uri.file('test.dacpac'), suppressMissingDependenciesErrors: false };
    ...
    it('Should not allow adding duplicate system database references', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should not allow adding duplicate project references', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should not allow adding duplicate nupkg references', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newSdkStyleProjectSdkNodeBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
    ...
    it('Should handle trying to add duplicate database references when slashes are different direction', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
        should(project.databaseReferences.length).equal(0, 'There should be no database references to start with');
        const projectReference = {
    ...
    it('Should update sqlcmd variable values if value changes', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
...
describe('Project: add SQLCMD Variables', function () {
    before(async function () {
        await baselines.loadBaselines();
    });
    after(async function () {
    ...
    it('Should update .sqlproj with new sqlcmd variables', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openProjectFileBaseline);
        let project = await project_1.Project.openProject(projFilePath);
...
describe('Project: publish profiles', function () {
    before(async function () {
        await baselines.loadBaselines();
    });
    after(async function () {
    ...
    it('Should add new publish profile', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
        should(project.publishProfiles.length).equal(3);
...
describe('Project: properties', function () {
    ...
    it('Should read target database version', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.openProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
        should(project.getProjectTargetVersion()).equal('150');
    });
    it('Should throw on missing target database version', async function () {
    ...
    it('Should throw on invalid target database version', async function () {
    ...
    it('Should read default database collation', async function () {
    ...
    it('Should return default value when database collation is not specified', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.newProjectFileBaseline);
        const project = await project_1.Project.openProject(projFilePath);
    ...
    it.skip('Should throw on invalid default database collation', async function () {
    ...
    it('Should add database source to project property', async function () {
        const project = await testUtils.createTestSqlProject(this.test);
    ...
    it('Should remove database source from project property', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.sqlProjectInvalidCollationBaseline);
        const project = await project_1.Project.openProject(projFilePath);
        await project.addDatabaseSource('test1');
        await project.addDatabaseSource('test2');
    ...
    it('Should throw error when adding or removing database source that contains semicolon', async function () {
        const projFilePath = await testUtils.createTestSqlProjFile(this.test, baselines.sqlProjectInvalidCollationBaseline);
        const project = await project_1.Project.openProject(projFilePath);
        const semicolon = ';';
...
describe('Project: round trip updates', function () {
    before(async function () {
        await baselines.loadBaselines();
    });
    beforeEach(function () {
    ...
    it('Should update SSDT project to work in ADS', async function () {
        await testUpdateInRoundTrip(this.test, baselines.SSDTProjectFileBaseline);
    });
    it.skip('Should update SSDT project with new system database references', async function () {
        await testUpdateInRoundTrip(this.test, baselines.SSDTUpdatedProjectBaseline);
    });
    it('Should update SSDT project to work in ADS handling pre-existing targets', async function () {
        await testUpdateInRoundTrip(this.test, baselines.SSDTProjectBaselineWithBeforeBuildTarget);
    });
    it('Should not update project and no backup file should be created when prompt to update project is rejected', async function () {
    ...
    it('Should not show warning message for non-SSDT projects that have the additional information for Build', async function () {
        // setup test files
        const folderPath = await testUtils.generateTestFolderPath(this.test);
    ...
    it('Should not show update project warning message when opening sdk style project using Sdk node', async function () {
        await shouldNotShowUpdateWarning(this.test, baselines.newSdkStyleProjectSdkNodeBaseline);
    });
    it('Should not show update project warning message when opening sdk style project using Project node with Sdk attribute', async function () {
        await shouldNotShowUpdateWarning(this.test, baselines.newSdkStyleProjectSdkProjectAttributeBaseline);
    });
    it('Should not show update project warning message when opening sdk style project using Import node with Sdk attribute', async function () {
