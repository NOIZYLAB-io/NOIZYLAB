...
export class KnowledgeGraphAI {
    ...
    private mockNER(text: string): string[] {
        ...
        // Google AI Studio
        if (text.match(/Google AI Studio|AI Studio/i)) entities.push("GOOGLE_AI_STUDIO");
        if (text.match(/Gemini/i)) entities.push("GEMINI");
        if (text.match(/Vertex AI/i)) entities.push("VERTEX_AI");
        if (text.match(/398413916496/i)) entities.push("GCP_PROJECT_398413916496");
