    ...
    try {
      ...
      switch (request.type) {
        ...
        case 'graph':
          ...
          if (typeof graphPayload === 'object' && 'type' in graphPayload && (graphPayload as any).type === 'overlap') { // Type guard for broader payload
              // Construct overlap query string for internal handler
              const overlap = (graphPayload as any).range;
