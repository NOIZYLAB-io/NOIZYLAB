...
echo ">>> LAUNCHING NEURAL NEXUS (Mission Control v7)..."
echo ">>> (Press 1-5 to command the fleet)"
# Check python command
if command -v python3 &> /dev/null; then
    python3 mission_control_v7.py
else
    echo "!!! Python3 not found. Run 'mission_control_v7.py' manually."
fi
