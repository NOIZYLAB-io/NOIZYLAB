...
echo -e "  ${YELLOW}Starting Hypervelocity Server on 0.0.0.0:8000...${NC}"
# Use uvicorn directly to control host/port
python3 -m uvicorn core.gabriel_hypervelocity:app --host 0.0.0.0 --port 8000 > hypervelocity.log 2>&1 &
SERVER_PID=$!
