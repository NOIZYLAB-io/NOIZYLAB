...
class FlowState:
    ...
    def trigger_environment_changes(self, zone):
        # "Shirl" (Temporal Logic) dictates environment
        if zone == "FLOW_STATE_GOD_MODE":
            print("    -> [SHIRL] LOCKING STUDIO. NOTIFICATIONS DISABLED.")
            print("    -> [ENGR]  ACOUSTICS: DEADENED. LIGHTING: DARK_BLUE.")
        elif zone == "DISTRACTED":
            print("    -> [SHIRL] SUGGESTION: 40Hz BINAURAL BEATS.")
