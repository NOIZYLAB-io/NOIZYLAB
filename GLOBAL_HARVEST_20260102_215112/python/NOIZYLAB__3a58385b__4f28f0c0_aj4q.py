...
class SystemGuardian:
    ...
    def __init__(self):
        ...
        self.spirit.start_stream() # Enable subconscious by default
    ...
    def main_loop(self):
        ...
        while True:
            ...
            print(f"{Colors.BOLD}10.👁️  Toggle Neural Stream (Spirit){Colors.ENDC}")
            print(f"{Colors.BOLD}11.🎭 Switch Persona ({self.current_persona}){Colors.ENDC}") # Added new option
            ...
            if choice == '1':
                ...
                self.boot_sequence()
                 ...
                 if track:
                    ...
                    self.vision.animate(duration=10) # Visuals for 10s
                 else:
