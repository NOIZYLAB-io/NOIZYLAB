...
if __name__ == "__main__":
    try:
        ...
        print("\n\n⚠️  Mapping Interrupted. Generating Partial Map...")
        # Note: We can't access 'all_hotspots' here easily because it's local.
        # Ideally we'd move it to global or pass it out. 
        # Quick fix: rely on the print statements or just let the user run it fully later.
        # Actually, let's fix the scope to be useful.
