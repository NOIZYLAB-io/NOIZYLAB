...
async def handle_screenshare(request):
    """WebSocket handler for MJPEG Screen Sharing"""
    ...
    try:
        async for msg in ws:
            if msg.type == web.WSMsgType.BINARY:
                # Broadcast binary blob (MJPEG frame) to others in room
                # In a real app, strict separation of sender/receiver is needed
                # Here we assume the sender knows to send binary, receivers just listen
