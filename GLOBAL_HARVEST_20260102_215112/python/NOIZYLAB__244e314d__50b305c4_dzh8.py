...
try:
    ...
    from gabriel_voice import GabrielVoiceV2 as GabrielVoice
...
class SystemGuardian:
    ...
    def main_loop(self):
        ...
        while True:
            ...
            print(f"{Colors.BOLD}  [8] Vision / Eyes{Colors.ENDC}")
            print(f"{Colors.BOLD}  [9] Gabriel Player / DJ Mode{Colors.ENDC}")
            print(f"{Colors.BOLD}  [10] MC96 Dashboard (Metrics){Colors.ENDC}")
            print(f"{Colors.BOLD}  [11] Voice Preacher (Session){Colors.ENDC}")
            print(f"{Colors.BOLD}  [12] Run Truth Scan{Colors.ENDC}")
            print(f"{Colors.BOLD}  [13] System Reboot (Diagnostics){Colors.ENDC}")
            print(f"{Colors.BOLD}  [14] Voice Settings / Test{Colors.ENDC}")
            print(f"{Colors.BOLD}  [15] Switch Persona ({self.current_persona}){Colors.ENDC}")
