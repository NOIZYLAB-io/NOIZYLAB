...
class MemCell:
    ...
    def process_neural_input(self, msg, author="USER"):
        ...
        if msg.upper().startswith("BECOME:"):
            ...
            if target_identity in ["SHIRL", "ENGR", "GABRIEL", "CORE"]:
        ...
        if not author or author == "USER":
             # We could store a persistent author state in the class if we wanted the system to "be" someone.
             # But here we are processing INPUT from the User.
             # If the SYSTEM is speaking, we use the prompts.
             pass
