...
NETWORK_NODES = {
    "10.90.90.10": {"role": "COMMAND_CENTER", "device": "M2 Ultra Mac Studio", "name": "GABRIEL"},
    "10.90.90.20": {"role": "PROCESSING_ENGINE", "device": "HP-OMEN 25L", "name": "DAFIXER_OFFLINE"}, # User reported OFF
