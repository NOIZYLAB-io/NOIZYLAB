...
class SystemGuardian:
    ...
    def main_loop(self):
        ...
        while True:
            ...
            print(f"{Colors.BOLD}3. 🎓 Launch X1000 (Autonomous Learning){Colors.ENDC}")
            print(f"{Colors.BOLD}4. 🎣 Run Fishnet (System Scan){Colors.ENDC}")
            print(f"{Colors.BOLD}5. 🔄 System Reboot (Diagnostics){Colors.ENDC}")
