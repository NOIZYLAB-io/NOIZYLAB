...
# ... (GC Controller omitted, not changed) ...
...
async def voice_status():
    ...
    return {
        ...
        "openai": {"available": bool(OPENAI_KEY), "voices": ["alloy", "echo", "shimmer", "ash", "ballad", "coral", "sage", "verse"]},
        "macos": {"available": True, "voices": ["Samantha", "Alex", "Victoria"]}
    }
