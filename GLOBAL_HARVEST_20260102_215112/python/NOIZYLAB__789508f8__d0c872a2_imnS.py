...
# Custom CSS for "The Stage" Aesthetic (V28: DUNE / VILLENEUVE)
st.markdown("""
<style>
    /* DUNE PALETTE: Void Black, Desert Sand, Spice Blue, Rich Burgundy */
    .stApp {
        background-color: #050505;
        color: #E0E0E0;
    }
    
    /* INPUT FIELDS - Brutalist Blocks */
    ...
    h1 {
        ...
        font-weight: 800;
        letter-spacing: 2px;
        background: -webkit-linear-gradient(90deg, #C2B280, #E6D2B5); /* Sand Gradient */
    ...
    div.stButton > button:first-child {
        background-color: #660018; /* Deep Burgundy */
        color: #E0E0E0;
    ...
    div.stButton > button:first-child:hover {
        ...
        border-color: #C2B280; /* Sand Border */
        color: #ffffff;
    }
    ...
    .status-box {
        ...
        border-left: 5px solid #660018; /* Burgundy Accent */
