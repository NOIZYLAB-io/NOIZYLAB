    ...
    def do_GET(self):
        ...
        if path == "/api/stats":
            ...
            try:
                ...
                try:
                    ...
                    print(f"MemCell Chronos Error: {e}")
                    stats["heatmap"] = []
                    stats["identities"] = {}
        ...
        # API: Action Trigger
            ...
            if action == "ingest":
                ...
                # 1. Vacuum
                vault = Path.home() / "Universal"
                # Run sequentially or parallel? Sequentially is safer for cleanup
                # But Popen is async. We'll spawn a "cleanup agent" script? 
                # Or just chain them in a shell command string for Popen
