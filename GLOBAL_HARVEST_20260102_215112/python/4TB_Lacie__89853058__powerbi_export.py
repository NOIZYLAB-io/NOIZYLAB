...
def export_to_powerbi(db_path: str = "email_intelligence.db", output_file: str = "powerbi_export.csv"):
...
if __name__ == "__main__":
    ...
    db_path = sys.argv[1] if len(sys.argv) > 1 else "email_intelligence.db"
