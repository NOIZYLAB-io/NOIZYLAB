...
def run_omega(target_dir):
    ...
    print(f"\n{BOLD}⚠️  WARNING: THIS WILL TRANSFORM THE UNIVERSE.{RESET}")
    print(f"Target: {target_path}")
    print("The Time Machine is Active. Undo is possible.")
    time.sleep(1)

    # 1. WORMHOLE SCANNER (Universal Ingestion)
