...
class GeminiLiveProvider(VoiceProvider):
    ...
    def __init__(self, api_key: str, voice: str = "Puck", system_prompt: str = ""):
...
class OpenAIRealtimeProvider(VoiceProvider):
    ...
    def __init__(self, api_key: str, voice: str = "alloy", system_prompt: str = ""):
        self.api_key = api_key
        self.voice = voice  # alloy, echo, shimmer, ash, ballad, coral, sage, verse
        self.system_prompt = system_prompt
        self.ws = None
    ...
    def __init__(
        ...
        if gemini_key:
            self.providers.append(
                GeminiLiveProvider(gemini_key, "Puck", system_prompt)
            )
