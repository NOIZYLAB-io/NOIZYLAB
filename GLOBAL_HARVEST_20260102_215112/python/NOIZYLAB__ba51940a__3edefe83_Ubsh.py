...
# ============================================================================
class NativeBridge:
    """Interface to C++/Metal Native Modules (Imported from Gabriel Infinity)"""
...
async def auth_middleware(request, handler):
    ...
    if expected_key and request.path.startswith('/api/automation') or request.path.startswith('/api/exec'):
