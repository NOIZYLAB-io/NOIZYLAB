...
try:
    from gabriel_diagnostics import GabrielDiagnostics, GabrielHealer
    GABRIEL_DIAGNOSTICS_AVAILABLE = True
    diagnostics = GabrielDiagnostics()
    healer = GabrielHealer()
...
if '/Users/m2ultra/.gemini/antigravity/playground/iridescent-station/NOIZYLAB_WORKSPACES_LOCAL/GABRIEL_UNIFIED/core' not in sys.path:
...
try:
    from gabriel_neural_doctor import GabrielDoctor
except ImportError:
    GabrielDoctor = None
