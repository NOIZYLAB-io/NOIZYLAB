...
if __name__ == "__main__":
    ...
    print(f"\n🚀 Launching {module_name} on http://127.0.0.1:8765 (dashboard at /dashboard)")
    uvicorn.run(f"{module_name}:app", host="127.0.0.1", port=8765, reload=True)

# ----------------------------------------------------------------------------
# Integration helper (for mission_control.py)
# ----------------------------------------------------------------------------
"""
To connect Mission Control 96:
1. Run this file:
     python mcp_server.py
2. Replace the EventBus import:
     from mcp_server import MCPClient as EventBus
3. Update config.yaml:
     options:
       event_db: http://127.0.0.1:8765
4. Agents will now publish/fetch via HTTP instead of SQLite.
"""