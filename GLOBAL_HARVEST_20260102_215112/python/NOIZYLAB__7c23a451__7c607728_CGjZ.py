...
# SYSTEM IDENTITY
SYSTEM_NAME = "GABRIEL SYSTEM OMEGA"
SYSTEM_ROLE = "OVERLORD & CODEMASTER"
SYSTEM_STATUS = "GORUNFREE!!!"

import os

# Base Paths
GABRIEL_ROOT = "/Users/m2ultra/NOIZYLAB/GABRIEL"
LIBRARY_ROOT = "/Volumes/6TB/Sample_Libraries"

# Backward Compatibility (Alias)
MC96_ROOT = LIBRARY_ROOT 

MEMCELL_DIR = os.path.join(GABRIEL_ROOT, "memcell_data")
...
WEB_ROOT = os.path.join(GABRIEL_ROOT, "mission_control_portal")
SERVER_PORT = 5173
REPORT_FILE = os.path.join(LIBRARY_ROOT, "GLOBAL_TODO_REPORT.md")
...
CLEAN_TARGETS = [
    LIBRARY_ROOT,
    os.path.join(LIBRARY_ROOT, "Native_Instruments"),
    os.path.join(LIBRARY_ROOT, "Sample_Magic"),
    os.path.join(LIBRARY_ROOT, "Earth_Moments")
]

# Critical Files Verification
CRITICAL_FILES = [
    os.path.join(LIBRARY_ROOT, "MC96ECOUNIVERSE_MASTER_MANIFEST.md"),
    os.path.join(GABRIEL_ROOT, "memcell_core.py"),
