...
class SystemGuardian:
    ...
    def run_memcell_interface(self):
        ...
        while True:
            ...
            choice = input(f"\n{Colors.HEADER}🧠 MEMORY > {Colors.ENDC}").strip()
            ...
            if choice == '1':
                ...
                q = input(f"  {Colors.CYAN}Search Memory: {Colors.ENDC}")
    ...
    def main_loop(self):
        ...
        while True:
            ...
            print(f"{Colors.BOLD}4. 🎓 Launch X1000 (Autonomous Learning){Colors.ENDC}")
            print(f"{Colors.BOLD}5. 🎣 Run Fishnet (System Scan){Colors.ENDC}")
            print(f"{Colors.BOLD}6. 🔄 System Reboot (Diagnostics){Colors.ENDC}")
