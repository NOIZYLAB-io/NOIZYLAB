...
class GabrielDoctor:
    ...
    def check_network(self):
        ...
        try:
            ...
            logger.info("  ✅ DreamChamber (PC) is ONLINE [RME CORE DETECTED].")
        except:
    ...
    def check_audio_hardware(self):
        ...
        # Check /Library/Audio/Plug-Ins/Components for UAD
        if os.path.exists("/Library/Audio/Plug-Ins/Components/UAD Teletronix LA-2A Gray.component"):
             logger.info("  ✅ UAD PLUGINS: INSTALLED (Hardware likely present)")
        else:
             self.report("UAD APOLLO: NOT DETECTED (Mixer/Plugins missing)")
