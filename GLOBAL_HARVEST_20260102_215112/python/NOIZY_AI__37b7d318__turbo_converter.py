...
def run_alchemist(target_dir):
    print(f"{BOLD}{CYAN}CORE > ⚗️  THE ALCHEMIST: AUDIO TRANSMUTATION ENGINE{RESET}")
    print(f"CORE > Target: {target_dir}")
    print(f"CORE > Format: 44.1kHz / 16-bit WAV (Industry Standard)")
    ...
    # Gather files
    files = []
    print("CORE > Gathering ingredients...")
    ...
    print(f"CORE > Found {len(files)} candidates.")
