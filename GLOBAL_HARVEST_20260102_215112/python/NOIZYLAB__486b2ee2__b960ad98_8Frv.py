    ...
    def execute_command(self, args):
        ...
        # --- OMNIPOTENCE UPGRADE: ALL SCRIPTS LOADED ---
             ...
             if script_path.exists():
                 ...
                 # Forward any extra args if we had them, but for now just launch
                 import subprocess
                 # We need to capture the rest of the arguments? 
                 # For simplicity in this 'run' command, we just launch the script
                 try:
