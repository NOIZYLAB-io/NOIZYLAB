...
def generate_design_system(concept):
    ...
    prompt = "You are HEX. Generate a comprehensive Design System for: " + concept + """.
    Output must be valid JSON:
    {
        "palette": { "primary": "#...", "secondary": "#...", "bg": "#...", "text": "#..." },
        "typography": { "headings": "font", "body": "font" },
        "moodboard": ["keyword1", "keyword2", "keyword3"],
        "css_suggestion": "css code snippet for a button..."
    }
    """
    return model.generate_content(prompt).text
...
# TABS for distinct workflows
tab1, tab2, tab3, tab4 = st.tabs(["🧠 TEAM BRAIN", "🔊 EARS (Audio Analysis)", "⚡ LIGHTHOUSE AUDIT", "🎨 STUDIO (Design)"])
