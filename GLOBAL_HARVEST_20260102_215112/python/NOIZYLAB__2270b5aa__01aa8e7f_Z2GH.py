...
def nexus_dashboard():
    ...
    while True:
        ...
        elif lower_choice == 'p': run_script("turbo_plugin.py")
        elif lower_choice == 'a': run_script("turbo_sonic.py")
        elif lower_choice == 'l': run_script("turbo_logo.py")
        elif lower_choice == 'u': run_script("turbo_deploy.py")
        elif lower_choice == 'q':
