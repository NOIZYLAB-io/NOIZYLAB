...
# MODULE: 👁️ UNIVERSAL MEDIA VAULT (The Fishnet)
    ...
    if vis_db.exists():
        ...
        with c2:
            media_filter = st.selectbox("TYPE", ["ALL", "VIDEO", "IMAGE", "AUDIO", "PROJECT"])
        with c3:
        ...
        try:
            ...
            try:
                ...
                st.caption(f"🕸️ CAUGHT: {stats_dict.get('video',0):,} VIDEOS | {stats_dict.get('image',0):,} IMAGES | {stats_dict.get('audio',0):,} AUDIO | {stats_dict.get('project',0):,} PROJECTS")
            except:
                pass
                    ...
                    with cols[i % 4]:
                        with st.container(border=True):
                            ...
                            try:
                                ...
                                st.caption("Preivew Unavailable")
