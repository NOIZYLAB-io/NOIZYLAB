...
def main():
    ...
    for cid, members in clusters.items():
        ...
        is_drift_critical = drift_risk == "HIGH"
    ...
    for item in prioritized_items:
        ...
        if item['Meta'].get('DriftRisk') == "HIGH":
        ...
        with open(action_queue_path, 'w') as f:
            ...
            for pack_name, items in work_packs.items():
                ...
                for item in items:
                     ...
                     risk = "Safe-Auto"
                     if item['Meta']['Tier'] == "P0" or item['Meta'].get('DriftRisk') == "HIGH":
                         risk = "Manual"
                     elif item['Meta']['Tier'] in ["P1", "P2"]:
                         risk = "Safe-Confirm"
                         
                     f.write(f"| **{item['Meta']['Tier']}** | {risk} | {item['Meta']['PriorityScore']} | {item['Meta']['DueDate']} | `{task_id}` | {item['Title']} | Queued |\n")
