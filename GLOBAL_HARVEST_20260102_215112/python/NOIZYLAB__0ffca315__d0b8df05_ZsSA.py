...
def run_test(name, cmd):
    ...
    # Check for v3.0 compliance or specific unique output
    if "v3.0" in output or "v11.0" in output or "v10.1" in output or "SYSTEM VIBE" in output or "Search Query" in output:
        # Check for Vibe awareness in output if expected
        print(f"    -> STATUS: COMPLIANT (v3.0/v11.0)")
        return True
    else:
