            ...
            try:
                ...
                with urllib.request.urlopen(req, timeout=10) as response:
                    ...
                    if worker_resp.get("status") == "ok":
                         ...
                         # The worker returns a relative URL usually? Or absolute?
                         # If it's on 8787, we need to point the browser there or proxy the file.
                         # Let's assume we return the full URL to the browser if accessible, 
                         # or if the worker serves it.
