...
class ImageGenerator:
    ...
    def generate(prompt):
        ...
        # V28: DUNE AESTHETIC (Villeneuve/Fraser)
        # "CINEMATIC IN A BIG WAY", "RICH BURGUNDY"
        style = "cinematic shot, Denis Villeneuve style, Greg Greig Fraser cinematography, massive scale, atmospheric lighting, hyper-realistic, 8k, rich burgundy and desert gold colors, wide angle, brutalist architecture"
        enhanced_prompt = f"{safe_prompt}, {style}"
