...
export default {
  async fetch(request, env, ctx) {
    ...
    // In production, these should be environment secrets (wrangler secret put ...)
    const GABRIEL_PORTAL_URL = "https://unavailable-exclusive-policies-gazette.trycloudflare.com";
