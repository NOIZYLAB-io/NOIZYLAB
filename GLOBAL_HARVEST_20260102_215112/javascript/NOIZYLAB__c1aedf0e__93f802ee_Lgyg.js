            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (data.vibe) {
                        ...
                        // We can modify CSS variable if we added one, or just set it:
                        // Low vibe = slow (5s), High vibe = fast (0.5s)
                        const speed = Math.max(0.2, 5.0 - (this.vibe / 20)); // Vibe 100 -> 0s?? No. 
                        // Vibe 100 = 5 - 5 = 0. Too fast.
                        // Let's say Vibe 100 => 0.5s. Vibe 0 => 4s.
                        // 4.0 - (vibe / 100 * 3.5)
