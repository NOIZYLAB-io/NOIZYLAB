...
class GabrielCore {
    ...
    executeRemote(data) {
        ...
        // 1. VOICE INJECTION (Telepresence)
        ...
        // 2. GOD MODE TOGGLE
        if (cmd === 'god_mode') {
            const newInterval = (this.dreamInterval === 500) ? 5000 : 500;
            this.dreamInterval = newInterval; // Needs to be handled in dream loop
            if (this.rob) this.rob.speak(newInterval === 500 ? "God Mode Engaged. Hyper Speed." : "Systems Normalized.");
            return;
        }
        ...
        // Ack (Only verify complex commands visually, avoid spamming voice)
