...
class NeuralEngine {
     ...
     pulse() {
          ...
          this.nodes.forEach(n => {
               ...
               n.val += 5; // Temporarily grow
          });

          // Flash background or lines?
          NeuralConfig.lineColor = '#ffffff';
          setTimeout(() => {
               NeuralConfig.lineColor = 'rgba(124, 58, 237, 0.2)';
               this.nodes.forEach(n => n.val = Math.max(1, n.val - 5));
          }, 300);
     }
