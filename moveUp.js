...
function moveUp(favoritesProvider) {
    return vscode.commands.registerCommand('favorites.moveUp', function (value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let resources = (0, util_1.replaceArrayElements)(items, currentIndex, previousIndex);
